...
<html lang="en">
  <head>
    <title>Data Barang Tahun Perolehan <?php echo $id;?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG TAHUN PEROLEHAN <?php echo $id;?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE thn_perolehan='$id' ORDER BY DATE(tgl_perolehan) DESC";
