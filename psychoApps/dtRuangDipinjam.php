<?php include( "contentsConAdm.php" );
  $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_pinjam_ruang WHERE status_peminjaman='1'";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtRuangDipinjam.php?pagination=true&keyword=$keyword";
          ...
          WHERE (dpr.tgl_awal_pinjam LIKE '%$keyword%' OR dpr.tgl_akhir_pinjam LIKE '%$keyword%' OR dpr.tgl_kembali LIKE '%$keyword%' OR dr.nm LIKE '%$keyword%' OR okr.nm LIKE '%$keyword%' OR omr.nm LIKE '%$keyword%' OR ospb.nm LIKE '%$keyword%' OR dtpr.nm LIKE '%$keyword%' OR osp.nm LIKE '%$keyword%') AND dpr.status_peminjaman='1' ORDER BY dpr.id DESC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "dtRuangDipinjam.php?pagination=true";
          $sql = "SELECT * FROM dt_pinjam_ruang WHERE status_peminjaman='1' ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtRuangDipinjam.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtRuangDipinjam.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
