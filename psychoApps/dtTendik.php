<?php include("contentsConAdm.php");
  $qry_jumAktif = "SELECT COUNT(id) AS jumData FROM dt_pegawai WHERE jenis_pegawai='2' AND status='1'";
  $r_jumAktif = mysqli_query($con, $qry_jumAktif);
  $d_jumAktif = mysqli_fetch_assoc($r_jumAktif);
  
  $qry_jumTidakAktif = "SELECT COUNT(id) AS jumData FROM dt_pegawai WHERE jenis_pegawai='2' AND status='2'";
...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Data Tendik</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtTendik.php?pagination=true&keyword=$keyword";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtTendik.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtTendik.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                ...
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      ...
                      <button type="button" class="btn btn-outline-success btn-xs float-right" data-toggle="modal" data-target="#inputModal"><i class="far fa-plus-square"></i> Input Data Tendik</button>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-sm custom">
                        <thead class="thead-light">
                          ...
                          <th width="20%">Nama</th>
                          <th width="16%">NIP</th>
                          <th width="42%">Pangkat * Jabatan Instansi</th>
                        ...
                        <tbody>
                          <?php
                            ...
                            $tgl_2a = strtotime($data['tgl_2a']);
                            $new_tgl_2a = date("d-m-Y", $tgl_2a);
                            $tgl_2b = strtotime($data['tgl_2b']);
                            $new_tgl_2b = date("d-m-Y", $tgl_2b);
                            $tgl_2c = strtotime($data['tgl_2c']);
                            $new_tgl_2c = date("d-m-Y", $tgl_2c);
                            $tgl_2d = strtotime($data['tgl_2d']);
                            $new_tgl_2d = date("d-m-Y", $tgl_2d);
                            ...
                            $th_sma = strtotime($data['th_sma']);
                            $new_th_sma = date("d-m-Y", $th_sma);
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class=""> <?php echo $dpangkat['nm_pangkat'].' * '.$djabataninstansi['nm'];?> </td>
                            <td class=""> <?php echo $dstatuspegawai['nm'];?> </td>
                            <td class="text-center" width="4%"> <a class="btn btn-outline-success btn-xs btn-block" href="editDtTendik.php?id=<?php echo $data['id'].'&page='.$page;?>" title="Edit data"><i class="far fa-edit"></i></a> </td>
                                  ...
                                  <table class="table rounded-0 mb-0">
                                    <tbody>
                                      ...
                                      <tr>
                                        <th>Tanggal IIa</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $new_tgl_2a;?></td>
                                      </tr>
                                      <tr>
                                        <th>Tanggal IIb</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $new_tgl_2b;?></td>
                                      </tr>
                                      <tr>
                                        <th>Tanggal IIc</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $new_tgl_2c;?></td>
                                      </tr>
                                      <tr>
                                        <th>Tanggal IId</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $new_tgl_2d;?></td>
                                      </tr>
                                      <tr>
                                        <th>Tanggal IIIa</th>
                                        <td>:</td>
                                      ...
                                      <tr>
                                        <th>SMA/Sederajat</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $data['sma'];?></td>
                                      </tr>
                                      <tr>
                                        <th>Tanggal Lulus SMA/Sederajat</th>
                                        <td>:</td>
                                        <td colspan="2"><?php echo $new_th_sma;?></td>
                                      </tr>
                                      <tr>
    ...
    <form action="sDtTendik.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title" id="inputModalLabel">Input Data Tendik</h6>
            ...
            <div class="modal-body">
              <div class="row">
                <input type="text" value="2" name="jenis_pegawai" class="form-control form-control-sm sr-only" required>
                <input type="text" value="1" name="level" class="form-control form-control-sm sr-only" required>
              ...
              <div class="row">
                ...
                <div class="form-group col-3">
                  ...
                  <div class="input-group date" id="tgl_2a" data-target-input="nearest">
                    <input type="text" name="tgl_2a" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_2a">
                ...
                <div class="form-group col-3">
                  ...
                  <div class="input-group date" id="tgl_2b" data-target-input="nearest">
                    <input type="text" name="tgl_2b" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_2b">
              ...
              <div class="row">
                <div class="form-group col-3">
                  ...
                  <div class="input-group date" id="tgl_2c" data-target-input="nearest">
                    <input type="text" name="tgl_2c" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_2c">
                ...
                <div class="form-group col-3">
                  ...
                  <div class="input-group date" id="tgl_2d" data-target-input="nearest">
                    <input type="text" name="tgl_2d" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_2d">
              ...
              <div class="row">
                <div class="form-group col-8">
                  ...
                  <input type="text" name="sma" class="form-control form-control-sm">
                </div>
                <div class="form-group col-4">
                  <label for="th_sma">Tanggal Lulus SMA/Sederajat</label>
                  <div class="input-group date" id="th_sma" data-target-input="nearest">
                    <input type="text" name="th_sma" class="form-control form-control-sm datetimepicker-input" data-target="#th_sma">
