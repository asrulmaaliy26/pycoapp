    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dataStPertahunAdm.php?pagination=true&keyword=$keyword&tahun=$tahun&page_a=$page_a";
          ...
          , este.editor
          FROM st este
          LEFT JOIN opsi_jenis_st ojs
          ON ojs.id = este.jenis_st
          LEFT JOIN personil_st pst
          ...
          $reload = "dataStPertahunAdm.php?pagination=true&page_a=$page_a&tahun=$tahun";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dataStPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dataStPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <?php 
                              ...
                              <td width="4%" class="text-center pl-2"><a href="editDataStKepanitiaanPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-warning btn-xs" title="Edit ST Kepanitiaan"><i class="bi bi-pencil-square"></i></a></td>
                              <td width="4%" class="text-center"><a href="cetakDataSTKepanitiaanPertahunAdm.php?id='.$data['id'].'&page='.$page.'" role="button" class="btn-block btn btn-outline-secondary btn-xs" target="_blank" title="Cetak ST Kepanitiaan"><i class="bi bi-printer"></i></a></td>
                              <td width="4%" class="text-center pr-2"><a href="deleteDataStPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-danger btn-xs" onClick="return confirm(\'Yakin data ini dihapus?\')" title="Hapus surat"><i class="bi bi-trash"></i></a></td>';}
                              else if($data['jenis_st']==2) { echo '
                              <td width="4%" class="text-center pl-2"><a href="editDataStSpdPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-warning btn-xs" title="Edit ST SPD"><i class="bi bi-pencil-square"></i></a></td>
                              <td width="4%" class="text-center"><a href="cetakDataSTSpdPertahunAdm.php?id='.$data['id'].'&page='.$page.'" role="button" class="btn-block btn btn-outline-secondary btn-xs" target="_blank" title="Cetak ST SPD"><i class="bi bi-printer"></i></a></td>
                              <td width="4%" class="text-center pr-2"><a href="deleteDataStPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-danger btn-xs" onClick="return confirm(\'Yakin data ini dihapus?\')" title="Hapus surat"><i class="bi bi-trash"></i></a></td>';}
                              else if($data['jenis_st']==3) { echo '
                              <td width="4%" class="text-center pl-2"><a href="editDataStPenunjukanPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-warning btn-xs" title="Edit ST Penunjukan"><i class="bi bi-pencil-square"></i></a></td>
                              <td width="4%" class="text-center"><a href="cetakDataSTPenunjukanPertahunAdm.php?id='.$data['id'].'&page='.$page.'" role="button" class="btn-block btn btn-outline-secondary btn-xs" target="_blank" title="Cetak ST Penunjukan"><i class="bi bi-printer"></i></a></td>
                              <td width="4%" class="text-center pr-2"><a href="deleteDataStPertahunAdm.php?id='.$data['id'].'&page_a='.$page_a.'&tahun='.$tahun.'&page='.$page.'" role="button" class="btn-block btn btn-outline-danger btn-xs" onClick="return confirm(\'Yakin data ini dihapus?\')" title="Hapus surat"><i class="bi bi-trash"></i></a></td>';}
                              ?>
                          </tr>
