    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dataKontribEksBuatStPertahunAdm.php?pagination=true";
          $sql = "SELECT * FROM st WHERE tahun = '$tahun' AND executor = '$username' GROUP BY bulan ORDER BY bulan ASC";
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry = "SELECT COUNT(*) AS jumData FROM st WHERE executor = '$username' AND tahun = '$data[tahun]' AND bulan = '$data[bulan]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-2">
                              <a href="dataKontribEksBuatStPerbulanAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>&bulan=<?php echo $data['bulan'];?>" role="button" class="btn btn-warning btn-block btn-xs" title="Buka"><i class="bi bi-folder2-open"></i></a>
                            </td>
                          </tr>
                          <?php
                            $i++; 
