<?php include( "contentsConAdm.php" );
  $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_pinjam_barang WHERE status_peminjaman='1'";
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h4 class="mb-0">Data Barang Dipinjam</h4>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Data Barang Dipinjam</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtBarangDipinjam.php?pagination=true&keyword=$keyword";
          ...
          WHERE (dpb.tgl_awal_pinjam LIKE '%$keyword%' OR dpb.tgl_akhir_pinjam LIKE '%$keyword%' OR dpb.tgl_kembali LIKE '%$keyword%' OR dib.id_inventaris LIKE '%$keyword%' OR dib.nm LIKE '%$keyword%' OR okb.nm LIKE '%$keyword%' OR omb.nm LIKE '%$keyword%' OR dr.nm LIKE '%$keyword%' OR okob.nm LIKE '%$keyword%' OR ospb.nm LIKE '%$keyword%' OR dtpb.nm LIKE '%$keyword%' OR osp.nm LIKE '%$keyword%') AND dpb.status_peminjaman='1' ORDER BY dpb.id DESC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "dtBarangDipinjam.php?pagination=true";
          $sql = "SELECT * FROM dt_pinjam_barang WHERE status_peminjaman='1' ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtBarangDipinjam.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtBarangDipinjam.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Data Barang Dipinjam (<?php echo $d_jum['jumData'];?>)</h4>
                    </div>
                  </div>
