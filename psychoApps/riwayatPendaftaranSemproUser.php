  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatPendaftaranSemproUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 text-center table-sm custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_sempro WHERE nim='$username'";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td width="4%" class="text-center pr-1"><a class='btn btn-outline-primary btn-xs btn-block' title='Jadwal seminar proposal skripsi' href='jadwalSemproUser.php?id=<?php echo $data['id'];?>'><i class="far fa-calendar-alt"></i></a></td>
                          </tr>
                                    ...
                                    <div class="card">
                                      ...
                                      <div class="card-body text-left pb-0">
                                        <dl class="row">
                                          ...
                                          <dt class="col-sm-4">Judul proposal skripsi</dt>
                                          <dd class="col-sm-8"><?php echo $data['judul_prop']=preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $data['judul_prop']);?></dd>
                                          <dt class="col-sm-4">Lampiran file</dt>
                                          <dd class="col-sm-8"><?php if(empty($data['file_prop'])) { echo 'Tidak ada';} else { echo '<a class="btn btn-outline-primary btn-xs" title="Lihat/download" href="'.$data['file_prop'].'" target="_blank">Proposal</a>';}?></dd>
                                          ...
                                          <dd class="col-sm-8"><?php if(empty($dt_jdwl['tgl_seminar']) && empty($dt_jdwl['jam_mulai']) && empty($dt_jdwl['jam_selesai']) && empty($dt_jdwl['ruang'])) { echo "Belum ada";} else { echo "Penguji 1: $dt_p1[nama]
                                            <br/>Penguji 2: $dt_p2[nama]
                                            <br/>Tanggal Seminar: $newDateJad
                                            <br/>Pukul: $dt_jdwl[jam_mulai] - $dt_jdwl[jam_selesai]
                                            <br/>Ruang: $dt_ruang[nm]";}?></dd>
                                          <dt class="col-sm-4">Nilai</dt>
                                          <dd class="col-sm-8">Penguji I: <?php include("nilaiNarsum1PesSemproUser.php");?>
                                            <br/>Penguji II: <?php include("nilaiNarsum2PesSemproUser.php");?></dd>
                                          <dt class="col-sm-4">Rerata nilai</dt>
                                          <dd class="col-sm-8"><?php include "nilaiPesSemproUser.php";?></dd>
                                        </dl>
                                      </div>
                                    </div>
                                  </div>
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakPsempro.php",
            data: dataString,
            cache: false,
