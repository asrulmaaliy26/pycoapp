...
$sekretaris9=mysqli_real_escape_string($con, $_POST['sekretaris9']);

$sql="UPDATE nilai_ujskrip SET sekretaris9='$sekretaris9' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
