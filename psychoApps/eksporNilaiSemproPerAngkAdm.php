...
<html lang="en">
  <head>
    <title>Data Nilai Seminar Proposal Angkatan <?php echo "$angkatan";?></title>
    <meta charset="utf-8">
    <style>
      table {
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Nilai Seminar Proposal Angkatan '.$angkatan.'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="12">Data Nilai Seminar Proposal Angkatan <?php echo "$angkatan";?>
          </th>
        </tr>
        <tr style="border:none;">
    ...
    <table>
      ...
      <tbody>
        <?php
          $no=0;
          $sql = "SELECT * FROM peserta_sempro INNER JOIN dt_mhssw ON peserta_sempro.nim=dt_mhssw.nim INNER JOIN nilai_sempro ON peserta_sempro.id=nilai_sempro.id_pendaftaran INNER JOIN jadwal_sempro ON peserta_sempro.id=jadwal_sempro.id_pendaftaran WHERE peserta_sempro.angkatan='$angkatan' ORDER BY dt_mhssw.nama ASC";
