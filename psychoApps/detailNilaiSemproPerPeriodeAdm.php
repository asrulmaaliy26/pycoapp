      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Nilai Seminar Proposal <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapNilaiSemproAdm.php?page=<?php echo $page;?>">Nilai Seminar Proposal</a></li>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="10%">Nilai Penguji I</td>
                            <td width="10%" class="pr-1">Nilai Penguji II</td>
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p1['nama'];?>"><?php include("nilaiNarsum1PesSemproAdm.php");?></span> </td>
                            <td class="text-center"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p2['nama'];?>"><?php include("nilaiNarsum2PesSemproAdm.php");?></span> </td>
                            <td class="text-center pr-1"> <?php include("meanNilaiPesSemproAdm.php");?> </td>
                          </tr>
                          <tr class="expandable-body">
                            <td colspan="7"> <?php include("detailPesSemproAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
