  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
        ...
        $reload = "berkasUndangan.php?pagination=true&keyword=$keyword";
        ...
        $sql = "SELECT ps.id
          ...
          WHERE (ps.id_sending_surat LIKE '%$keyword%' OR ps.jenis_surat_penerima LIKE '%$keyword%' OR ps.penerima LIKE '%$keyword%' OR ps.tgl_kirim LIKE '%$keyword%' OR ps.bln_kirim LIKE '%$keyword%' OR ps.thn_kirim LIKE '%$keyword%' OR ss.deskripsi LIKE '%$keyword%' OR ss.jenis_surat LIKE '%$keyword%' OR ss.file_surat LIKE '%$keyword%' OR ss.tgl_upload LIKE '%$keyword%' OR ss.bln_upload LIKE '%$keyword%' OR ss.thn_upload LIKE '%$keyword%' OR ss.catatan LIKE '%$keyword%' OR ss.executor LIKE '%$keyword%' OR ss.editor LIKE '%$keyword%' OR ojfs.nm LIKE '%$keyword%' OR ab.nm_person LIKE '%$keyword%') AND ps.penerima=$dtDosen[id] AND ps.jenis_surat_penerima = '3' GROUP BY ps.id ORDER BY ps.id_sending_surat DESC";

        $result = mysqli_query($con, $sql);
      } else {
        $reload = "berkasUndangan.php?pagination=true";
        $sql = "SELECT * FROM penerima_surat WHERE penerima='$dtDosen[id]' AND jenis_surat_penerima ='3' ORDER BY id_sending_surat DESC";
        $result = mysqli_query($con, $sql);
      }
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm mb-2">
              <form method="post" action="berkasUndangan.php">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
                    ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="berkasUndangan.php"><i class="fas fa-sync"></i> Kembali</a>
                    <?php
                    }
                    ?>
                  </div>
