...
if (strlen($d1['file_prop'])>3)
{
   ...
   mysqli_query($con, "UPDATE pengelompokan_dospem_skripsi SET file_prop='$file_prop' WHERE id='$id' LIMIT 1");
   header("location:prePengajuanDospemUser.php?message=notifInput");}
   else {
   header("location:prePengajuanDospemUser.php?message=notifGagalUpload");}
...
if (strlen($d2['file_transkrip'])>3)
{
   ...
   mysqli_query($con, "UPDATE pengelompokan_dospem_skripsi SET file_transkrip='$file_transkrip' WHERE id='$id' LIMIT 1");
   header("location:prePengajuanDospemUser.php?message=notifInput");}
   else {
   header("location:prePengajuanDospemUser.php?message=notifGagalUpload");}
...
if (strlen($d3['file_toefl_toafl'])>3)
{
   ...
   mysqli_query($con, "UPDATE pengelompokan_dospem_skripsi SET file_toefl_toafl='$file_toefl_toafl' WHERE id='$id' LIMIT 1");
   header("location:prePengajuanDospemUser.php?message=notifInput");}
   else {
   header("location:prePengajuanDospemUser.php?message=notifGagalUpload");}
...
if (strlen($d4['file_tashih'])>3)
{
   ...
   mysqli_query($con, "UPDATE pengelompokan_dospem_skripsi SET file_tashih='$file_tashih' WHERE id='$id' LIMIT 1");
   header("location:prePengajuanDospemUser.php?message=notifInput");} 
   else {
   header("location:prePengajuanDospemUser.php?message=notifGagalUpload");}
...
if (strlen($d5['file_ukt'])>3)
{
   ...
   mysqli_query($con, "UPDATE pengelompokan_dospem_skripsi SET file_ukt='$file_ukt' WHERE id='$id' LIMIT 1");
   header("location:prePengajuanDospemUser.php?message=notifInput");} 
   else {
   header("location:formPengDospem.php?message=notifGagalUpload");}
   ?>