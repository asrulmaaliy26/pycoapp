...
$sekretaris10=mysqli_real_escape_string($con, $_POST['sekretaris10']);

$sql="UPDATE nilai_ujskrip SET sekretaris10='$sekretaris10' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
