                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE (peserta_pkl.nilai <= '$dt_grade_per_angk[ct]' AND nilai >= '$dt_grade_per_angk[cb]') AND (peserta_pkl.angkatan='$angkatan') AND (id_pkl='$id_pkl') ORDER BY dt_mhssw.nama ASC";
