...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Observasi dan Wawancara (Matkul) Individu Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Observasi dan Wawancara (Matkul) Individu Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
          ...
          <th width="52%">Tempat Observasi dan Wawancara</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM siow_individu WHERE thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
        ...
        <tr>
          ...
          <td><?php echo $data['tempat_ow'].' '.$data['alamat_lengkap_lts'];?></td>
