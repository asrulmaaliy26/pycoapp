<?php include( "contentsConAdm.php" );  
  ...
  $qry_kat = "SELECT * FROM opsi_kat_barang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Kategori <?php echo $d_kat['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG KATEGORI <?php echo strtoupper($d_kat['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE kategori='$id' ORDER BY DATE(tgl_perolehan) DESC";
