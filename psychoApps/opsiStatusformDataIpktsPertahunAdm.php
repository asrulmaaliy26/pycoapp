...
<form action="updateStatusformDataIpktsPertahunAdm.php" method="post" enctype="multipart/form-data">
  <input type="text" name="id" class="sr-only" value="<?php echo $data['id'];?>" required readonly>
  <input type="text" name="tahun" class="sr-only" value="<?php echo $tahun;?>" required readonly>
  <input type="text" name="page_a" class="sr-only" value="<?php echo $page_a;?>" required readonly>
