...
<html lang="en">
  <head>
    <title>Data Nilai PKL Angkatan <?php echo ''.$angkatan.'';?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <?php
      ...
      ?>
    <br>
    <span style="text-transform:uppercase;"><b>Data Nilai PKL Angkatan <?php echo ''.$angkatan.'';?></b>
    <br>
    <br>
    <table width="100%" style="font-size:10px;">
      ...
      <tbody>
        <?php
          $no=0;
          $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE peserta_pkl.angkatan='$angkatan' AND peserta_pkl.nilai!='' ORDER BY dt_mhssw.nama ASC";
        ...
        <tr>
          ...
          <td style="text-align:center;"> <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?> </td>
