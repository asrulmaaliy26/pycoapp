<?php include( "contentsConAdm.php" );
  ...
  $qidper = "SELECT * FROM pendaftaran_skripsi WHERE id='$dper[id_ujskrip]'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a class="text-info" href="inputJadUjskripPerPeriodeAdm.php?id=<?php echo $dper['id_ujskrip'];?>&page=<?php echo $page;?>">Input Jadwal Per Pendaftar</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateJadUjskripAdm.php" method="post">
                  <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
                  <input type="text" name="id_ujskrip" class="sr-only" value="<?php echo $didper['id'];?>" required readonly>
                  ...
                  <div class="card card-outline card-info">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group date" id="tgl_ujian" data-target-input="nearest">
                              <input type="text" name="tgl_ujian" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_ujian" value="<?php echo $djdwl['tgl_ujian'];?>" required/>
                              <div class="input-group-append" data-target="#tgl_ujian" data-toggle="datetimepicker">
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select name="sekretaris_penguji" class="form-control form-control-sm" id="sekretaris_penguji" required>
                            <?php
                              echo "<option value=''>-Pilih-</option>";
                              $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai = '1' ORDER BY nama_tg ASC" );
                              while ( $w = mysqli_fetch_array( $tampil ) ) {
                                if ( $djdwl['sekretaris_penguji'] == $w[ 'id' ] ) {
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select name="ketua_penguji" class="form-control form-control-sm" id="ketua_penguji" required>
                            <?php
                               echo "<option value=''>-Pilih-</option>";
                               $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai = '1' ORDER BY nama_tg ASC" );
                              while ( $w = mysqli_fetch_array( $tampil ) ) {
                                if ( $djdwl['ketua_penguji'] == $w[ 'id' ] ) {
                                  echo "<option value='$w[id]' selected>$w[nama_tg]</option>";
                                } else {
                                  echo "<option value='$w[id]'>$w[nama_tg]</option>";
                                }
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select name="penguji_utama" class="form-control form-control-sm" id="penguji_utama" required>
                            <?php
                               echo "<option value=''>-Pilih-</option>";
                               $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai = '1' ORDER BY nama_tg ASC" );
                              while ( $w = mysqli_fetch_array( $tampil ) ) {
                                if ( $djdwl['penguji_utama'] == $w[ 'id' ] ) {
                                  echo "<option value='$w[id]' selected>$w[nama_tg]</option>";
                                } else {
                                  echo "<option value='$w[id]'>$w[nama_tg]</option>";
                                }
                    ...
                    <div class="card-footer">
                      <a href="inputJadUjskripPerPeriodeAdm.php?id=<?php echo $dper['id_ujskrip'];?>&page=<?php echo $page;?>" class="btn btn-outline-warning btn-flat btn-sm float-left" data-dismiss="modal">Batal</a>
