            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="sinputAgendaSuratMasukAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group date" id="tgl_dmy_one" data-target-input="nearest">
                            <input type="text" name="tgl_terima" class="form-control form-control-sm" data-target="#tgl_dmy_one"  data-toggle="datetimepicker" required/>
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="pengirim" class="form-control form-control-sm" required>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Tanggal Berkas Surat</label>
                          <div class="input-group date" id="tgl_dmy_two" data-target-input="nearest">
                            <input type="text" name="tgl_surat" class="form-control form-control-sm" data-target="#tgl_dmy_two"  data-toggle="datetimepicker" required/>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="no_surat" class="form-control form-control-sm" required>
                        </div>
                      </div>
                      <div class="form-group">
