        ...
        <div class="card">
          ...
          <div class="card-body text-left pb-0">
            <dl class="row">
              ...
              <dd class="col-sm-7"><?php if(empty($dt_jdwl['tgl_ujian']) && empty($dt_jdwl['jam_mulai']) && empty($dt_jdwl['jam_selesai']) && empty($dt_jdwl['ruang'])) { echo "Belum ada";} else { echo "Sekretaris Penguji: $dt_p2[nama]
              <br/>Ketua Penguji: $dt_p1[nama] <br/>Penguji Utama: $dt_p3[nama]
              <br/>Tanggal Ujian: $dt_jdwl[tgl_ujian]
