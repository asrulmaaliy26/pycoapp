<?php include( "contentsConAdm.php" );
  ...
  $nilai_narsum1=mysqli_real_escape_string($con, $_POST['nilai_narsum1']);

  $sql="UPDATE nilai_sempro SET nilai_narsum1='$nilai_narsum1' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
