<?php include( "contentsConAdm.php" );  
  ...
  $qry_sub_kat = "SELECT * FROM opsi_sub_kat_barang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Sub Kategori <?php echo $d_sub_kat['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG SUB KATEGORI <?php echo strtoupper($d_sub_kat['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE sub_kategori='$id' ORDER BY DATE(tgl_perolehan) DESC";
