<?php
   ...
   $res5 = mysqli_query($con, "SELECT file_ukt FROM pengelompokan_dospem_skripsi WHERE id='".mysqli_real_escape_string($con, $_GET['id'])."' LIMIT 1");
   ...
   header ("location:riwayatPengajuanDospemUser.php?message=notifDelete");
   ?>