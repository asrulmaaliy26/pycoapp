                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="detailRiwayatPendaftaranKompreUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Pendaftaran</a>
                      </li>
                    </ul>
                  </div>
                  <div class="card-body">
                              ...
                              <table class="table m-0 text-center table-sm custom">
                                <thead>
                                  <tr>
                                    ...
                                    <th width="80%">SKS yang telah ditempuh</th>
                                    <th width="4%" class="pr-1">Opsi</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <?php
                                    $qry = "SELECT * FROM peserta_kompre WHERE nim='$dataku[nim]' AND id='$id'";
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center"><?php echo $md['sks_ditempuh'];?></td>
                                    <td class="text-center pr-1">
                                      <?php 
                                        if($md['val_adm']==2) { echo
                                          ...
                                          '<a class="btn btn-outline-warning btn-xs btn-block" onclick="return confirm(\'Yakin data ini diedit?\')" title="Yakin data ini diedit?" href="editPendaftaranKompreUserSatu.php?id='.$md['id'].'"><i class="far fa-edit"></i></a>';}?>
                                    </td>
                                  </tr>
                                  <?php }?>
                                </tbody>
                              ...
                              <table class="table m-0 text-center table-sm custom">
                                ...
                                <tbody>
                                  <?php
                                    ...
                                    ?>
                                  <tr>
                                    <td class="text-center pl-1"><?php if(empty($md['file_transkrip_nilai'])) { echo '<a class="btn btn-outline-secondary btn-xs btn-block" title="Tidak ada file" disabled><i class="fas fa-folder-minus"></i> Tidak ada file</a>';} else { echo '<a class="btn btn-outline-primary btn-xs btn-block" title="Lihat/download" href="'.$md['file_transkrip_nilai'].'" target="_blank"><i class="fas fa-file-download"></i> Lihat/download</a>';}?></td>
                                    <td class="text-center pr-1">
                                      <?php 
                                        if($md['val_adm']==2) { echo
                                          '<a class="btn btn-outline-secondary btn-xs btn-block" title="Tidak bisa diedit. Pendaftaran telah diterima" disabled><i class="far fa-edit"></i></a>';}
                                          ...
                                          '<a class="btn btn-outline-warning btn-xs btn-block" onclick="return confirm(\'Yakin data ini diedit?\')" title="Yakin data ini diedit?" href="editPendaftaranKompreUserDua.php?id='.$md['id'].'"><i class="far fa-edit"></i></a>';}?>
                                    </td>
                                  </tr>
                                  <?php }?>
                                </tbody>
