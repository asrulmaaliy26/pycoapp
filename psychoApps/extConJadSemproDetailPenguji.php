...
<div class="table-responsive" style="margin-bottom:30px;">
   <table class="table m-0 table-bordered table-sm small custom">
      ...
      <tbody class="text-muted" style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM jadwal_sempro WHERE (penguji1='$id' OR penguji2='$id') AND id_sempro='$data[id_sempro]' AND tgl_seminar='$data[tgl_seminar]' ORDER BY jam_mulai ASC";
         ...
         <tr>
            ...
            <td class="text-left <?php if($d['penguji1']==$id) { echo 'bg-secondary';} else { echo '';}?>"><?php echo $dp1['nama'];?></td>
            <td class="text-left <?php if($d['penguji2']==$id) { echo 'bg-secondary';} else { echo '';}?> pr-1"><?php echo $dp2['nama'];?></td>
         </tr>
         <?php 
            }
            ?>
