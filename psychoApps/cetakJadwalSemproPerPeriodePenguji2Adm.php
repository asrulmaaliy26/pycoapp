<?php include( "contentsConAdm.php" );
  ...
  $qidjdwl = "SELECT * FROM jadwal_sempro WHERE penguji2='$id' AND id_sempro='$id_sempro'";
...
<html lang="en">
   <head>
      <title>Jadwal Seminar Proposal <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></title>
      <meta charset="utf-8">
   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
      <?php 
         $jdwl = "SELECT * FROM jadwal_sempro WHERE penguji2='$id' AND id_sempro='$id_sempro' AND tgl_seminar='$tgl_seminar'";
         $rjdwl = mysqli_query($con,  $jdwl )or die( mysqli_error($con) );
         $djdwl = mysqli_fetch_assoc( $rjdwl );
         
         $qpenguji = "SELECT * FROM dt_pegawai WHERE id='$djdwl[penguji2]'";
         ...
         '<div class="page">';   
            ...
            include("extCetakJadwalSempro1Penguji2.php");
            include("extCetakJadwalSempro2Penguji2.php");
            include("extCetakJadwalSempro3Penguji2.php");'
            ';'      
         </div>';?>
