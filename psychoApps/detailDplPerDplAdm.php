        ...
        <div class="card">
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              <li class="nav-item"><a class="nav-link active" href="#profil<?php echo $data0['id_dpl'];?>" data-toggle="tab">Profil</a></li>
              <li class="nav-item"><a class="nav-link" href="#rekap<?php echo $data0['id_dpl'];?>" data-toggle="tab">Rekap</a></li>
            </ul>
          </div>
          <div class="card-body">
            <div class="tab-content">
              <div class="active tab-pane" id="profil<?php echo $data0['id_dpl'];?>">
              ...
              <div class="tab-pane" id="rekap<?php echo $data0['id_dpl'];?>">
