                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatSipsUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <table class="table table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="56%">Tempat penelitian</th>
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM sips WHERE nim=$dataku[nim] ORDER BY id DESC";
