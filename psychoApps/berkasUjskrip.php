                      ...
                      <table class="table table-hover table-bordered table-sm custom mb-0">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php if(empty($dpend['file_skripsi'])) { echo '<a class="btn btn-outline-secondary btn-flat btn-xs btn-block" onclick="return confirm(\'Tidak ada file!\')" title="Tidak ada file" disabled><i class="fas fa-download"></i></a>';} else { echo '<a class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Lihat/download" href="'.$dpend['file_skripsi'].'" target="_blank"><i class="fas fa-download"></i></a>';}?> </td>
                          </tr>
