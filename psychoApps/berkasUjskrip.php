  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
        ...
        $reload = "berkasUjskrip.php?pagination=true&keyword=$keyword";
        ...
        $reload = "berkasUjskrip.php?pagination=true";
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm mb-2">
              <form method="post" action="berkasUjskrip.php">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
                    ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="berkasUjskrip.php"><i class="fas fa-sync"></i> Kembali</a>
                    <?php
                    }
                    ?>
                  </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php if (empty($dpend['file_skripsi'])) {
                                                            ...
                                                            echo '<a class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Lihat/download" href="' . $dpend['file_skripsi'] . '" target="_blank"><i class="fas fa-download"></i></a>';
                                                          } ?> </td>
                          </tr>
