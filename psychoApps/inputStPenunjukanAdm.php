            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="sinputStPenunjukanAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-row mt-2">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan56" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan57" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan58" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan59" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan60" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan61" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan62" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan63" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan64" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan65" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>Nama 23</label>
                          <input type="text" name="nama66" class="form-control form-control-sm">
                        </div>
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan66" class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>Nama 24</label>
                          <input type="text" name="nama67" class="form-control form-control-sm">
                        </div>
                        <div class="form-group col-md-6">
                          <label>Jabatan</label>
                          <input type="text" name="jabatan67" class="form-control form-control-sm">
                        </div>
                      </div>
