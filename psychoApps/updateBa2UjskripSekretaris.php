...
$sekretaris2=mysqli_real_escape_string($con, $_POST['sekretaris2']);

$sql="UPDATE nilai_ujskrip SET sekretaris2='$sekretaris2' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
