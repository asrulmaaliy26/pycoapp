            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="rekapSiprakSiswaIndAdm.php?date=<?php echo $tahun;?>&page=<?php echo $page;?>">Izin Praktikum Individu Testee Siswa</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanSiprakisAdm.php" method="post" enctype="multipart/form-data">
