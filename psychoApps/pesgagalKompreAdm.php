            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Pendaftar Tidak Lulus Ujian</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Pendaftar Tidak Lulus Ujian</h4>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_kompre INNER JOIN dt_mhssw ON peserta_kompre.nim=dt_mhssw.nim WHERE peserta_kompre.id_kompre='$id' AND (peserta_kompre.hasil_ujian < $didper[passing_grade] AND peserta_kompre.hasil_ujian >= 1) ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php if(empty($data['hasil_ujian'])) { echo "Belum ada"." ";} 
                              ...
                              elseif ($data['hasil_ujian'] <= $dt_grade['dt'] && $data['hasil_ujian'] >= $dt_grade['db']) {echo $data['hasil_ujian']. ' (D)'.' ';}?> </td>
                          </tr>
