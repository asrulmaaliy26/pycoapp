...
<html lang="en">
  ...
  <form action="sformSimagkUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" href="formSimagkUser.php" role="tab" aria-selected="true">Form</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="card-body pb-0">
                      ...
                      <div class="form-group">
                        <label for="proposal">Upload file proposal magang (PDF) <span class="text-danger">*</span></label>
                        <input type="file" name="proposal" class="form-control form-control-sm" required>
                      ...
                      <input type="text" name="validasi_proposal" class="sr-only" value="1" required readonly>
