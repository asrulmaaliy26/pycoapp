...
$sekretaris8=mysqli_real_escape_string($con, $_POST['sekretaris8']);

$sql="UPDATE nilai_ujskrip SET sekretaris8='$sekretaris8' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
