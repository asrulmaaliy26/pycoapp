...
<html lang="en">
  ...
  <form action="updateSipsUser.php" method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-8">
                  <ol class="mt-2 breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Izin Penelitian Skripsi</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link" href="formSipsUser.php" role="tab" aria-selected="true">Form</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="riwayatSipsUser.php" role="tab" aria-selected="true">Riwayat</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" href="editSipsUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      ...
                      <div class="form-group">
                        <label for="nama_obyek">Tempat penelitian <span class="text-danger">*</span></label>
                        ...
                        <p class="help-block small"><strong><input type="checkbox" name="bilasama" onClick="IsiSamaNamaObyek(this.form)"> Silahkan checklist jika tempat penelitian sama dengan Instansi/lembaga tujuan surat.</strong></p>
                      </div>
                      <div class="form-group">
                        ...
                        <p class="help-block small"><strong>Judul skripsi harus ditulis dengan benar atau permohonan surat ditolak.</strong></p>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-6">
                          ...
                          <?php
                            ...
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                              if ( $dataku['dosen_pembimbing1'] == $w[ 'id' ] ) {
                        ...
                        <div class="form-group col-sm-6">
                          ...
                          <?php
                            ...
                            $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai = '1' AND status='1' ORDER BY nama ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                              if ( $dataku['dosen_pembimbing2'] == $w[ 'id' ] ) {
                                echo "<option value='$w[id]' selected>$w[nama]</option>";
                              } else {
                                echo "<option value='$w[id]'>$w[nama]</option>";
                              }
                      ...
                      <div class="form-row">
                        <div class="form-group col-sm-4">
                          <label for="tgl_awal_pelaksanaan">Tanggal mulai penelitian <span class="text-danger">*</span></label>
                          <div class="input-group date" id="tgl_dmy_one" data-target-input="nearest">
                            ...
                            <div class="input-group-append" data-target="#tgl_dmy_one" data-toggle="datetimepicker">
                              <div class="input-group-text form-control-sm"><i class="fas fa-calendar-alt"></i></div>
                            </div>
                          </div>
                        </div>
                        <div class="form-group col-sm-4">
                          <label for="tgl_akhir_pelaksanaan">Tanggal selesai penelitian <span class="text-danger">*</span></label>
