            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Nilai dari Penguji II Telah Diisi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Nilai dari Penguji II Telah Diisi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="16%" class="pr-1">Nilai Penguji II</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_sempro INNER JOIN dt_mhssw ON peserta_sempro.nim=dt_mhssw.nim INNER JOIN nilai_sempro ON peserta_sempro.id=nilai_sempro.id_pendaftaran WHERE peserta_sempro.id_sempro='$id' AND nilai_sempro.nilai_narsum2 != '0' ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p2['nama'];?>"><?php include("nilaiNarsum2PesSemproAdm.php");?></span> </td>
                          </tr>
