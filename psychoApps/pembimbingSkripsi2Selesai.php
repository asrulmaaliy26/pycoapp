    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "pembimbingSkripsi2Selesai.php?pagination=true&keyword=$keyword";
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR dospem_skripsi2.nama LIKE '%$keyword%') AND (pds.dospem_skripsi2=$dtDosen[id]) AND (pds.nim NOT IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]')) ORDER BY dm.nama ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "pembimbingSkripsi2Selesai.php?pagination=true";
          $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$dtDosen[id]' AND nim NOT IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]') ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="pembimbingSkripsi2Selesai.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="pembimbingSkripsi2Selesai.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
