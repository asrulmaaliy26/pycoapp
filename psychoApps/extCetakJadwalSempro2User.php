   ...
   <table class="jadwal">
      <thead>
         <tr>
            ...
            <th width="8%" style="text-align:center;">Pukul</th>
      ...
      <tbody style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM jadwal_sempro WHERE id_sempro='$djdwl[id_sempro]' AND tgl_seminar='$djdwl[tgl_seminar]' ORDER BY jam_mulai ASC";
         ...
         <tr>
            ...
            <td style="text-align:center;"><?php echo $d['jam_mulai'].' - '.$d['jam_selesai'];?></td>
