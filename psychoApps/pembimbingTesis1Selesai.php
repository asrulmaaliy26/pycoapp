<?php include( "contentsConAdm.php" );
  ...
  $qNim = "SELECT nim FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]'";
  $dNim = mysqli_query($con, $qNim)or die( mysqli_error($con));
  $dtNim = mysqli_fetch_assoc($dNim);

  $qJml = "SELECT COUNT(id) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]'";
  $rJml =  mysqli_query($con, $qJml) or die(mysqli_error($con));
  $dJml = mysqli_fetch_assoc($rJml) or die(mysqli_error($con));
  $jData = $dJml['jumData'];

  $qJmlProses = "SELECT COUNT(id) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]' AND status='1'";
  ...
  $qJmlUjskrip = "SELECT COUNT(id) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]' AND status='2'";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Pembimbing I Tesis</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "pembimbingTesis1Selesai.php?pagination=true&keyword=$keyword";
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR nip_dospem_tesis1.nama LIKE '%$keyword%') AND (pds.nip_dospem_tesis1='$dtDosen[id]' AND pds.status='2') ORDER BY dm.nama ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "pembimbingTesis1Proses.php?pagination=true";
          $sql = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]' AND status='2' ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="pembimbingTesis1Selesai.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="pembimbingTesis1Selesai.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <h4 class="card-title">Pembimbing I Tesis</h4>
                    <div class="card-tools">
                      <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                          <a class="nav-link" href="pembimbingTesis1.php">Semua (<?php echo $jData;?>)</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="pembimbingTesis1Proses.php">Proses (<?php echo $jDataProses;?>)</a>
                        </li>
                        <li class="nav-item">
                      ...
                      <table class="table table-hover table-bordered table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qpend =  "SELECT * FROM mag_peserta_ujtes WHERE nim='$data[nim]'";
                            $rpend = mysqli_query($con, $qpend);
                            $dpend = mysqli_fetch_array($rpend);
                            
                            $qjdwl =  "SELECT * FROM mag_jadwal_ujtes WHERE id_pendaftaran='$dpend[id]'";
                            ...
                            $qnilai =  "SELECT * FROM mag_nilai_ujtes WHERE id_pendaftaran='$dpend[id]'";
                                  ...
                                  <table class="table no-border rounded-0 mb-0">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php include ("meanNilaiUjTes.php");?></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
