          ...
          <div class="card-body box-profile">
            ...
            <ul class="list-group list-group-unbordered mb-3 text-left">
              <li class="list-group-item">
                <b>Menjadi Sekretaris Penguji</b> <a class="float-right"><?php echo "$jumlahData1";?></a>
              </li>
              <li class="list-group-item">
                <b>Menjadi Ketua Penguji</b> <a class="float-right"><?php echo "$jumlahData2";?></a>
              </li>
              <li class="list-group-item">
                <b>Menjadi Penguji Utama</b> <a class="float-right"><?php echo "$jumlahData3";?></a>
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <div class="card-body text-left p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        ...
                        Menjadi Sekretaris Penguji <span class="float-right badge bg-primary"><?php echo $jumlahData4;?></span>
                        </span>
                      </li>
                      <li class="nav-item">
                        <span class="nav-link text-primary">
                        Menjadi Ketua Penguji <span class="float-right badge bg-primary"><?php echo $jumlahData5;?></span>
                        </span>
                      </li>
                      <li class="nav-item">
                        <span class="nav-link text-primary">
                        Menjadi Penguji Utama <span class="float-right badge bg-primary"><?php echo $jumlahData6;?></span>
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="card-body text-left p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        ...
                        Menjadi Sekretaris Penguji <span class="float-right badge bg-danger"><?php echo "$jumlahData1";?></span>
                        </span>
                      </li>
                      <li class="nav-item">
                        <span class="nav-link text-danger">
                        Menjadi Ketua Penguji <span class="float-right badge bg-danger"><?php echo "$jumlahData2";?></span>
                        </span>
                      </li>
                      <li class="nav-item">
                        <span class="nav-link text-danger">
                        Menjadi Penguji Utama <span class="float-right badge bg-danger"><?php echo "$jumlahData3";?></span>
                        </span>
                      </li>
                    </ul>
                  </div>
