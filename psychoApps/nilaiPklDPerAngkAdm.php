            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Nilai PKL D Angkatan <?php echo $angkatan;?></li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Nilai PKL D Angkatan <?php echo $angkatan;?></h4>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE (peserta_pkl.nilai <= '$dt_grade_per_angk[dt]' AND nilai >= '$dt_grade_per_angk[db]') AND (peserta_pkl.angkatan='$angkatan') AND (id_pkl='$id_pkl') ORDER BY dt_mhssw.nama ASC";
