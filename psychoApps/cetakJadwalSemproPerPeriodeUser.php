<?php include( "contentsConAdm.php" );
  ...
  $qidjdwl = "SELECT * FROM jadwal_sempro WHERE id='$id'";
...
<html lang="en">
   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
      <?php 
         $jdwl = "SELECT * FROM jadwal_sempro WHERE id='$id'";
         ...
         <div class="page">';   
            ...
            include("extCetakJadwalSempro1User.php");
            include("extCetakJadwalSempro2User.php");
            include("extCetakJadwalSempro3User.php");'
            ';}'      
         </div>';?>
