...
$mean_nilai_penguji1_7=mysqli_real_escape_string($con, $_POST['nilai_penguji1_7']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji1_7='$mean_nilai_penguji1_7' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
...
header("location:ba7UjianTesisPenguji1.php?page=$page&id=$id_pendaftaran");
?>