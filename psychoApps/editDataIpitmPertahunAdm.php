            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="dataIpitmPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataIpitmPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          <label>NIM Testee</label>
                          <input type="text" name="nim_testee" class="form-control form-control-sm" value="<?php echo $dSurat['nim_testee'];?>" required>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-6">
