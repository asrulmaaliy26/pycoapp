      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemSatuProsesPerPeriodeAdm.php?pagination=true&nip=$nip";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$nip' AND (cek1='2' OR cek1='3') AND status='2' AND id_periode='$id' ORDER BY tgl_mulai ASC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Dospem I Sedang Proses Pembimbingan</h4>
