    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "pembimbingTesis1Proses.php?pagination=true&keyword=$keyword";
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR nip_dospem_tesis1.nama LIKE '%$keyword%') AND (pds.nip_dospem_tesis1='$dtDosen[id]' AND pds.status='1') ORDER BY dm.nama ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "pembimbingTesis1Proses.php?pagination=true";
          $sql = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE nip_dospem_tesis1='$dtDosen[id]' AND status='1' ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="pembimbingTesis1Proses.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="pembimbingTesis1Proses.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <ul class="nav nav-pills ml-auto">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="">Proses (<?php echo $jDataProses;?>)</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="pembimbingTesis1Selesai.php">Selesai (<?php echo $jDataUjskrip;?>)</a>
                        </li>
                      </ul>
                    </div>
                  </div>
