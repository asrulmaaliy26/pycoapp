      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Jadwal Seminar Proposal <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapJdwlSemproAdm.php?page=<?php echo $page;?>">Jadwal Seminar Proposal</a></li>
                  <li class="breadcrumb-item active small">Status Jadwal Pending</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Status Jadwal Pending</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="30%">Nama</td>
                            <td width="56%">Judul</td>
                            <td width="10%" class="pr-1">Tgl. Pendaftaran</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_sempro INNER JOIN dt_mhssw ON peserta_sempro.nim=dt_mhssw.nim WHERE peserta_sempro.id_sempro='$id' AND peserta_sempro.statusform='1' ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr class="expandable-body">
                            <td colspan="4"> <?php include("detailPesSemproAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
