   ...
   <table class="jadwal">
      <thead>
         <tr>
            ...
            <th width="19%">Judul Skripsi</th>
            <th width="20%">Sekretaris Penguji</th>
            <th width="20%">Ketua Penguji</th>
            <th width="20%">Penguji Utama</th>
         </tr>
      </thead>
      <tbody style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM jadwal_ujskrip WHERE id_ujskrip='$djdwl[id_ujskrip]' AND tgl_ujian='$djdwl[tgl_ujian]' ORDER BY jam_mulai ASC";
