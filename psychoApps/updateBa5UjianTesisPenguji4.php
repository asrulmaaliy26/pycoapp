...
$mean_nilai_penguji4_5=mysqli_real_escape_string($con, $_POST['nilai_penguji4_5']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji4_5='$mean_nilai_penguji4_5' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
