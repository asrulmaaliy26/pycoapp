    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Penguji I</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          ...
          $reload0 = "rekapPenguji1SemproAdm.php?id=$id&page=$page&pagination0=true";
          $sql0 = "SELECT * FROM jadwal_sempro INNER JOIN pendaftaran_sempro ON jadwal_sempro.id_sempro=pendaftaran_sempro.id WHERE penguji1='$id' GROUP BY jadwal_sempro.id_sempro ORDER BY pendaftaran_sempro.status ASC, pendaftaran_sempro.start_datetime DESC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Penguji I Per Periode</h4>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="8%" rowspan="2">Menjadi Penguji I</td>
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry1 = "SELECT COUNT(id) AS jumData FROM jadwal_sempro WHERE id_sempro='$data0[id_sempro]' AND penguji1='$data0[penguji1]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <a href="detailPenguji1SemproPerPeriodeAdm.php?id=<?php echo $id;?>&id_sempro=<?php echo $data0['id_sempro'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" class="btn btn-outline-primary btn-flat btn-xs btn-block" title="Lihat data" type="button"><?php echo $jumlahData1;?></a> </td>
                            <td width="6%" class="text-center pl-1"> <a href="cetakDetailPenguji1SemproPerPeriodeAdm.php?id=<?php echo $id;?>&id_sempro=<?php echo $data0['id_sempro'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Cetak data atau jadwal" type="button"><i class="fas fa-print"></i></a> </td>
                            <td width="6%" class="text-center pr-1"> <a href="eksporDetailPenguji1SemproPerPeriodeAdm.php?id=<?php echo $id;?>&id_sempro=<?php echo $data0['id_sempro'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" type="button" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Ekspor data ke Ms. Excel"><i class="fas fa-download"></i></a> </td>
                          </tr>
                          <?php
                            $i0++; 
                            $count0++;
