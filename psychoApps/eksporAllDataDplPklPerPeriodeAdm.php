...
<html lang="en">
  <head>
    <title>Rekap DPL PKL <br/><?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></title>
    <meta charset="utf-8">
    <style type="text/css">
      table.detail {
    ...
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th colspan="7">Rekap DPL PKL <br/><?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?>
          </th>
        </tr>
      </thead>
    </table>
    <table class="detail">
      ...
      <tbody>
        <tr>
          ...
          <td style="width: 78%;"><?php echo $dt_dpl['nama'];?></td>
        </tr>
        <tr>
          <td>Lokasi</td>
