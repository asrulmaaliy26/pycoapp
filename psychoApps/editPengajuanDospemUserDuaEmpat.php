...
<html lang="en">
  ...
  <form action="updatePengajuanDospemUserDuaEmpat.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editPengajuanDospemUserDuaEmpat.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Lampiran Berkas Tashih</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      <div class="form-group">
                        <label for="file_tashih">Upload file tashih (PDF)</label>
