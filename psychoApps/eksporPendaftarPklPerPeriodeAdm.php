...
<html lang="en">
  <head>
    <title>Data Pendaftar PKL <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></title>
    <meta charset="utf-8">
    <style>
      table {
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Pendaftar PKL Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="9">Data Pendaftar PKL <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?>
          </th>
        </tr>
        <tr style="border:none;">
