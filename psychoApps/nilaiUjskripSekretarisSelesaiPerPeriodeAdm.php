      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Nilai Ujian Skripsi <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapNilaiUjskripAdm.php?page=<?php echo $page;?>">Nilai Ujian Skripsi</a></li>
                  <li class="breadcrumb-item active small">Nilai dari Sekretaris Penguji Telah Diisi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Nilai dari Sekretaris Penguji Telah Diisi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="16%" class="pr-1">Nilai Sekretaris Penguji</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_ujskrip INNER JOIN dt_mhssw ON peserta_ujskrip.nim=dt_mhssw.nim INNER JOIN nilai_ujskrip ON peserta_ujskrip.id=nilai_ujskrip.id_pendaftaran WHERE peserta_ujskrip.id_ujskrip='$id' AND nilai_ujskrip.nilai_sekretaris IS NOT NULL ORDER BY dt_mhssw.nama ASC";
                            ...
                            $qry_nilai = "SELECT * FROM nilai_ujskrip WHERE id_pendaftaran='$dpra[id]'";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p1['nama'];?>"><?php include("nilaiSekretarisPesUjskripAdm.php");?></span> </td>
                          </tr>
                          <tr class="expandable-body">
                            <td colspan="5"> <?php include("detailPesUjskripAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
