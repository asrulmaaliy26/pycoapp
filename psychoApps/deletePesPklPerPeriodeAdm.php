<?php
  ...
  $terisi = $dterisi['terisi'] - 1;
   ...
   $res1 = mysqli_query($con, "SELECT file_transkrip FROM peserta_pkl WHERE id='".mysqli_real_escape_string($con, $_GET['id_pendaftar'])."' LIMIT 1");
  ...
  $myquery =  "DELETE FROM peserta_pkl WHERE id='".mysqli_real_escape_string($con, $_GET['id_pendaftar'])."' LIMIT 1";
