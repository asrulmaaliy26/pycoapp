            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small"><a href="rekapKirimSuratKeputusanAdm.php?page=<?php echo $page;?>">Surat Keputusan</a></li>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body pt-2 pb-2 pl-0 pr-0">
                    <form action="sinputPenerimaFileSkAdm.php" method="post" enctype="multipart/form-data">
