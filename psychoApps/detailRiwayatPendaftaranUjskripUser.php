                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="detailRiwayatPendaftaranUjskripUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Pendaftaran</a>
                      </li>
                    </ul>
                  </div>
                  <div class="card-body">
                              ...
                              <table class="table m-0 text-center table-sm custom">
                                <thead>
                                  <tr>
                                    ...
                                    <th width="80%">Judul skripsi</th>
                                    <th width="4%" class="pr-1">Opsi</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <?php
                                    $qry = "SELECT * FROM peserta_ujskrip WHERE nim='$dataku[nim]' AND id='$id'";
                                    ...
                                    <td class="text-center pr-1">
                                      <?php 
                                        if($md['val_adm']==2) { echo
                                          ...
                                          '<a class="btn btn-outline-warning btn-xs btn-block" onclick="return confirm(\'Yakin data ini diedit?\')" title="Yakin data ini diedit?" href="editPendaftaranUjskripUserSatu.php?id='.$md['id'].'"><i class="far fa-edit"></i></a>';}?>
                                    </td>
                                  </tr>
                                  <?php }?>
                                </tbody>
                          ...
                          <div class="card-body p-0">
                            <div class="table-responsive">
                              <table class="table m-0 text-center table-sm custom">
                                <thead>
                                  <tr>
                                    <th width="76%" class="pl-1">Skripsi</th>
                                ...
                                <tbody>
                                  <?php
                                    ...
                                    ?>
                                  <tr>
                                    <td class="text-center pl-1"><?php if(empty($md['file_skripsi'])) { echo '<a class="btn btn-outline-secondary btn-xs btn-block" title="Tidak ada file" disabled><i class="fas fa-folder-minus"></i> Tidak ada file</a>';} else { echo '<a class="btn btn-outline-primary btn-xs btn-block" title="Lihat/download" href="'.$md['file_skripsi'].'" target="_blank"><i class="fas fa-file-download"></i> Lihat/download</a>';}?></td>
                                    <td class="text-center pr-1">
                                      <?php 
                                        if($md['val_adm']==2) { echo
                                          '<a class="btn btn-outline-secondary btn-xs btn-block" title="Tidak bisa diedit. Pendaftaran telah diterima" disabled><i class="far fa-edit"></i></a>';}
                                          ...
                                          '<a class="btn btn-outline-warning btn-xs btn-block" onclick="return confirm(\'Yakin data ini diedit?\')" title="Yakin data ini diedit?" href="editPendaftaranUjskripUserDua.php?id='.$md['id'].'"><i class="far fa-edit"></i></a>';}?>
                                    </td>
                                  </tr>
                                  <?php }?>
                                </tbody>
