...
$mean_nilai_penguji3_1=mysqli_real_escape_string($con, $_POST['nilai_penguji3_1']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji3_1='$mean_nilai_penguji3_1' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
