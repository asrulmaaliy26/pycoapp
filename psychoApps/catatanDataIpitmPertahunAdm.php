            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataIpitmAdm.php?page=<?php echo $page_a;?>">Izin Praktikum Individu...</a></li>
                  <li class="breadcrumb-item small"><a href="dataIpitmPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanDataIpitmPertahunAdm.php" method="post" enctype="multipart/form-data">
