            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="rekapSkkbAdm.php?date=<?php echo $tahun;?>&page=<?php echo $page;?>">Keterangan Kelakuan Baik</a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateSkkbAdm.php" method="post" enctype="multipart/form-data">
