...
$sekretaris7=mysqli_real_escape_string($con, $_POST['sekretaris7']);

$sql="UPDATE nilai_ujskrip SET sekretaris7='$sekretaris7' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
