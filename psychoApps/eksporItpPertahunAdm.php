...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Tempat (Lokasi) PKL Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Tempat (Lokasi) PKL Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
          ...
          <th width="52%">Tempat (Lokasi) PKL</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM sitp WHERE thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
