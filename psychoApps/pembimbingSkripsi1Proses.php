    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR dospem_skripsi1.nama LIKE '%$keyword%') AND (pds.dospem_skripsi1=$dtDosen[id]) AND (pds.nim IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]')) ORDER BY dm.nama ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "pembimbingSkripsi1Proses.php?pagination=true";
          $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$dtDosen[id]' AND nim IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]') ORDER BY id DESC";
          $result = mysqli_query($con, $sql);
          }
