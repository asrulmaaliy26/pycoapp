  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
        ...
        $reload = "pembimbingSkripsi1Proses.php?pagination=true&keyword=$keyword";
...
WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR dospem_skripsi1.nama LIKE '%$keyword%') AND (pds.dospem_skripsi1=$dtDosen[id]) AND (pds.nim IN(SELECT nim FROM peserta_ujskrip)) ORDER BY dm.nama ASC";

        $result = mysqli_query($con, $sql);
      } else {
        $reload = "pembimbingSkripsi1Proses.php?pagination=true";
        $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$dtDosen[id]' AND nim IN(SELECT nim FROM peserta_ujskrip) ORDER BY id DESC";
        $result = mysqli_query($con, $sql);
      }
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm mb-2">
              <form method="post" action="pembimbingSkripsi1Proses.php">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
                    ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="pembimbingSkripsi1Proses.php"><i class="fas fa-sync"></i> Kembali</a>
                    <?php
                    }
                    ?>
                  </div>
