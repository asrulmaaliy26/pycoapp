  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:1.1em;">
    ...
    <table width="100%" style="padding-left:0px;">
      <tr>
        ...
        <td width="62%" align="left"><?php if($dt['no_agenda_surat']=='') {echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';} else {echo $dt['no_agenda_surat'];}?>/<?php echo $dkddekanat1['kd_nmr_srt'];?>/PP.009/<?php echo "$ambilbln";?>/<?php echo "$ambilthn";?></td>
