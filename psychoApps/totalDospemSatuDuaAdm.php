      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapDospemAdm.php">Rekap Dospem Skripsi</a></li>
        ...
        <?php
          ...
          if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>""){
          	...
          	$reload = "totalDospemSatuDuaAdm.php?pagination=true&id=$id&keyword=$keyword";
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR pds.ipk LIKE '%$keyword%' OR pds.sks_ditempuh LIKE '%$keyword%' OR pds.judul_skripsi LIKE '%$keyword%' OR pds.var_1 LIKE '%$keyword%' OR pds.var_2 LIKE '%$keyword%' OR pds.var_3 LIKE '%$keyword%' OR pds.var_4 LIKE '%$keyword%' OR pds.tgl_pengajuan LIKE '%$keyword%' OR pds.thn_pengajuan LIKE '%$keyword%' OR pds.tgl_mulai LIKE '%$keyword%' OR pds.thn_mulai LIKE '%$keyword%' OR pds.tgl_akhir LIKE '%$keyword%' OR pds.thn_akhir LIKE '%$keyword%' OR otuu.tahap LIKE '%$keyword%' OR ons.nama LIKE '%$keyword%' OR ojs.nm LIKE '%$keyword%' OR obs.nm LIKE '%$keyword%' OR ojp.opsi LIKE '%$keyword%' OR ovpd1.nm LIKE '%$keyword%' OR ovpd2.nm LIKE '%$keyword%' OR ovpd3.nm LIKE '%$keyword%' OR ospd.nm LIKE '%$keyword%') AND (pds.dospem_skripsi1='$id' OR pds.dospem_skripsi2='$id') AND (pds.status='2' OR pds.status='3')";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "totalDospemSatuDuaAdm.php?pagination=true&id=$id";
          $sql = "SELECT * 
            FROM pengelompokan_dospem_skripsi INNER JOIN dt_mhssw on pengelompokan_dospem_skripsi.nim = dt_mhssw.nim WHERE (pengelompokan_dospem_skripsi.dospem_skripsi1='$id' OR pengelompokan_dospem_skripsi.dospem_skripsi2='$id') AND (pengelompokan_dospem_skripsi.status='2' OR pengelompokan_dospem_skripsi.status='3') ORDER BY dt_mhssw.nama ASC";
          $result = mysqli_query($con, $sql);
           }
        ...
        <section class="content">
          <div class="container-fluid">
            <div class="row">
              <div class="col mb-2">
                <form method="post" action="totalDospemSatuDuaAdm.php?id=<?php echo $id;?>">
                  ...
                  <div class="input-group input-group-sm">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a role="button" class="btn btn-outline-secondary pl-3 pr-3" title="Refresh" href="totalDospemSatuDuaAdm.php?id=<?php echo $id;?>"><i class="fas fa-sync pr-2"></i>Refresh</a>
                      <?php
                        }
                        ?>
                    </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-left"><div class="clearfix"><div class="float-left"> <?php echo $dmhssw['nama'].' / '.$dmhssw['nim'];?> </div><div class="float-right"><?php if($id==$data['dospem_skripsi1']) {echo "<span class='badge badge-primary'>Dospem I</span>";} else if($id==$data['dospem_skripsi2']) {echo "<span class='badge badge-secondary'>Dospem II</span>";}?></div></div></td>
