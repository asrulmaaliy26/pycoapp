    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Ubah NIP/Id Lainnya</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "ubahNip.php?pagination=true&keyword=$keyword";
          ...
          $reload = "ubahNip.php?pagination=true";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="ubahNip.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="ubahNip.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">NIP/Id Lainnya: <span class="badge badge-success"><?php echo $d_jum['jumData'];?> Item</span></h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-sm custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-1"> <a class="btn btn-outline-success btn-xs btn-block" href="editUbahNip.php?id=<?php echo $data['id'].'&page='.$page;?>" title="Edit data"><i class="far fa-edit"></i></a> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
