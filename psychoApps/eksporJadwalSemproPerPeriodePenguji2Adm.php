<?php include( "contentsConAdm.php" );
  ...
  $qpenguji = "SELECT * FROM dt_pegawai WHERE id='$didjdwl[penguji2]'";
...
<html lang="en">
  ...
  <body>
    <?php
      ...
      include("extEksporJadwalSempro1Penguji2.php");
      include("extEksporJadwalSempro2Penguji2.php");
      include("extEksporJadwalSempro3Penguji2.php");?>
