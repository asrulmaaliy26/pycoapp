    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataKontribEksSiowkAdm.php?page=<?php echo $page;?>">Permohonan Surat Izin Observasi dan Wawancara...</a></li>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dataKontribEksSiowkPertahunAdm.php?pagination=true";
          $sql = "SELECT * FROM siow_kelompok WHERE thn_pengajuan = '$tahun' AND executor = '$username' GROUP BY bln_pengajuan ORDER BY bln_pengajuan ASC";
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry = "SELECT COUNT(*) AS jumData FROM siow_kelompok WHERE executor = '$username' AND thn_pengajuan = '$data[thn_pengajuan]' AND bln_pengajuan = '$data[bln_pengajuan]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-2">
                              <a href="dataKontribEksSiowkPerbulanAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>&bulan=<?php echo $data['bln_pengajuan'];?>" role="button" class="btn btn-warning btn-block btn-xs" title="Buka"><i class="bi bi-folder2-open"></i></a>
                            </td>
                          </tr>
                          <?php
                            $i++; 
