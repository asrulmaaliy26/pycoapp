...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Observasi dan Wawancara (Matkul) Kelompok Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Observasi dan Wawancara (Matkul) Kelompok Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM siow_kelompok WHERE thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
