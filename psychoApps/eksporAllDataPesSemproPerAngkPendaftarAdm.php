...
<html lang="en">
  <head>
    <title>Data Pendaftar Seminar Proposal Angkatan <?php echo "$angkatan";?></title>
    <meta charset="utf-8">
    <style>
      table {
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Pendaftar Seminar Proposal Angkatan '.$angkatan.'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="12">Data Pendaftar Seminar Proposal Angkatan <?php echo "$angkatan";?>
          </th>
        </tr>
        <tr style="border:none;">
