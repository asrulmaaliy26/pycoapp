<?php include( "contentsConAdm.php" );
   ...
   mysqli_query($con, "INSERT INTO dt_peminjam_barang(nm,alasan_pinjam,tgl_awal_pinjam,tgl_akhir_pinjam)".
   "values('$nm','$alasan_pinjam','$tgl_awal_pinjam','$tgl_akhir_pinjam')")  or die(mysqli_error($con));

   header("location:dtPinjamBarang.php?message=notifInput");
   ?>