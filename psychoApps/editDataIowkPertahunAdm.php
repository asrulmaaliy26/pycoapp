<?php include( "contentsConAdm.php" );
  ...
  $querySurat = "SELECT * FROM siow_kelompok WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataIowkAdm.php?page=<?php echo $page_a;?>">Izin Observasi dan Wawancara...</a></li>
                  <li class="breadcrumb-item active small"><a href="dataIowkPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataIowkPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='2'");
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='3'");
                            $select = mysqli_fetch_array($tampil);
                            $data = $select['nim_anggota'];
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='4'");
                            $select = mysqli_fetch_array($tampil);
                            $data = $select['nim_anggota'];
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='5'");
                            $select = mysqli_fetch_array($tampil);
                            $data = $select['nim_anggota'];
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='6'");
                            $select = mysqli_fetch_array($tampil);
                            $data = $select['nim_anggota'];
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='7'");
                            $select = mysqli_fetch_array($tampil);
                            $data = $select['nim_anggota'];
