    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a href="dataAskAdm.php?page=<?php echo $page_a;?>">Agenda Surat Keluar</a></li>
        ...
        <?php include 'pagination.php';    
          ...
          $reload = "dataAskPertahunAdm.php?pagination=true&keyword=$keyword&tahun=$tahun&page_a=$page_a";
          ...
          $reload = "dataAskPertahunAdm.php?pagination=true&page_a=$page_a&tahun=$tahun";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dataAskPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dataAskPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td width="4%" class="text-center pl-2"><a href="editDataAskPertahunAdm.php?id=<?php echo $data['id'];?>&page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-warning btn-block btn-xs" title="Edit agenda"><i class="bi bi-pencil-square"></i></a></td>
                            <td width="4%" class="text-center"><a href="cetakKopAmplopDataAskPertahunAdm.php?id=<?php echo $data['id'];?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-secondary btn-block btn-xs" target="_blank" title="Cetak kop amplop"><i class="bi bi-printer"></i></a></td>
                            <td width="4%" class="text-center pr-2"><a href="deleteDataAskPertahunAdm.php?id=<?php echo $data['id'];?>&page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-danger btn-block btn-xs" onClick="return confirm('Yakin data ini dihapus?')" title="Hapus agenda"><i class="bi bi-trash"></i></a></td>
                          </tr>
