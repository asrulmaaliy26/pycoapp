<?php include( "contentsConAdm.php" );
  ...
  $sql = "SELECT * FROM peserta_kompre INNER JOIN dt_mhssw ON peserta_kompre.nim=dt_mhssw.nim WHERE peserta_kompre.nim='$nim' AND peserta_kompre.id_kompre='$id'";
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Pendaftaran Ujian Kompre <?php echo 'Tahap '.$dthp['tahap'].' <code>'.$djp['nm'].'</code> '.$dsemester['nama'].' '.$dnta['ta'].'';?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a class="text-info" href="verpesKomprePerPeriodeAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>">Verifikasi Pendaftar</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanPesKomprePerPeriodeAdm.php" method="post" enctype="multipart/form-data">
