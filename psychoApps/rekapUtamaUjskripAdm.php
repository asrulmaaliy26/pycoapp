    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Penguji Utama</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          ...
          $reload0 = "rekapUtamaUjskripAdm.php?id=$id&page=$page&pagination0=true";
          $sql0 = "SELECT * FROM jadwal_ujskrip INNER JOIN pendaftaran_skripsi ON jadwal_ujskrip.id_ujskrip=pendaftaran_skripsi.id WHERE penguji_utama='$id' GROUP BY jadwal_ujskrip.id_ujskrip ORDER BY pendaftaran_skripsi.status ASC, pendaftaran_skripsi.start_datetime DESC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Penguji Utama Per Periode</h4>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="10%" rowspan="2">Menjadi <br>Penguji Utama</td>
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry1 = "SELECT COUNT(id) AS jumData FROM jadwal_ujskrip WHERE id_ujskrip='$data0[id_ujskrip]' AND penguji_utama='$data0[penguji_utama]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <a href="detailUtamaUjskripPerPeriodeAdm.php?id=<?php echo $id;?>&id_ujskrip=<?php echo $data0['id_ujskrip'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" class="btn btn-outline-primary btn-flat btn-xs btn-block" title="Lihat data" type="button"><?php echo $jumlahData1;?></a> </td>
                            <td width="6%" class="text-center pl-1"> <a href="cetakDetailUtamaUjskripPerPeriodeAdm.php?id=<?php echo $id;?>&id_ujskrip=<?php echo $data0['id_ujskrip'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Cetak data atau jadwal" type="button"><i class="fas fa-print"></i></a> </td>
                            <td width="6%" class="text-center pr-1"> <a href="eksporDetailUtamaUjskripPerPeriodeAdm.php?id=<?php echo $id;?>&id_ujskrip=<?php echo $data0['id_ujskrip'];?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>" type="button" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Ekspor data ke Ms. Excel"><i class="fas fa-download"></i></a> </td>
                          </tr>
                          <?php
                            $i0++; 
                            $count0++;
