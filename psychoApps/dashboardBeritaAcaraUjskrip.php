                      ...
                      <tbody>
                        ...
                        ?>
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-left"><?php $allowedlimit = 20;
                                                  if (mb_strlen($dmhssw['nama']) > $allowedlimit) {
                                                    echo mb_substr($dmhssw['nama'], 0, $allowedlimit) . "..." . ' [' . $dmhssw['nim'] . ']';
                                                  } else {
                                                    echo  $dmhssw['nama'] . ' [' . $dmhssw['nim'] . ']';
                                                  } ?></td>
                            <td <?php if ($dtDosen['id'] == $data['sekretaris_penguji']) {
                                  echo 'class="text-center pl-1 bg-light"';
                                } else {
                                  echo 'class="text-center pl-1"';
                                } ?>><?php include("meanNilaiSekretarisUjskrip.php"); ?>
                            </td>
                            <td <?php if ($dtDosen['id'] == $data['ketua_penguji']) {
                                  echo 'class="text-center bg-light"';
                                } else {
                                  echo 'class="text-center"';
                                } ?>><?php include("meanNilaiKetuaUjskrip.php"); ?>
                            </td>
                            <td <?php if ($dtDosen['id'] == $data['penguji_utama']) {
                                  echo 'class="text-center pr-1 bg-light"';
                                } else {
                                  echo 'class="text-center pr-1"';
                                } ?>><?php include("meanNilaiUtamaUjskrip.php"); ?></td>
                            <td class="text-center"><?php include("meanNilaiUjskrip.php"); ?></td>
                            <td class="text-center pr-1">
                              <?php
                              if (empty($data['tgl_ujian']) && empty($data['jam_mulai']) && empty($data['jam_selesai']) && empty($data['ruang'])) {
                                echo "<button role='button' class='btn btn-outline-secondary btn-xs btn-block' title='Belum terjadwal' disabled><span class='glyphicon glyphicon-ban-circle'></span> Belum Terjadwal</button>";
                              } else if ($dnilai['validasi'] == 1 && $data['sekretaris_penguji'] == $dtDosen['id']) {
                                echo "<a href='baUjskripSekretaris.php?page=$page&id=$data[id]' role='button' class='btn btn-outline-secondary btn-xs btn-block'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";
                              } else if ($dnilai['validasi'] == 1 && $data['ketua_penguji'] == $dtDosen['id']) {
                                echo "<a href='baUjskripKetua.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";
                              } else if ($dnilai['validasi'] == 1 && $data['penguji_utama'] == $dtDosen['id']) {
                                echo "<a href='baUjskripUtama.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";
                              } else {
                                echo "<button class='btn btn-success btn-block btn-xs' title='Tervalidasi' disabled><span class='glyphicon glyphicon-check'></span> Tervalidasi</button>";
                              }
                              ?>
                            </td>
                          </tr>
