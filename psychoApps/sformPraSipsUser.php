<?php include( "contentsConAdm.php" );
   ...
   mysqli_query($con, "INSERT INTO prasips(nim,lembaga_tujuan_surat,alamat_lengkap_lts,nama_obyek,tgl_awal_pelaksanaan,tgl_akhir_pelaksanaan,model_pelaksanaan,kota_observasi,sebutan_pimpinan,judul_prop,dosen_pembimbing1,dosen_pembimbing2,tgl_pengajuan,bln_pengajuan,thn_pengajuan,wd1,statusform)".
   "values('$nim','$lembaga_tujuan_surat','$alamat_lengkap_lts','$nama_obyek','$tgl_awal_pelaksanaan','$tgl_akhir_pelaksanaan','$model_pelaksanaan','$kota_observasi','$sebutan_pimpinan','$judul_prop','$dosen_pembimbing1','$dosen_pembimbing2','$tgl_pengajuan','$bln_pengajuan','$thn_pengajuan','$wd1','$statusform')")  or die(mysqli_error($con));
   ...
   header("location:riwayatPraSipsUser.php?message=notifInput");
   ?>