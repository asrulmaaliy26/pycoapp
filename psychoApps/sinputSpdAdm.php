<?php include "contentsConAdm.php";
   ...
   mysqli_query($con, "INSERT INTO spd(no_agenda_surat,penerima,pangkat,jabatan_instansi_penerima,maksud_spd,tempat_berangkat,tempat_tujuan,tempat_tujuan2,tempat_tujuan3,tanggal_berangkat,tanggal_kembali,durasi_spd,ppk,jabatan_ppk,dekan,tgl_ditetapkan,bulan,tahun,executor)" .
   "values('$no_agenda_surat','$penerima','$pangkat','$jabatan_instansi_penerima','$maksud_spd','$tempat_berangkat','$tempat_tujuan','$tempat_tujuan2','$tempat_tujuan3','$tanggal_berangkat','$tanggal_kembali','$durasi_spd','$ppk','$jabatan_ppk','$dekan','$tgl_ditetapkan','$bulan','$tahun','$executor')") or die(mysqli_error($con));

   header("location:rekapSpdAdm.php?page=$page&message=notifInput");
   ?>