          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item small"><a href="dataKontribEksSkkbPertahunAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>">Tahun <?php echo $tahun;?></a></li>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-sm custom mb-0">
                      <thead class="thead-light">
                        ...
                        <th scope="col" width="44%" class="text-left">Keperluan SKKB</th>
                        <th scope="col" width="12%" class="text-center">Status</th>
                      </thead>
                      <tbody>
                        <?php
                          $no=0;
                          $sql = "SELECT * FROM skkb WHERE thn_pengajuan = '$tahun' AND bln_pengajuan = '$bulan' AND executor = '$username' ORDER BY id DESC";
                        ...
                        <tr data-widget="expandable-table" aria-expanded="false">
                          ...
                          <td class="text-left"><?php $allowedlimit = 44; if(mb_strlen($data['keperluan'])>$allowedlimit) { echo mb_substr($data['keperluan'],0,$allowedlimit)."...";} else {echo $data['keperluan'];}?></td>
