          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updatePeriodePendPklAdm.php" method="post">
                  ...
                  <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="ketua" class="form-control form-control-sm" id="ketua" required>
                        <?php
                          $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai='1' ORDER BY nama_tg ASC" );
                          while ( $w = mysqli_fetch_array( $tampil ) ) {
                            if ( $didper['ketua'] == $w[ 'id' ] ) {
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          ...
                          <input type="number" max="100" step=".0001" name="at" class="form-control form-control-sm" value="<?php echo $dt_grade['at'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="ab">Batas Bawah Grade A</label>
                          <input type="number" step=".0001" name="ab" class="form-control form-control-sm" value="<?php echo $dt_grade['ab'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="bplust">Batas Atas Grade B+</label>
                          <input type="number" step=".0001" name="bplust" class="form-control form-control-sm" value="<?php echo $dt_grade['bplust'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="bplusb">Batas Bawah Grade B+</label>
                          <input type="number" step=".0001" name="bplusb" class="form-control form-control-sm" value="<?php echo $dt_grade['bplusb'];?>" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="bt">Batas Atas Grade B</label>
                          <input type="number" step=".0001" name="bt" class="form-control form-control-sm" value="<?php echo $dt_grade['bt'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="bb">Batas Bawah Grade B</label>
                          <input type="number" step=".0001" name="bb" class="form-control form-control-sm" value="<?php echo $dt_grade['bb'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="cplust">Batas Atas Grade C+</label>
                          <input type="number" step=".0001" name="cplust" class="form-control form-control-sm" value="<?php echo $dt_grade['cplust'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="cplusb">Batas Bawah Grade C+</label>
                          <input type="number" step=".0001" name="cplusb" class="form-control form-control-sm" value="<?php echo $dt_grade['cplusb'];?>" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="ct">Batas Atas Grade C</label>
                          <input type="number" step=".0001" name="ct" class="form-control form-control-sm" value="<?php echo $dt_grade['ct'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="cb">Batas Bawah Grade C</label>
                          <input type="number" step=".0001" name="cb" class="form-control form-control-sm" value="<?php echo $dt_grade['cb'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="dt">Batas Atas Grade D</label>
                          <input type="number" step=".0001" name="dt" class="form-control form-control-sm" value="<?php echo $dt_grade['dt'];?>" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="db">Batas Bawah Grade D</label>
                          <input type="number" min="1" step=".0001" name="db" class="form-control form-control-sm" value="<?php echo $dt_grade['db'];?>" required>
                        </div>
                      </div>
                    ...
                    <div class="card-footer">
                      <a href="pndftrnPklAdm.php?page=<?php echo "$page";?>" class="btn btn-outline-warning btn-flat btn-sm float-left" data-dismiss="modal">Batal</a>
