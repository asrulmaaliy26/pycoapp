...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Pendaftaran Seminar Proposal</h6>
              </div>
              <div class="col-sm-6">
        ...
        <?php
          include 'pagination.php';
           $reload = "pndftrnSemproAdm.php?pagination=true";
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="6%" class="text-center pr-1"> <?php if($data['status']==1) { echo "<button class='btn btn-outline-primary btn-flat btn-xs btn-block' title='Sedang aktif'><i class='fas fa-calendar-check'></i></button>";} else { echo "<a class='btn btn-outline-secondary btn-flat btn-xs btn-block' title='Tidak aktif' href='updateStatusPeriodeSempro.php?id=".$id."&page=".$page."' onclick='return confirm(\"Yakin periode pendaftaran ini diaktifkan?\")'><i class='far fa-calendar-times'></i></a>";}?> </td>
                            <td class="text-center" width="6%"> <a href="editPeriodePendSemproAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Edit periode"><i class="far fa-edit"></i></a> </td>
                            <td class="text-center pr-1" width="6%"> <?php if($data1['jumData'] > 0) { echo "<a  class='btn btn-outline-secondary btn-flat btn-xs btn-block' onclick='return confirm(\"Tidak bisa dihapus! Sudah ada peserta\")' title='Tidak bisa dihapus! Sudah ada peserta' disabled><i class='far fa-trash-alt'></i></a>";} else { echo "<a class='btn btn-outline-danger btn-flat btn-xs btn-block' href='deletePeriodeSempro.php?id=".$id."&page=".$page."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><i class='far fa-trash-alt'></i></a>";}?> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
      ...
      <form action="spndftrnSemproAdm.php" method="post">
              ...
              <div class="modal-body">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" max="100" step=".0001" name="lt" class="form-control form-control-sm bg-transparent text-white" value="100" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="lb">Batas Bawah Grade Lulus</label>
                    <input type="number" step=".0001" name="lb" class="form-control form-control-sm bg-transparent text-white" value="80" required>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="lrt">Batas Atas Grade Lulus Revisi</label>
                    <input type="number" step=".0001" name="lrt" class="form-control form-control-sm bg-transparent text-white" value="79.9999" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="lrb">Batas Bawah Grade Lulus Revisi</label>
                    <input type="number" step=".0001" name="lrb" class="form-control form-control-sm bg-transparent text-white" value="60" required>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="sut">Batas Atas Grade Seminar Ulang</label>
                    <input type="number" step=".0001" name="sut" class="form-control form-control-sm bg-transparent text-white" value="69.9999" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="sub">Batas Bawah Grade Seminar Ulang</label>
                    <input type="number" step=".0001" name="sub" class="form-control form-control-sm bg-transparent text-white" value="1" required>
                  </div>
                </div>
