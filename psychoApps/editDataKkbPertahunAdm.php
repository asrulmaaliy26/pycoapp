<?php include( "contentsConAdm.php" );
  ...
  $querySurat = "SELECT * FROM skkb WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="dataKkbPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataKkbPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          <label>Keperluan SKKB</label>
                          <input type="text" name="keperluan" class="form-control form-control-sm" value="<?php echo $dSurat['keperluan'];?>" required>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group date" id="tgl_dmy_one" data-target-input="nearest">
                            <input type="text" name="tgl_awal_berlaku" class="form-control form-control-sm" data-target="#tgl_dmy_one"  data-toggle="datetimepicker" value="<?php echo $dSurat['tgl_awal_berlaku'];?>" required/>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group date" id="tgl_dmy_two" data-target-input="nearest">
                            <input type="text" name="tgl_akhir_berlaku" class="form-control form-control-sm" data-target="#tgl_dmy_two"  data-toggle="datetimepicker" value="<?php echo $dSurat['tgl_akhir_berlaku'];?>" required/>
