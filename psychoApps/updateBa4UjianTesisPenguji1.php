...
$mean_nilai_penguji1_4=mysqli_real_escape_string($con, $_POST['nilai_penguji1_4']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji1_4='$mean_nilai_penguji1_4' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
