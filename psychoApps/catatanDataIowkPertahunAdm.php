<?php include( "contentsConAdm.php" );
  ...
  $sql = "SELECT * FROM siow_kelompok WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small">Form Catatan</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanDataIowkPertahunAdm.php" method="post" enctype="multipart/form-data">
