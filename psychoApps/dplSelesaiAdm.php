            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Pendaftar Sudah Ada DPL dan Lokasi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Pendaftar Sudah Ada DPL dan Lokasi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td rowspan="2" width="8%">Tgl. Pendaftaran</td>
                            <td rowspan="2" width="8%" class="pr-1">Tgl. Verifikasi</td>
                          </tr>
                          <tr class="text-center bg-secondary">
                            <td width="22%" class="pl-1">DPL</td>
                            <td width="24%" class="pr-1">Lokasi</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE peserta_pkl.id_pkl='$id' AND peserta_pkl.statusform='2' ORDER BY dt_mhssw.nama ASC";
