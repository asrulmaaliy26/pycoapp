  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
        ...
        $reload = "pembimbingSkripsi2Proses.php?pagination=true&keyword=$keyword";
        ...
        $sql = "SELECT pds.id
          ...
          WHERE (pds.nim LIKE '%$keyword%' OR dm.nim LIKE '%$keyword%' OR ps.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR dospem_skripsi2.nama LIKE '%$keyword%') AND (pds.dospem_skripsi2=$dtDosen[id]) AND (pds.nim IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]')) ORDER BY dm.nama ASC";

        $result = mysqli_query($con, $sql);
      } else {
        $reload = "pembimbingSkripsi2Proses.php?pagination=true";
        $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$dtDosen[id]' AND nim IN(SELECT nim FROM peserta_ujskrip WHERE nim='$dtNim[nim]') ORDER BY id DESC";
        $result = mysqli_query($con, $sql);
      }
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm mb-2">
              <form method="post" action="pembimbingSkripsi2Proses.php">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
                    ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="pembimbingSkripsi2Proses.php"><i class="fas fa-sync"></i> Kembali</a>
                    <?php
                    }
                    ?>
                  </div>
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                      <li class="nav-item">
                        <a class="nav-link" href="pembimbingSkripsi2.php">Semua (<?php echo $jData; ?>)</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <table class="table table-hover table-bordered table-sm custom mb-0">
                      ...
                      <tbody>
                        ...
                        while (($count < $rpp) && ($i < $tcount)) {
                          ...
                          if (!$dnilai) $dnilai = ['nilai_narsum1' => '0', 'nilai_narsum2' => '0'];
