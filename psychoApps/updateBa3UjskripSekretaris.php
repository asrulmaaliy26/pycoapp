...
$sekretaris3=mysqli_real_escape_string($con, $_POST['sekretaris3']);

$sql="UPDATE nilai_ujskrip SET sekretaris3='$sekretaris3' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
