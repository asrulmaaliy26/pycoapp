  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    ...
    <table width="100%">
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM sending_surat WHERE thn_upload='$thn_upload' AND jenis_surat='3' ORDER BY tgl_upload ASC";
          $result = mysqli_query($con, $sql);
          while($data = mysqli_fetch_array($result)) {
             $no++;
             $qry = "SELECT COUNT(*) AS jumData FROM sending_surat WHERE thn_upload='$thn_upload' AND jenis_surat='3'";
