    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          $reload = "dataKontribEksAskAdm.php?pagination=true";
          $sql = "SELECT * FROM surat_keluar WHERE executor = '$username' GROUP BY tahun ORDER BY tahun DESC";
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry = "SELECT COUNT(*) AS jumData FROM surat_keluar WHERE executor = '$username' AND tahun = '$data[tahun]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-2">
                              <a href="dataKontribEksAskPertahunAdm.php?page=<?php echo $page;?>&tahun=<?php echo $data['tahun'];?>" role="button" class="btn btn-warning btn-block btn-xs" title="Buka"><i class="bi bi-folder2-open"></i></a>
                            </td>
                          </tr>
                          <?php
                            $i++; 
