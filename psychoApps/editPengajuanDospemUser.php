...
<html lang="en">
  ...
  <form action="updatePengajuanDospemUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editPengajuanDospemUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="judul_skripsi" name="judul_skripsi" class="form-control form-control-sm"><?php echo $dataku['judul_skripsi'];?></textarea>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-sm btn-danger">Update pengajuan Dospem Skripsi</button>
                    </div>
                  </div>
                </div>
              </div>
