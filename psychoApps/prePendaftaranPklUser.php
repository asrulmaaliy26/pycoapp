                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" href="prePendaftaranPklUser.php" role="tab" aria-selected="true">Form</a>
                      </li>
                      <li class="nav-item">
                    ...
                    '<div class="card-body">
                       <h5>Pendaftaran Praktik Kerja Lapangan (PKL) Tahap '.$dthp['tahap'].' Semester '.$dsemester['nama'].' '.$dnta['ta'].' belum dibuka. <br>Pendaftaran dibuka mulai tanggal '.$dateStart.' pukul '.$timeStart.' sampai dengan tanggal '.$dateEnd.' pukul '.$timeEnd.'.</h5>
                        ...
                        if($dbio['fakultas_pertama_daftar']=='' || $dbio['jurusan_pertama_daftar']=='' || $dbio['jurusan_pertama_daftar']==''|| $dbio['asal_sekolah']=='' || $dbio['pend_terakhir']=='' || $dbio['dosen_wali']=='' || $dbio['tempat_lahir']=='' || $dbio['tanggal_lahir']=='' || $dbio['jenis_kelamin']=='' || $dbio['alamat_ktp']=='' || $dbio['alamat_malang']=='' || $dbio['kntk']=='' || $dbio['imel']=='' || $dbio['nama_ayah']=='' || $dbio['alamat_ayah']=='' || $dbio['telepon_ayah']=='' || $dbio['nama_ibu']=='' || $dbio['pekerjaan_ibu']=='' || $dbio['alamat_ibu']=='' || $dbio['telepon_ibu']=='' || $dbio['photo']=='') { echo 
                          ...
                          else if(empty($adaIsian['file_transkrip'])) {
                          include ("formPendaftaranPklUserDua.php");}

                          else if(empty($adaIsian['dpl']) && empty($adaIsian['id_dpl'])) {
                          include ("formPendaftaranPklUserTiga.php");}

                          else if(!empty($adaIsian['id_pkl']) && !empty($adaIsian['nim']) && !empty($adaIsian['file_transkrip']) && !empty($adaIsian['dpl'])) { echo
                          '<div class="card-body">
