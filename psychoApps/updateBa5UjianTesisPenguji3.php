...
$mean_nilai_penguji3_5=mysqli_real_escape_string($con, $_POST['nilai_penguji3_5']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji3_5='$mean_nilai_penguji3_5' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
...
header("location:ba5UjianTesisPenguji3.php?page=$page&id=$id_pendaftaran");
?>