      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Dospem I Selesai Pembimbingan</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemSatuSelesaiAdm.php?pagination=true&id=$id";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$id' AND (cek1='2' OR cek1='3') AND status='3' ORDER BY tgl_akhir ASC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Dospem I Selesai Pembimbingan</h4>
