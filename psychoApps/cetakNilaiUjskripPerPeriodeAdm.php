...
<html lang="en">
  <head>
    <title>Data Nilai Ujian Skripsi <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <?php
      ...
      ?>
    <br>
    <span style="text-transform:uppercase;"><b>Data Nilai Ujian Skripsi <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></b>
    <br>
    <br>
