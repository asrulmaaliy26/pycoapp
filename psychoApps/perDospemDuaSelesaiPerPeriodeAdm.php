      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemDuaSelesaiPerPeriodeAdm.php?pagination=true&nip=$nip";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$nip' AND (cek2='2' OR cek2='3') AND status='3' AND id_periode='$id' ORDER BY tgl_akhir ASC";
