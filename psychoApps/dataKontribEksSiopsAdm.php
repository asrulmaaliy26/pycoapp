    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Permohonan Surat Izin Observasi Pra Skripsi</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dataKontribEksSiopsAdm.php?pagination=true";
          $sql = "SELECT * FROM prasips WHERE executor = '$username' GROUP BY thn_pengajuan ORDER BY thn_pengajuan DESC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <h4 class="card-title">Permohonan Surat Izin Observasi Pra Skripsi</h4>
                  </div>
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry = "SELECT COUNT(*) AS jumData FROM prasips WHERE executor = '$username' AND thn_pengajuan = '$data[thn_pengajuan]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-2">
                              <a href="dataKontribEksSiopsPertahunAdm.php?page=<?php echo $page;?>&tahun=<?php echo $data['thn_pengajuan'];?>" role="button" class="btn btn-warning btn-block btn-xs" title="Buka"><i class="bi bi-folder2-open"></i></a>
                            </td>
                          </tr>
                          <?php
                            $i++; 
