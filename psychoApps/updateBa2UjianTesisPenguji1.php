...
$mean_nilai_penguji1_2=mysqli_real_escape_string($con, $_POST['nilai_penguji1_2']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji1_2='$mean_nilai_penguji1_2' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
...
$mean_nilai_penguji1=($dmean['nilai_penguji1_1'] + $dmean['nilai_penguji1_2'] + $dmean['nilai_penguji1_3'] + $dmean['nilai_penguji1_4'] + $dmean['nilai_penguji1_5'] + $dmean['nilai_penguji1_6'] + $dmean['nilai_penguji1_7']) / 7;

$sql="UPDATE mag_nilai_ujtes SET mean_nilai_penguji1='$mean_nilai_penguji1' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
$result = mysqli_query($con, $sql) or die(mysqli_error($con));
...
header("location:ba2UjianTesisPenguji1.php?page=$page&id=$id_pendaftaran");
?>