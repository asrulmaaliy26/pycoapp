...
<html lang="en">
  ...
  <form action="updatePengajuanDospemUserDuaDua.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editPengajuanDospemUserDuaDua.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Lampiran Berkas Transkrip Nilai</a>
                        </li>
                      </ul>
                    </div>
