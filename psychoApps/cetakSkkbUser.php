...
<html lang="en">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:1.1em;">
    <?php
      ...
      ?>
    <br />
    <p style="text-align:center;"><strong><u>SURAT KETERANGAN KELAKUAN BAIK</u></strong><br />
      Nomor:<?php if($dt['no_agenda_surat']=='') {echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';} else {echo $dt['no_agenda_surat'];}?>/<?php echo $dkddekanat3['kd_nmr_srt'];?>/PP.009/<?php echo "$ambilbln";?>/<?php echo "$ambilthn";?>
    </p>
    ...
    <div class="ttd">
      <img width="80%" src="images/ttd_wd3.png">
    </div>
    <div class="right">
