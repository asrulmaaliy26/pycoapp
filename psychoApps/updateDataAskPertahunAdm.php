<?php include( "contentsConAdm.php" );
  ...
  header("location:dataAskPertahunAdm.php?message=notifEdit");
  } else {
  header("location:dataAskPertahunAdm.php?message=notifGagal");
  */
  ...
  header("location:dataAskPertahunAdm.php?page_a=$page_a&tahun=$tahun&page=$page&message=notifEdit");
  ?>