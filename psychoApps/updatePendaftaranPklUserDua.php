...
if (strlen($d2['file_transkrip'])>3)
{
   ...
   mysqli_query($con, "UPDATE peserta_pkl SET file_transkrip='$file_transkrip',tgl_pengajuan='$tgl_pengajuan',thn_pengajuan='$thn_pengajuan',val_adm='$val_adm',statusform='$statusform' WHERE id='$id' LIMIT 1");
