      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">Personal Dospem Tesis</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          include 'pagination.php';
           $reload = "magPersonalPtAdm.php?pagination=true";
              ...
              <section class="col connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <h3 class="card-title">Personal Dospem Tesis</h3>
                  </div>
                      ...
                      <table class="table table-bordered table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="18%">Jumlah Dospem Tesis</th>
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry0 = "SELECT COUNT(id) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE id_periode='$data[id]'";
                            ...
                            $qjumAc = "SELECT COUNT(id_periode) AS jum FROM mag_dospem_tesis WHERE id_periode='$data[id]'";
                          ...
                          <tr>
                            ...
                            <td class="pr-1"><a class="btn btn-outline-success btn-xs btn-block" title="Lihat Personal Academic Coach" href="magPersonalPtPerPeriodeAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>"><i class="fas fa-users"></i></a></td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
