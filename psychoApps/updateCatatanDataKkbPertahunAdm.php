<?php
  ...
  $myqry="UPDATE skkb SET catatan='$catatan' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry) or die(mysqli_error($con));
  header("location:dataKkbPertahunAdm.php?page_a=$page_a&tahun=$tahun&page=$page&message=notifCatatan");
  ?>