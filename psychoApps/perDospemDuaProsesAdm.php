      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Dospem II Proses Pembimbingan</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemDuaProsesAdm.php?pagination=true&id=$id";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$id' AND (cek2='2' OR cek2='3') AND status='2' ORDER BY tgl_mulai ASC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Dospem II Proses Pembimbingan</h4>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="16%">Tgl. Pengajuan</td>
                            <td width="16%" class="pr-1">Tgl. Mulai</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
