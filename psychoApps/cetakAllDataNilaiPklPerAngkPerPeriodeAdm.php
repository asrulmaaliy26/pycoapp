<?php include( "contentsConAdm.php" );
  ...
  $qper = "SELECT * FROM peserta_pkl WHERE angkatan='$angkatan' AND id_pkl='$id_pkl'";
...
<html lang="en">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <?php
      ...
      ?>
    <br>
    <span style="text-transform:uppercase;"><b>Data Nilai PKL Angkatan <?php echo ''.$angkatan.' Pada '. 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></b>
    <br>
    <br>
