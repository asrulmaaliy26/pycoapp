...
$sekretaris1=mysqli_real_escape_string($con, $_POST['sekretaris1']);

$sql="UPDATE nilai_ujskrip SET sekretaris1='$sekretaris1' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
