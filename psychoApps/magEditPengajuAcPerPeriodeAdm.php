      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination1.php';
           $reload1 = "magEditPengajuAcPerPeriodeAdm.php?id=$id&page=$page";
           $sql1 = "SELECT
                      ...
                      <table class="table table-bordered table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="30%">Pilihan Academic Coach</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td  class="pr-1"><?php if($data['cek']==2) {echo '<a class="btn btn-outline-secondary btn-xs btn-block" title="Telah diverifikasi." onclick="return confirm(\'Telah diverifikasi.\')"><i class="far fa-edit"></i></a>';} else if($data['status']==2) {echo '<a class="btn btn-outline-secondary btn-xs btn-block" title="Telah selesai." onclick="return confirm(\'Telah selesai.\')"><i class="far fa-edit"></i></a>';} else { echo '<a class="btn btn-outline-success btn-xs btn-block" title="Edit Pengajuan" href="magEditPengajuAcPerPeriodePerIdAdm.php?idPersonal='.$data['idPersonal'].'&id='.$id.'&page='.$page.'&page1='.$page1.'"><i class="far fa-edit"></a>';}?></td>
                          </tr>
                          <?php
                            $i1++; 
                            $count1++;
