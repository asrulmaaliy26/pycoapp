  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0 mb-3">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatSiowiUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 text-center table-sm custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM siow_individu WHERE nim=$dataku[nim] ORDER BY id DESC";
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakSiowi.php",
            data: dataString,
            cache: false,
