            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataKontribEksAskAdm.php?page=<?php echo $page;?>">Agenda Surat Keluar</a></li>
                  <li class="breadcrumb-item small"><a href="dataKontribEksAskPertahunAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>">Tahun <?php echo $tahun;?></a></li>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM surat_keluar WHERE tahun = '$tahun' AND bulan = '$bulan' AND executor = '$username' ORDER BY ABS(no_berkas) DESC";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-left"><?php $allowedlimit = 54; if(mb_strlen($data['tujuan'])>$allowedlimit) { echo mb_substr($data['tujuan'],0,$allowedlimit)."...";} else {echo $data['tujuan'];}?></td>
                            <td class="text-left" title="<?php echo $data['perihal']=preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $data['perihal']);?>"><?php echo  $data['perihal']=preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $data['perihal']);?></td>
