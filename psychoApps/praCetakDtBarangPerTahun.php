    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          $reload = "praCetakDtBarangPerTahun.php?pagination=true";
          $sql = "SELECT * FROM dt_inventaris_barang GROUP BY thn_perolehan ORDER BY thn_perolehan DESC";
                ...
                <div class="card card-danger card-outline card-outline-tabs">
                  <div class="card-header p-0 pb-1 border-bottom-0">
                    <ul class="nav nav-tabs" id="" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="praCetakDtBarangPerTahun.php" role="tab" aria-selected="true">Tahun Perolehan</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-sm custom">
                        <thead class="thead-light">
                          ...
                          <th width="52%">Tahun Perolehan</th>
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_inventaris_barang WHERE thn_perolehan='$data[thn_perolehan]'";
                            $r_jum = mysqli_query($con,  $qry_jum )or DIE( mysqli_error($con) );
                            $d_jum = mysqli_fetch_assoc( $r_jum );
                            ?>
                          <tr>
                            <td class="text-center pl-1"> <?php echo ++$no_urut;?> </td>
                            <td class="text-left"> <?php echo $data['thn_perolehan'];?> </td>
                            <td class="text-left"> <?php echo $d_jum['jumData'];?> </td>
                            <td class="text-center" width="4%"> <a href="cetakDtBarangPerTahun.php?id=<?php echo $data['thn_perolehan'];?>&page=<?php echo $page;?>" target="_blank" class="btn btn-outline-primary btn-xs btn-block" title="Cetak data"><i class="fas fa-print"></i></a> </td>
                            <td class="text-center pr-1" width="4%"> <a href="eksporDtBarangPerTahun.php?id=<?php echo $data['thn_perolehan'];?>&page=<?php echo $page;?>" class="btn btn-outline-success btn-xs btn-block" title="Ekspor data"><i class="fas fa-file-excel"></i></a> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
