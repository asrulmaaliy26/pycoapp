   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:15px;">
      ...
      <div class="page">
         ...
         <table width="100%">
            ...
            <?php if(empty($dataku['dasar'])) {include "nonDasarStPenunjukan.php";}
            else {include "dasarStPenunjukan.php";}?>
         </table>
         <br />
         <br />
         ...
         <div class="kanan_atas_lampiran">
            <table width="100%" style="font-size:14px;">
               ...
               <tr valign="top" align="justify">
                  ...
                  <td style="padding-top:1px; padding-bottom:1px;"><?php if($dataku['no_agenda_surat']=='') {echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';} else {echo '&nbsp;'.$dataku['no_agenda_surat'];}?>/<?php echo $dkodesrt['kd_nmr_srt'];?>/KP.01.1/<?php echo "$ambilbln";?>/<?php echo "$ambilthn";?>
                  </td>
               </tr>
               <tr valign="top" align="justify">
         ...
         <table class="table-lampiran" align="center">
            ...
            <tbody>
               <?php
                  ...
                  $qjabatanst="select * from opsi_jabatan_instansi WHERE id='$dambilpersonil[jabatan_st]'";
               ...
               <tr>
                  <td><?php echo $no;?>.</td>
                  <td><?php if($dambilpersonil['nama'] == $dtpersonil['id']) { echo $dtpersonil['nama'];} else { echo $dambilpersonil['nama'];}?></td>
                  <td><?php if($dambilpersonil['jabatan_st'] == $dtjabatanst['id']) { echo $dtjabatanst['nm'].' '.$data1['nm'];} else { echo $dambilpersonil['jabatan_st'];}?></td>
               </tr>
               <?php } ?>
            </tbody>
         </table>
