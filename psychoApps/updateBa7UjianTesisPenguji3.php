...
$mean_nilai_penguji3_7=mysqli_real_escape_string($con, $_POST['nilai_penguji3_7']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji3_7='$mean_nilai_penguji3_7' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
...
$mean_nilai_penguji3=($dmean['nilai_penguji3_1'] + $dmean['nilai_penguji3_2'] + $dmean['nilai_penguji3_3'] + $dmean['nilai_penguji3_4'] + $dmean['nilai_penguji3_5'] + $dmean['nilai_penguji3_6'] + $dmean['nilai_penguji3_7']) / 7;

$sql="UPDATE mag_nilai_ujtes SET mean_nilai_penguji3='$mean_nilai_penguji3' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
$result = mysqli_query($con, $sql) or die(mysqli_error($con));
...
header("location:ba7UjianTesisPenguji3.php?page=$page&id=$id_pendaftaran");
?>