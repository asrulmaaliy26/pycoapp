            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="rekapSimagIndividuAdm.php?date=<?php echo $tahun;?>&page=<?php echo $page;?>">Izin Magang Mandiri Individu</a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateSimagIndividuAdm.php" method="post" enctype="multipart/form-data">
