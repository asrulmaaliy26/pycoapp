    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataKontribEksKirimStAdm.php?page=<?php echo $page;?>">Kirim File Surat Tugas</a></li>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dataKontribEksKirimStPertahunAdm.php?pagination=true";
          $sql = "SELECT * FROM sending_surat WHERE jenis_surat = '2' AND thn_upload = '$tahun' AND executor = '$username' GROUP BY bln_upload ORDER BY bln_upload ASC";
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry = "SELECT COUNT(*) AS jumData FROM sending_surat WHERE jenis_surat = '2' AND executor = '$username' AND thn_upload = '$data[thn_upload]' AND bln_upload = '$data[bln_upload]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-2">
                              <a href="dataKontribEksKirimStPerbulanAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>&bulan=<?php echo $data['bln_upload'];?>" role="button" class="btn btn-warning btn-block btn-xs" title="Buka"><i class="bi bi-folder2-open"></i></a>
                            </td>
                          </tr>
                          <?php
                            $i++; 
