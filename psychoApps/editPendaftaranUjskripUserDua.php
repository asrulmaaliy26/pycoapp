...
<html lang="en">
  ...
  <form action="updatePendaftaranUjskripUserDua.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editPendaftaranUjskripUserDua.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Lampiran Berkas</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      <div class="form-group">
                        <label for="file_skripsi">Upload file skripsi (PDF)</label>
                        <input type="file" class="form-control form-control-sm" name="file_skripsi" value="<?php echo $dataku['file_skripsi'];?>">
                      </div>
