<?php include( "contentsConAdm.php" );
  ...
  $querySurat = "SELECT * FROM siprak_mahasiswa WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataIpktmAdm.php?page=<?php echo $page_a;?>">Izin Praktikum Kelompok Testee Mahasiswa</a></li>
                  <li class="breadcrumb-item active small"><a href="dataIpktmPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataIpktmPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          <label>Matakuliah Testee</label>
                          <input type="text" name="matkul_testee" class="form-control form-control-sm" value="<?php echo $dSurat['matkul_testee'];?>" required>
                        </div>
                        <div class="form-group col-6">
                          <label>Dosen Pengampu Matakuliah</label>
                          <input type="text" name="dosen_testee" class="form-control form-control-sm" value="<?php echo $dSurat['dosen_testee'];?>" required>
                        </div>
                      </div>
                      <div class="row">
                        <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee1" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>" required>
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee2" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee3" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee4" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee5" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee6" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>  
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee7" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee8" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee9" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee10" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div> 
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee11" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee12" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee13" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee14" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee15" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee16" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee17" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee18" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee19" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                          <?php 
                        ...
                        <div class="form-group col-6">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="nim_testee20" class="form-control form-control-sm" value="<?php echo $mydata['nim'];?>">
                          </div>
                        </div>
                      </div>
