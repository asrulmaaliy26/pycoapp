          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form method="post" action="sformImporDataMahasiswaS2.php" enctype="multipart/form-data">
                  <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Form Impor</h4>
                      <a href="images/template-impor-data-mahasiswa-s2.xls" type="button" class="btn btn-outline-success btn-xs float-right" title="Download Template Impor"><i class="fas fa-download"></i> Download Template Impor</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="info-box mb-3">
                        <b>Petunjuk:</b>
                        <ul class="list">
                          <li>Form ini untuk impor data <?php echo $dUser['nm'];?> yang belum terdaftar.</li>
                          <li>File yang akan diimpor hanya berekstensi .xls (Excel 97-2003).</li>
                          <li>Silahkan download template file untuk impor data <?php echo $dUser['nm'];?>, dan silahkan baca di sheet "baca petunjuk" untuk pengisian kolom yang tersedia.</li>
                        </ul>
                      </div>
