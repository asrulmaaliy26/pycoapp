      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemSatuPendingAdm.php?pagination=true&id=$id";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$id' AND cek1='1' AND status='1' ORDER BY tgl_pengajuan ASC";
