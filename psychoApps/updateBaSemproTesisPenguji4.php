<?php include( "contentsConAdm.php" );
  ...
  $nilai_penguji4=mysqli_real_escape_string($con, $_POST['nilai_penguji4']);

  $sql="UPDATE mag_nilai_sempro SET nilai_penguji4='$nilai_penguji4' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
