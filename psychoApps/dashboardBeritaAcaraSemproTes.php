    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dashboardBeritaAcaraSemproTes.php?pagination=true&keyword=$keyword";
          ...
          $reload = "dashboardBeritaAcaraSemproTes.php?pagination=true";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dashboardBeritaAcaraSemproTes.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dashboardBeritaAcaraSemproTes.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                      ...
                      <table class="table table-hover table-bordered table-sm custom mb-0">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qnilai =  "SELECT * FROM mag_nilai_sempro WHERE id_pendaftaran='$data[id_pendaftaran]'";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td <?php if($dtDosen['id'] == $data['penguji3']) {echo 'class="text-center pl-1 bg-light"';} else {echo 'class="text-center pl-1"';}?>><?php include ("meanNilaiPenguji3SemproTes.php");?>
                            </td>
                            <td <?php if($dtDosen['id'] == $data['penguji4']) {echo 'class="text-center bg-light"';} else {echo 'class="text-center"';}?>><?php include ("meanNilaiPenguji4SemproTes.php");?>
                            </td>
                            <td <?php if($dtDosen['id'] == $data['penguji1']) {echo 'class="text-center bg-light"';} else {echo 'class="text-center"';}?>><?php include ("meanNilaiPenguji1SemproTes.php");?>
                            </td>
                            <td <?php if($dtDosen['id'] == $data['penguji2']) {echo 'class="text-center pr-1 bg-light"';} else {echo 'class="text-center pr-1"';}?>><?php include ("meanNilaiPenguji2SemproTes.php");?>
                            </td>
                            <td class="text-center"><?php include ("meanNilaiSemproTes.php");?></td>
                            <td class="text-center pr-1">
                              <?php
                                if($data['cekhadir1']==2 && $data['penguji1'] == $dtDosen['id']) { echo "<button class='btn btn-danger btn-block btn-sm' title='Anda tidak hadir dalam seminar ini' disabled><span class='glyphicon glyphicon-ban-circle'></span> Tidak Hadir</button>";}
                                else if($data['cekhadir2']==2 && $data['penguji2'] == $dtDosen['id']) { echo "<button class='btn btn-danger btn-block btn-sm' title='Anda tidak hadir dalam seminar ini' disabled><span class='glyphicon glyphicon-ban-circle'></span> Tidak Hadir</button>";}
                                else if($data['cekhadir3']==2 && $data['penguji3'] == $dtDosen['id']) { echo "<button class='btn btn-danger btn-block btn-sm' title='Anda tidak hadir dalam seminar ini' disabled><span class='glyphicon glyphicon-ban-circle'></span> Tidak Hadir</button>";}
                                else if($data['cekhadir4']==2 && $data['penguji4'] == $dtDosen['id']) { echo "<button class='btn btn-danger btn-block btn-sm' title='Anda tidak hadir dalam seminar ini' disabled><span class='glyphicon glyphicon-ban-circle'></span> Tidak Hadir</button>";}
                                else if (empty($data['tgl_seminar']) && empty($data['jam_mulai']) && empty($data['jam_selesai']) && empty($data['ruang'])) { echo "<button role='button' class='btn btn-outline-secondary btn-xs btn-block' title='Belum terjadwal' disabled><span class='glyphicon glyphicon-ban-circle'></span> Belum Terjadwal</button>";}
                                else if($dnilai['validasi']==1 && $data['penguji3'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji3.php?page=$page&id=$data[id]' role='button' class='btn btn-outline-secondary btn-xs btn-block'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if($dnilai['validasi']==1 && $data['penguji4'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji4.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if($dnilai['validasi']==1 && $data['penguji1'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji1.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if($dnilai['validasi']==1 && $data['penguji2'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji2.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
