<?php include( "contentsConAdm.php" );
  ...
  $sql = "SELECT * FROM sitp WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="rekapSitpAdm.php?date=<?php echo $tahun;?>&page=<?php echo $page;?>">Izin Tempat (Lokasi) PKL</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanSitpAdm.php" method="post" enctype="multipart/form-data">
