      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Input Jadwal Ujian Skripsi</h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Input Jadwal Ujian Skripsi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Input Jadwal Ujian Skripsi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-1"> <?php if($data2['jumData']==0) { echo '<a href="inputJadUjskripPerPeriodeAdm.php?id='.$id_ujskrip.'&page='.$page.'" type="button" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Input jadwal"><i class="far fa-calendar-plus"></i></a>';} else { echo '<a href="inputJadUjskripPerPeriodeAdm.php?id='.$id_ujskrip.'&page='.$page.'" type="button" class="btn btn-outline-success btn-flat btn-xs btn-block" title="Edit jadwal"><i class="far fa-calendar-plus"></i></a>';} ?> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
