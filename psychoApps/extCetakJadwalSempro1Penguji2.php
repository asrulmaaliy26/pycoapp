...
<p style="text-align:center; font-size:18px; text-transform:uppercase;"><strong>JADWAL NARASUMBER II (<?php echo $dqpenguji['nama'];?>)<br />
   ...
   <strong>
      <table width="100%" class="tgl">
         <tr>
            ...
            <td width="82%"><?php echo $dayList1[$day1].', '.bulanIndo($djdwl['tgl_seminar']);?></td>
         </tr>
         <tr>
            <td>Ruang</td>
