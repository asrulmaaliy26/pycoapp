<?php include( "contentsConAdm.php" );
  ...
  $querySurat = "SELECT * FROM sips WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="dataIpsPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataIpsPertahunAdm.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <br />
                        <input type="checkbox" name="bilasama" onclick="IsiSamaNamaObyek(this.form)" <?php if($dSurat['nama_obyek']==$dSurat['lembaga_tujuan_surat']) { echo "checked";}?>> Tempat Penelitian Sama dengan Instansi/Lembaga Tujuan Surat</label>
                        <input type="text" name="nama_obyek" class="form-control form-control-sm" value="<?php echo $dSurat['nama_obyek'];?>" required>
                      </div>
                      <div class="form-group">
                        <label>Judul Skripsi</label>
                        <textarea id="textarea-custom-one" name="judul_skripsi" class="form-control form-control-sm" style="height: 300px;" required><?php echo $dSurat['judul_skripsi'];?></textarea>
                      </div>
                      <div class="row">
                      <div class="form-group col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        <label>Tanggal Akhir Penelitian</label>
                      ...
                      <div class="form-group col-md-4">
                        <label>Pelaksanaan Penelitian Dilakukan Secara</label>
                        <?php
