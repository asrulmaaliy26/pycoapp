<?php include( "contentsConAdm.php" );
  ...
  $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_inventaris_barang WHERE letak=''";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Input DIR</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination0.php';
          $reload0 = "inputDtDir.php?id=$id&page=$page&pagination0=true";
          $sql0 = "SELECT * FROM dt_inventaris_barang WHERE letak='' ORDER BY nm ASC";
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Data Barang Tersisa (<?php echo $d_jum['jumData']?>)</h4>
                      <span class="float-right"><strong><?php echo $d_ruang['nm'];?></strong></span>
                    </div>
                  </div>
                  <div class="card-body pt-2 pb-2 pl-0 pr-0">
                    <form name="update" method="post" action="updateInputDtDir.php" onSubmit="return confirm('Input data terpilih?')">
                      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
                      <input type="text" name="page" class="sr-only" value="<?php echo $page;?>" required readonly>
                      <input type="text" name="page0" class="sr-only" value="<?php echo $page0;?>" required readonly>
                      <div class="form-group">
                        <button name="submit" type="submit" class="btn btn-outline-primary btn-xs float-right mr-3" id="submit1"> <i class="fas fa-plus-square"></i> Input Data Terpilih </button>
                        ...
                        <button name="submit" type="submit" class="btn btn-outline-primary btn-xs float-right mr-3" id="submit2"> <i class="fas fa-plus-square"></i> Input Data Terpilih </button>
                      </div>
                    </form>
                  </div>
