...
$sekretaris5=mysqli_real_escape_string($con, $_POST['sekretaris5']);

$sql="UPDATE nilai_ujskrip SET sekretaris5='$sekretaris5' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
