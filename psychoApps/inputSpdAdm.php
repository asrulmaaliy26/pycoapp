            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small"><a href="rekapSpdAdm.php?page=<?php echo $page;?>">Surat Perjalanan Dinas</a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="sinputSpdAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <?php echo "<select name='penerima' class='form-control form-control-sm'>";
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="textarea-custom-one" name="maksud_spd" class="form-control form-control-sm" style="height: 300px;" required></textarea>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>Tempat Berangkat</label>
                          <?php echo "<select name='tempat_berangkat' class='form-control form-control-sm'>";
                            echo "<option value=''>-Pilih-</option>";
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <?php echo "<select name='durasi_spd' class='form-control form-control-sm'>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil=mysqli_query($con, "SELECT * FROM opsi_durasi_spd ORDER BY id ASC");
                            while($w=mysqli_fetch_array($tampil)){
                              echo "<option value='$w[id]'>$w[durasi] Hari</option>";
                            }
                            echo "</select>";
                             ?>
                        </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <?php echo "<select name='tempat_tujuan' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil=mysqli_query($con, "SELECT * FROM dt_kota ORDER BY nm_kota ASC");
                            while($w=mysqli_fetch_array($tampil)){
                            echo "<option value='$w[id]'>$w[nm_kota]</option>";
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php echo "<select name='tempat_tujuan2' class='form-control form-control-sm'>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil=mysqli_query($con, "SELECT * FROM dt_kota ORDER BY nm_kota ASC");
                            while($w=mysqli_fetch_array($tampil)){
                            echo "<option value='$w[id]'>$w[nm_kota]</option>";
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php echo "<select name='tempat_tujuan3' class='form-control form-control-sm'>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil=mysqli_query($con, "SELECT * FROM dt_kota ORDER BY nm_kota ASC");
                            while($w=mysqli_fetch_array($tampil)){
                            echo "<option value='$w[id]'>$w[nm_kota]</option>";
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <div class="input-group date" id="tgl_dmy_one" data-target-input="nearest">
                            <input type="text" name="tanggal_berangkat" class="form-control form-control-sm" data-target="#tgl_dmy_one" data-toggle="datetimepicker" required/>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <div class="input-group date" id="tgl_dmy_two" data-target-input="nearest">
                            <input type="text" name="tanggal_kembali" class="form-control form-control-sm" data-target="#tgl_dmy_two" data-toggle="datetimepicker" required/>
