...
<html lang="en">
  ...
  <form action="sformSiowiUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" href="formSiowiUser.php" role="tab" aria-selected="true">Form</a>
                        </li>
                        <li class="nav-item">
