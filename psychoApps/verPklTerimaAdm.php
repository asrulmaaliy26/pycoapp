            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Pendaftar Diterima</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Pendaftar Diterima</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="64%">Nama</td>
                            <td width="16%">Tgl. Pendaftaran</td>
                            <td width="16%" class="pr-1">Tgl. Verifikasi</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE peserta_pkl.id_pkl='$id' AND peserta_pkl.val_adm='2' ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php echo $data['tgl_validasi'];?> </td>
                          </tr>
                          <tr class="expandable-body">
                            <td colspan="4"> <?php include("detailPesPklAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
