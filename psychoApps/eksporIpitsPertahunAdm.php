...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Praktikum Individu Testee Siswa Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Praktikum Individu Testee Siswa Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM siprak_siswa WHERE jenis_praktikum = '1' AND thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
