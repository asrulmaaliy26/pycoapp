                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="jadwalSemproUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Jadwal</a>
                        </li>
                    </ul>
                  </div>
                  <div class="card-body pl-0 pr-0 pb-0">
                   <?php
                      $sql = "SELECT * FROM jadwal_sempro WHERE id_sempro='$id_sempro' GROUP BY tgl_seminar ORDER BY tgl_seminar ASC";
                      ...
                      include("tableHariRuangSemproUser.php");
                      include("extConJadSemproUser.php");'
               ';}?>
               </div>
                </div>
              </div>
