<?php include("contentsConAdm.php");
  $qry_jum = "SELECT COUNT(id) AS jumData FROM opsi_kat_pegawai";
  ...
  if(isset($_POST['new']) && $_POST['new']==1)
   ...
   $myqry=mysqli_query($con, "INSERT INTO opsi_kat_pegawai(nm) VALUES ('$nm')");
   header("location:dtKatPeg.php?message=notifInput");
   }
   mysqli_close($con);
  ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
          ...
          <div class="container-fluid">
            <?php
              if (!empty($_GET['message']) && $_GET['message'] == 'notifGagal') {
                  ...
                  <span>Input data gagal! Kategori Pegawai Sudah Ada!</span>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Kategori Pegawai</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtKatPeg.php?pagination=true&keyword=$keyword";
          
          $sql = "SELECT 
          d.id,
          d.nm
                    
          FROM opsi_kat_pegawai d
                    
          WHERE d.id LIKE '%$keyword%' OR d.nm LIKE '%$keyword%' ORDER BY d.nm ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "dtKatPeg.php?pagination=true";
          $sql = "SELECT * FROM opsi_kat_pegawai ORDER BY nm ASC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtKatPeg.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtKatPeg.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Kategori Pegawai: <span class="badge badge-success"><?php echo $d_jum['jumData'];?> Item</span></h4>
                      <button type="button" class="btn btn-outline-success btn-xs float-right" data-toggle="modal" data-target="#inputModal"><i class="far fa-plus-square"></i> Input Kategori Pegawai</button>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-sm custom">
                        <thead class="thead-light">
                          ...
                          <th width="88%">Kategori Pegawai</th>
                        ...
                        <tbody>
                          <?php
                            ...
                            $qkatpegawai =  "SELECT * FROM dt_pegawai WHERE kat_pegawai='$data[id]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center" width="4%"> <a class="btn btn-outline-success btn-xs btn-block" href="editDtKatPeg.php?id=<?php echo $data['id'].'&page='.$page;?>" title="Edit data"><i class="far fa-edit"></i></a> </td>
                            <td class="text-center pr-1" width="4%"> 
                              <?php 
                              if($dkatpegawai['kat_pegawai']==$id)
                                { echo "<a class='btn btn-outline-secondary btn-xs btn-block' onclick='return confirm(\"Tidak bisa dihapus! Data ini berhubungan dengan data lain!\")' title='Tidak bisa dihapus! Data ini berhubungan dengan data lain!' disabled><i class='far fa-trash-alt'></i></a>";} else { echo "<a class='btn btn-outline-danger btn-xs btn-block' href='deleteDtKatPeg.php?id=".$data['id']."&page=".$page."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus data'><i class='far fa-trash-alt'></i></a>";}?> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
    ...
    <form action="dtKatPeg.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title" id="inputModalLabel">Input Kategori Pegawai</h6>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="nm">Kategori Pegawai <span class="text-danger">*</span></label>
