<?php include( "contentsConAdm.php" );
  ...
  $myquery = "SELECT * FROM skkm WHERE id='$id'";
  $res = mysqli_query($con,  $myquery )or die( mysqli_error($con) );
  $dataku = mysqli_fetch_assoc( $res );
  
  $myquery1 = "SELECT * FROM skkm_unsur WHERE id='$dataku[unsur]'";
  $res1 = mysqli_query($con,  $myquery1 )or die( mysqli_error($con) );
  $dataku1 = mysqli_fetch_assoc( $res1 );
     
  $qry2 = "SELECT SUM(krdt) AS jumKredit FROM skkm WHERE nim='$username' AND unsur=$dataku[unsur]";
  $result = mysqli_query($con,  $qry2 );
  $dt = mysqli_fetch_array( $result );
  $jumKredit = $dt[ 'jumKredit' ];
                            
  $query1 = "SELECT * FROM persentase_skkm WHERE id='$dataku[unsur]'";
  ...
  $myquery2 = "SELECT * FROM dt_mhssw WHERE nim='$username'";
  $res2 = mysqli_query($con,  $myquery2 )or die( mysqli_error($con) );
  $dataku2 = mysqli_fetch_assoc( $res2 );
  $angkatan=$dataku2['angkatan'];
...
<html lang="en">
  ...
  <form action="updateSkkmUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editSkkmUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Data Unsur <?php echo $dataku1['unsur'];?></a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      <div class="card card-info card-outline">
                        <div class="card-body pb-0">
                          <ul class="pl-2 text-secondary">
                            <li>Data sub unsur, jenis aitem dan bukti fisik yang diinput pada unsur <?php echo $dataku1['unsur'];?> ini harus sesuai dengan ketentuan yang ada di buku SKKM.</li>
                      ...
                      <div class="form-row">
                        <div class="form-group col-sm-6">
                          ...
                          <input type="text" class="form-control form-control-sm" name="unsur" value="<?php echo $dataku1['unsur'];?>" disabled required>
                        </div>
                        <div class="form-group col-sm-6">
                          <label for="sub_unsur">Sub unsur <span class="text-danger">*</span></label>
                          <?php
                            echo "<select name='sub_unsur' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil = mysqli_query($con,  "SELECT * FROM subunsurskkm ORDER BY nmSubUnsur ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                            if ( $dataku['sub_unsur'] == $w[ 'id' ] ) {
                            echo "<option value='$w[id]' selected>$w[nmSubUnsur]</option>";
                            } else {
                            echo "<option value='$w[id]'>$w[nmSubUnsur]</option>";
                            }
                            }
                            echo "</select>";
                            ?>
                      ...
                      <div class="form-row">
                        <div class="form-group col-sm-6">
                          ...
                          <?php
                            echo "<select name='jenis_aitem' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil = mysqli_query($con,  "SELECT * FROM jenisaitemskkm ORDER BY nmJenisAitem ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                            if ( $dataku['jenis_aitem'] == $w[ 'id' ] ) {
                            echo "<option value='$w[id]' selected>$w[nmJenisAitem]</option>";
                            } else {
                            echo "<option value='$w[id]'>$w[nmJenisAitem]</option>";
                            }
                            }
                            echo "</select>";
                            ?>
                        ...
                        <div class="form-group col-sm-6">
                          ...
                          <?php
                            echo "<select name='bukti_fisik' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil = mysqli_query($con,  "SELECT * FROM buktifisikskkm ORDER BY nmBuktiFisik ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                            if ( $dataku['bukti_fisik'] == $w[ 'id' ] ) {
                            echo "<option value='$w[id]' selected>$w[nmBuktiFisik]</option>";
                            } else {
                            echo "<option value='$w[id]'>$w[nmBuktiFisik]</option>";
                            }
                            }
                            echo "</select>";
                            ?>
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="textarea-custom-one" name="deskrip_unsur" class="form-control form-control-sm" style="height: 300px;" required><?php echo $dataku['deskrip_unsur'];?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="tmpt" value="<?php echo $dataku['tmpt'];?>" required>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-4">
                          ...
                          <div class="input-group date" id="tgl_dmy_one" data-target-input="nearest">
                            <input type="text" name="start_keg" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_dmy_one" value="<?php echo $dataku['start_keg'];?>" required/>
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <div class="input-group date" id="tgl_dmy_two" data-target-input="nearest">
                            <input type="text" name="end_keg" class="form-control form-control-sm datetimepicker-input" data-target="#tgl_dmy_two" value="<?php echo $dataku['end_keg'];?>" required/>
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <?php
                            echo "<select name='krdt' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil = mysqli_query($con,  "SELECT * FROM krdt_skkm ORDER BY no ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                            if ( $dataku['krdt'] == $w[ 'jumlah_krdt' ] ) {
                            echo "<option value='$w[jumlah_krdt]' selected>$w[jumlah_krdt]</option>";
                            } else {
                            echo "<option value='$w[jumlah_krdt]'>$w[jumlah_krdt]</option>";
                            }
                            }
                            echo "</select>";
                            ?>
                      ...
                      <input class="sr-only" type="text" name="tgl_edit" value="<?php echo(date('Y-m-d'));?>" required readonly>
                    </div>
                    <div class="card-footer">
                      <button type="submit" class="btn btn-sm btn-danger">Update data</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group col-sm-9">
                  <div class="card card-info card-outline">
                    <div class="card-header">
                      <h3 class="card-title">Rekap Capaian Kredit Unsur <?php echo $dataku1['unsur'];?></h3>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover m-0 text-center table-sm custom">
                          ...
                          <tbody>
                            <?php
                              $no = 0;
                              $query = "SELECT * FROM skkm WHERE nim='$username' AND unsur='$dataku[unsur]'";
                                ...
                                <section class="content pt-2">
                                  <div class="container-fluid">
                                    <div class="col">
                                      <div class="card">
                                        <div class="card-header">
                                          <h3 class="card-title">Detail Kredit Sub Unsur <?php echo $dataku1['unsur'];?></h3>
                                        </div>
                                        <div class="card-body text-left pb-0">
                                          <dl class="row">
                                            <dt class="col-sm-3">Unsur</dt>
                                            <dd class="col-sm-9"><?php echo $dataku1['unsur'];?></dd>
                  ...
                  <div class="card card-danger card-outline">
                    ...
                    <div class="card-body pb-0">
                      <ul class="pl-2 small text-secondary">
                        <li>Prosentase unsur <?php echo $dataku1['unsur'];?> tidak boleh Kurang dari Standar, harus Sesuai Standar atau Lebih dari Standar.</li>
