<?php
  ...
  $qry_frek = "SELECT COUNT(id) AS jumData FROM peserta_sempro WHERE nim='$dataku[nim]'";
...
<div class="table-responsive">
  <table class="table table-striped m-0 table-bordered text-justify table-sm small custom">
    <tbody>
      ...
      <tr>
        <td scope="row">Judul Proposal</td>
        <td class="text-center">:</td>
        <td><?php echo $dataku['judul_prop']=preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $dataku['judul_prop']);?></td>
      </tr>
      <tr>
