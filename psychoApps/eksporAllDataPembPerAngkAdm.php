...
<html lang="en">
  <head>
    <title>Data Pengajuan Dosen Pembimbing Skripsi Angkatan <?php echo $angkatan;?></title>
    <meta charset="utf-8">
    <style>
      table {
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Pengajuan Dosen Pembimbing Skripsi Angkatan '.$angkatan.'.xls');
      ?> 
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="8">Data Pengajuan Dosen Pembimbing Skripsi Angkatan <?php echo $angkatan;?></th>
        </tr>
        <tr style="border:none;">
    ...
    <table>
      ...
      <tbody>
        <?php
          $no=0;
          $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE angkatan='$angkatan' ORDER BY NIM ASC";
