      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Form Berita Acara Ujian Skripsi</h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Form Berita Acara Ujian Skripsi</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          include 'pagination.php';
           $reload = "rekapBaUjskripAdm.php?pagination=true";
          ...
          <div class="container-fluid">
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Form Berita Acara Ujian Skripsi Per Periode</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <?php if($data1['jumData']==0) { echo '<a href="#" type="button" class="btn btn-outline-secondary btn-flat btn-xs btn-block" title="Tidak ada data">'.$data1['jumData'].'</a>';} else { echo '<a href="rekapPesUjskripPerPeriodeBaAdm.php?id='.$id.'&page='.$page.'" type="button" class="btn btn-outline-primary btn-flat btn-xs btn-block" title="Lihat data">'.$data1['jumData'].'</a>';} ?> </td>
                            <td class="text-center pr-1"> <?php if($data1['jumData']==0) { echo '<a type="button" class="btn btn-outline-secondary btn-flat btn-xs btn-block" title="Tidak ada data" onclick="return confirm(\'Tidak ada data\')"><i class="fas fa-print"></i></a>';} else { echo '<a href="cetakBaUjskripPerPeriodeAdm.php?id='.$id.'&page='.$page.'" type="button" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Cetak berita acara"><i class="fas fa-print"></i></a>';} ?> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
            ...
            <div class="row">
              <?php
                ...
                $reload0 = "rekapBaUjskripAdm.php?pagination0=true";
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <?php if($data11['jumData']==0) { echo '<a type="button" class="btn btn-outline-secondary btn-flat btn-xs btn-block" title="Tidak ada data" onclick="return confirm(\'Tidak ada data\')">'.$data11['jumData'].'</a>';} else { echo '<a href="rekapPesUjskripPerAngkBaAdm.php?angkatan='.$angkatan.'&page0='.$page0.'" type="button" class="btn btn-outline-primary btn-flat btn-xs btn-block" title="Lihat data">'.$data11['jumData'].'</a>';} ?> </td>
                            <td class="text-center pr-1"> <?php if($data11['jumData']==0) { echo '<a type="button" class="btn btn-outline-secondary btn-flat btn-xs btn-block" title="Tidak ada data" onclick="return confirm(\'Tidak ada data\')"><i class="fas fa-print"></i></a>';} else { echo '<a href="cetakBaUjskripPerAngkAdm.php?angkatan='.$angkatan.'&page0='.$page0.'" type="button" class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Cetak berita acara"><i class="fas fa-print"></i></a>';} ?> </td>
                          </tr>
                          <?php
                            $i0++; 
                            $count0++;
