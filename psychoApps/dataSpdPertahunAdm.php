    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a href="dataSpdAdm.php?page=<?php echo $page_a;?>">Surat Perjalanan Dinas</a></li>
        ...
        <?php include 'pagination.php'; 
          ...
          $reload = "dataSpdPertahunAdm.php?pagination=true&keyword=$keyword&tahun=$tahun&page_a=$page_a";
          ...
          $reload = "dataSpdPertahunAdm.php?pagination=true&page_a=$page_a&tahun=$tahun";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dataSpdPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dataSpdPertahunAdm.php?tahun=<?php echo $tahun;?>&page_a=<?php echo $page_a;?>"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td width="4%" class="text-center pl-2"><a href="editDataSpdPertahunAdm.php?id=<?php echo $data['id'];?>&page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>" role="button" class="btn btn-block btn-outline-warning btn-xs" title="Edit SPD"><i class="bi bi-pencil-square"></i></a></td>
                            <td width="4%" class="text-center"><a href="cetakDataSpdPertahunAdm.php?id=<?php echo $data['id'];?>&page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>" role="button" class="btn btn-block btn-outline-secondary btn-xs" target="_blank" title="Cetak SPD"><i class="bi bi-printer"></i></a></td>
                            <td width="4%" class="text-center pr-2"><a href="deleteDataSpdPertahunAdm.php?id=<?php echo $data['id'];?>&page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>" role="button" class="btn btn-block btn-outline-danger btn-xs" onClick="return confirm('Yakin data ini dihapus?')" title="Hapus surat"><i class="bi bi-trash"></i></a></td>
                            </td>
                          </tr>
