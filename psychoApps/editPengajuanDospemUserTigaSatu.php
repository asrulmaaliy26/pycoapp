...
<html lang="en">
  ...
  <form action="updatePengajuanDospemUserTigaSatu.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editPengajuanDospemUserTigaSatu.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit Dosen Pembimbing Skripsi 1</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body">
                      ...
                      <input type="text" name="cek1" class="sr-only" value="<?php echo $dataku['cek1'];?>" required readonly>
                      <input type="text" name="tgl_pengajuan" class="sr-only" value="<?php echo date("d-m-Y");?>" required readonly>
                    </div>
                    <div class="card-footer">
                      <button type="submit" class="btn btn-sm btn-danger">Update dosen pembimbing skripsi 1</button>
                    </div>
                  </div>
                </div>
              </div>
