<?php include( "contentsConAdm.php" );
   ...
   $myquery = "SELECT * FROM prasips WHERE id='$id'";
   ...
   $qkota = "SELECT * FROM dt_kota WHERE id='$dt[kota_observasi]'";
   ...
   $qbln = "SELECT MONTH(tgl_dikeluarkan) AS bulan FROM prasips WHERE id='$id'";
   $resbln = mysqli_query($con,  $qbln )or die( mysqli_error($con) );
   $dbln = mysqli_fetch_assoc( $resbln );
   $ambilbln=$dbln['bulan'];
   
   $qthn = "SELECT YEAR(tgl_dikeluarkan) AS tahun FROM prasips WHERE id='$id'";
   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
      ...
      <table width="100%">
         ...
         <tr>
            <td>Perihal</td>
            <td align="center">:</td>
            <td><strong>IZIN OBSERVASI PRA SKRIPSI</strong></td>
            <td>&nbsp;</td>
         </tr>
         <tr>
            <td>&nbsp;</td>
         ...
         <tr>
            ...
            <td colspan="2" style="text-align:justify;">
               Dengan hormat, <br />
               Sehubungan dengan akan dilaksanakannya proses penyusunan skripsi bagi mahasiswa <?php echo "$nm_lembaga".' '."$nm_lembaga_induk";?>, maka dengan ini kami mohon kepada Bapak/Ibu untuk memberikan izin melakukan kegiatan <b>observasi pra skripsi</b>, kepada:
               <br />
               <br />
               <table width="100%" style="padding-left:30px;">
                  <tr>
                     <td width="40%">Nama / NIM</td>
                     <td width="2%" align="center">:</td>
                     <td width="58%"><?php echo $dataku['nama'].' / '.$dataku['nim'];?></td>
                  </tr>
                  <tr valign="top">
                     <td>Judul Proposal</td>
                     <td align="center">:</td>
                     <td><?php echo $dt['judul_prop']=preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1', $dt['judul_prop']);?></td>
                  </tr>
                  <tr valign="top">
                     <td>Dosen Pembimbing</td>
                     <td align="center">:</td>
                     <td><?php if (empty($dt['dosen_pembimbing2'])) { echo $ddp1['nama'];} else { echo "<ol style='margin-top: 0 !important; padding-left: 1em;'><li>$ddp1[nama]</li><li>$ddp2[nama]</li></ol>";}?></td>
                  </tr>
                  <tr valign="top">
