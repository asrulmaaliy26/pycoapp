            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapSekretarisUjskripAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>">Sekretaris Penguji</a></li>
                  <li class="breadcrumb-item active small">Ekspor Sekretaris Penguji <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Ekspor Sekretaris Penguji <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h4>
                      <span class="badge badge-info float-right"> <?php echo $dqpenguji['nama'];?></span>
                    </div>
                  </div>
                  <div class="card-body p-0">
                   <?php
                      $sql = "SELECT * FROM jadwal_ujskrip WHERE sekretaris_penguji='$id' AND id_ujskrip='$id_ujskrip' GROUP BY tgl_ujian ORDER BY tgl_ujian ASC";
                      ...
                      include("tableHariRuangUjskripSekretarisEkspor.php");
                      include("extConJadUjskripSekretarisEkspor.php");'
                      ';}?>
               </div>
                </div>
              </section>
