    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          $reload = "praCetakDtBarangPerKondisi.php?pagination=true";
          $sql = "SELECT * FROM dt_inventaris_barang GROUP BY kondisi ORDER BY kondisi ASC";
                ...
                <div class="card card-danger card-outline card-outline-tabs">
                  <div class="card-header p-0 pb-1 border-bottom-0">
                    <ul class="nav nav-tabs" id="" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="praCetakDtBarangPerKondisi.php" role="tab" aria-selected="true">Kondisi</a>
                      </li>
                      <li class="nav-item">
                      ...
                      <table class="table table-hover m-0 table-sm custom">
                        ...
                        <tbody>
                          <?php
                            ...
                            $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_inventaris_barang WHERE kondisi='$data[kondisi]'";
                            $r_jum = mysqli_query($con,  $qry_jum )or DIE( mysqli_error($con) );
                            $d_jum = mysqli_fetch_assoc( $r_jum );
                            ?>
                          <tr>
                            ...
                            <td class="text-center" width="4%"> <a href="cetakDtBarangPerKondisi.php?id=<?php echo $data['kondisi'];?>&page=<?php echo $page;?>" target="_blank" class="btn btn-outline-primary btn-xs btn-block" title="Cetak data"><i class="fas fa-print"></i></a> </td>
                            <td class="text-center pr-1" width="4%"> <a href="eksporDtBarangPerKondisi.php?id=<?php echo $data['kondisi'];?>&page=<?php echo $page;?>" class="btn btn-outline-success btn-xs btn-block" title="Ekspor data"><i class="fas fa-file-excel"></i></a> </td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
