<?php
  ...
  $myqry="UPDATE prasips SET catatan='$catatan' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry) or die(mysqli_error($con));
  header("location:dataIopsPertahunAdm.php?page_a=$page_a&tahun=$tahun&page=$page&message=notifCatatan");
  ?>