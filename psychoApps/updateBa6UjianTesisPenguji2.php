...
$mean_nilai_penguji2_6=mysqli_real_escape_string($con, $_POST['nilai_penguji2_6']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji2_6='$mean_nilai_penguji2_6' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
