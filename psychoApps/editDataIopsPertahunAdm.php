<?php include( "contentsConAdm.php" );
  ...
  $querySurat = "SELECT * FROM prasips WHERE id='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="dataIopsPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataIopsPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <?php
                            echo "<select name='kota_observasi' class='form-control form-control-sm' required>";
                            echo "<option value=''>-Pilih-</option>";
                            $tampil = mysqli_query($con,  "SELECT * FROM dt_kota ORDER BY nm_kota ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                              if ( $dSurat['kota_observasi'] == $w[ 'id' ] ) {
                      ...
                      <div class="form-group">
                        ...
                        <br />
                        <input type="checkbox" name="bilasama" onclick="IsiSamaNamaObyek(this.form)" <?php if($dSurat['nama_obyek']==$dSurat['lembaga_tujuan_surat']) { echo "checked";}?>> Tempat Observasi dan Wawancara Sama dengan Instansi/Lembaga Tujuan Surat</label>
                        <input type="text" name="nama_obyek" class="form-control form-control-sm" value="<?php echo $dSurat['nama_obyek'];?>" required>
                      </div>
                      <div class="form-group">
                        <label>Judul Proposal</label>
                        <textarea id="textarea-custom-one" name="judul_prop" class="form-control form-control-sm" style="height: 300px;" required><?php echo $dSurat['judul_prop'];?></textarea>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <?php
                            ...
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                              if ( $dSurat['dosen_pembimbing1'] == $w[ 'id' ] ) {
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <?php
                            ...
                            $tampil = mysqli_query($con,  "SELECT * FROM dt_pegawai WHERE jenis_pegawai = '1' ORDER BY nama_tg ASC" );
                            while ( $w = mysqli_fetch_array( $tampil ) ) {
                              if ( $dSurat['dosen_pembimbing2'] == $w[ 'id' ] ) {
                                 echo "<option value='$w[id]' selected>$w[nama_tg]</option>";
                              } else {
                                 echo "<option value='$w[id]'>$w[nama_tg]</option>";
                              }
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          <label>Tanggal Akhir Observasi</label>
                        ...
                        <div class="form-group col-md-4">
                          <label>Pelaksanaan Observasi Dilakukan Secara</label>
                          <?php
