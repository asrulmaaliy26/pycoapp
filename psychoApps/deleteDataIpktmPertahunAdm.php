<?php include( "contentsConAdm.php" );
   ...
   $myquery =  "DELETE FROM siprak_mahasiswa WHERE id='$id' LIMIT 1";
   $hapus = mysqli_query($con, $myquery) or die ("gagal menghapus");
   
   $myquery =  "DELETE FROM testee_siprak WHERE id_siprak='$id'";
   $hapus = mysqli_query($con, $myquery) or die ("gagal menghapus");

   header("location:dataIpktmPertahunAdm.php?page_a=$page_a&tahun=$tahun&page=$page&message=notifDelete");
