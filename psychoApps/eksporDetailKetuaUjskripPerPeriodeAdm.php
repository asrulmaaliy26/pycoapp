            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Ekspor Ketua Penguji <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Ekspor Ketua Penguji <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h4>
                  ...
                  <div class="card-body p-0">
                   <?php
                      ...
                      include("tableHariRuangUjskripKetuaEkspor.php");
                      include("extConJadUjskripKetuaEkspor.php");'
                      ';}?>
               </div>
                </div>
              </section>
