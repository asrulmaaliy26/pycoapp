<?php include( "contentsConAdm.php" );  
  ...
  $qry_dir = "SELECT * FROM dt_ruang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Letak <?php echo $d_dir['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG LETAK <?php echo strtoupper($d_dir['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE letak='$id' ORDER BY DATE(tgl_perolehan) DESC";
