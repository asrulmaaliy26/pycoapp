    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Berkas Pegawai</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtBerkasPegawai.php?pagination=true&keyword=$keyword";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtBerkasPegawai.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtBerkasPegawai.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Berkas Pegawai: <span class="badge badge-success"><?php echo $d_jum['jumData'];?> Item</span></h4>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-sm custom">
                        <thead class="thead-light">
                          ...
                          <th width="40%">Nama</th>
                          <th width="46%">NIP/Id Lainnya</th>
                          <th class="pr-1 text-center" width="10%">Opsi</th>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-1"><a class="btn btn-outline-success btn-xs btn-block" href="dtBerkasPerPegawai.php?id=<?php echo ''.$data['id'].'&page='.$page.'';?>" title="Lihat berkas"><i class="fas fa-database"></i> Lihat Berkas</a></td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
