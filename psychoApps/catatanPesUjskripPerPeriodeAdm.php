<?php include( "contentsConAdm.php" );
  ...
  $sql = "SELECT * FROM peserta_ujskrip INNER JOIN dt_mhssw ON peserta_ujskrip.nim=dt_mhssw.nim WHERE peserta_ujskrip.nim='$nim' AND peserta_ujskrip.id_ujskrip='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a class="text-info" href="verPndftrUjskripPerPeriodeAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>">Opsi Verifikasi Pendaftar</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanPesUjskripPerPeriodeAdm.php" method="post" enctype="multipart/form-data">
