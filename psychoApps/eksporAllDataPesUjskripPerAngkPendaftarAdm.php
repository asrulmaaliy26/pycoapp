...
<html lang="en">
  <head>
    <title>Data Pendaftar Ujian Skripsi Angkatan <?php echo "$angkatan";?></title>
    <meta charset="utf-8">
    <style>
      table {
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Pendaftar Ujian Skripsi Angkatan '.$angkatan.'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="13">Data Pendaftar Ujian Skripsi Angkatan <?php echo "$angkatan";?>
          </th>
        </tr>
        <tr style="border:none;">
    ...
    <table>
      ...
      <tbody>
        <?php
          ...
          $qidper = "SELECT * FROM pendaftaran_ujskrip WHERE id='$data[id_ujskrip]'";
