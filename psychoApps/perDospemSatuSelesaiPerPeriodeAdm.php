      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemSatuSelesaiPerPeriodeAdm.php?pagination=true&nip=$nip";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi1='$nip' AND (cek1='2' OR cek1='3') AND status='3' AND id_periode='$id' ORDER BY tgl_akhir ASC";
