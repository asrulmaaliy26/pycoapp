...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Observasi Pra Skripsi Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Observasi Pra Skripsi Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
          ...
          <th width="52%">Tempat Observasi</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM prasips WHERE thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
