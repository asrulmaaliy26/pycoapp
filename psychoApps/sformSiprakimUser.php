<?php include( "contentsConAdm.php" );
   ...
   mysqli_query($con, "INSERT INTO siprak_mahasiswa(id,nim,jenis_praktikum,nama_testee,nim_testee,matkul_testee,dosen_testee,matkul,waktu,jam,tgl_pengajuan,bln_pengajuan,thn_pengajuan,wd1,statusform)" .
   "values('$id','$nim','$jenis_praktikum','$nama_testee','$nim_testee','$matkul_testee','$dosen_testee','$matkul','$waktu','$jam','$tgl_pengajuan','$bln_pengajuan','$thn_pengajuan','$wd1','$statusform')") or die(mysqli_error($con));

   header("location:riwayatSiprakimUser.php?message=notifInput");
   ?>