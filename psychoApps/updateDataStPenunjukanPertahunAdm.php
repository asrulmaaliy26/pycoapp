<?php include( "contentsConAdm.php" );
   ...
   mysqli_query($con, $qry) or die(mysqli_error($con));
   $qry="UPDATE personil_st SET nama='$nama10',jabatan_st='$mydata10' WHERE id_st='$id' AND urutan='10' LIMIT 1";
   mysqli_query($con, $qry) or die(mysqli_error($con));
   $qry="UPDATE personil_st SET nama='$nama11',jabatan_st='$mydata11' WHERE id_st='$id' AND urutan='11' LIMIT 1";
   mysqli_query($con, $qry) or die(mysqli_error($con));
   $qry="UPDATE personil_st SET nama='$nama12',jabatan_st='$mydata12' WHERE id_st='$id' AND urutan='12' LIMIT 1";
   mysqli_query($con, $qry) or die(mysqli_error($con));
   ...
   mysqli_query($con, $qry) or die(mysqli_error($con));
   $qry="UPDATE personil_st SET nama='$nama66',jabatan_st='$jabatan66' WHERE id_st='$id' AND urutan='66' LIMIT 1";
   mysqli_query($con, $qry) or die(mysqli_error($con));
   $qry="UPDATE personil_st SET nama='$nama67',jabatan_st='$jabatan67' WHERE id_st='$id' AND urutan='67' LIMIT 1";
   mysqli_query($con, $qry) or die(mysqli_error($con));
