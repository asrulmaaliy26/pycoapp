<?php
  ...
  $myqry1="UPDATE prasips SET statusform='$statusform',tgl_proses='' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry1) or die(mysqli_error($con));
  }
  elseif(mysqli_real_escape_string($con, $_POST['statusform'])=='2') {
  $myqry1="UPDATE prasips SET statusform='$statusform',tgl_proses='$tgl_proses',tgl_dikeluarkan='$tgl_dikeluarkan' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry1) or die(mysqli_error($con));
  }
  elseif(mysqli_real_escape_string($con, $_POST['statusform'])=='3') {
  $myqry1="UPDATE prasips SET statusform='$statusform',tgl_dikeluarkan='$tgl_dikeluarkan',tgl_selesai='$tgl_selesai' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry1) or die(mysqli_error($con));
  }
  else {
  $myqry1="UPDATE prasips SET statusform='$statusform' WHERE id='$id' LIMIT 1";
  mysqli_query($con, $myqry1) or die(mysqli_error($con));
  }
  header("location:dataIopsPertahunAdm.php?page_a=$page_a&tahun=$tahun&page=$page&message=notifEdit");
  ?>