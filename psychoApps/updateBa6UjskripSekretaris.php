...
$sekretaris6=mysqli_real_escape_string($con, $_POST['sekretaris6']);

$sql="UPDATE nilai_ujskrip SET sekretaris6='$sekretaris6' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
