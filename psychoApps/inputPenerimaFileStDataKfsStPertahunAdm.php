            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataKfsStPertahunAdm.php?page_a=<?php echo $page_a;?>&thn_upload=<?php echo $thn_upload;?>&page=<?php echo $page;?>">Tahun <?php echo $thn_upload;?></a></li>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body pt-2 pb-2 pl-0 pr-0">
                    <form action="sinputPenerimaFileStDataKfsStPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <input type="text" class="sr-only" name="jenis_surat" value="2" readonly required>
