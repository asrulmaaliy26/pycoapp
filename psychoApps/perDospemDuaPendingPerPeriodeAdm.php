      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "perDospemDuaPendingPerPeriodeAdm.php?pagination=true&nip=$nip";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$nip' AND cek2='1' AND status='1' AND id_periode='$id' ORDER BY tgl_pengajuan ASC";
