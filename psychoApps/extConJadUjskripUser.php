   ...
   <table class="table m-0 table-bordered table-sm small custom">
      <thead>
         <tr>
            ...
            <th width="30%" class="text-center">Judul Skripsi</th>
            <th width="14%" class="text-center">Sekretaris Penguji</th>
            <th width="14%" class="text-center pr-1">Ketua Penguji</th>
      ...
      <tbody class="text-muted" style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM jadwal_ujskrip WHERE id_ujskrip='$data[id_ujskrip]' AND tgl_ujian='$data[tgl_ujian]' ORDER BY jam_mulai ASC";
