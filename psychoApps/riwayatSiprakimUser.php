  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatSiprakimUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <table class="table table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="30%">Nama NIM testee</th>
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM siprak_mahasiswa WHERE nim=$dataku[nim] AND jenis_praktikum='1' ORDER BY id DESC";
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakSiprakim.php",
            data: dataString,
            cache: false,
