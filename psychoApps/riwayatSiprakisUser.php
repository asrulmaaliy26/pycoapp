  ...
  <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-8">
                <ol class="mt-2 breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">Izin Praktikum Individu Testee Siswa</li>
                </ol>
              </div>
            </div>
          </div>
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link" href="formSiprakisUser.php" role="tab" aria-selected="true">Form</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatSiprakisUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <table class="table table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="30%">Nama testee</th>
                            <th width="26%">Matakuliah praktikum</th>
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM siprak_siswa WHERE nim=$dataku[nim] AND jenis_praktikum='1' ORDER BY id DESC";
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakSiprakis.php",
            data: dataString,
            cache: false,
