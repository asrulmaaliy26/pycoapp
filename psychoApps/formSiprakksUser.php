...
<html lang="en">
  ...
  <form action="sformSiprakksUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" href="formSiprakksUser.php" role="tab" aria-selected="true">Form</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="card-body pb-0">
                      <div class="form-row">
                        <div class="form-group col-sm-6">
                          ...
                          <input type="text" class="form-control form-control-sm" name="tujuan_prak" placeholder="Nama lembaga yang siswa/santri/anak asuhnya akan Anda gunakan sebagai testee." required>
                        </div>
                        <div class="form-group col-sm-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-sm-4">
                          ...
                          <select name="kota_prak" class="form-control form-control-sm" required>
                            <option value="">-Pilih-</option>
                            <?php
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <select name="jenjang_testee" class="form-control form-control-sm" required>
                            <option value="">-Pilih-</option>
                            <?php
                              $q = mysqli_query($con, "SELECT * FROM jenjang_testee ORDER BY nama ASC");
                              while ($tampil = mysqli_fetch_array($q)){
                      ...
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                          ...
                          <input type="text" class="form-control form-control-sm" name="testee1" placeholder="Satu nama per kolom." required>
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee2">Testee 2 <span class="text-danger">*</span></label>
                          <input type="text" class="form-control form-control-sm" name="testee2" placeholder="Satu nama per kolom." required>
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee3">Testee 3</label>
                          <input type="text" class="form-control form-control-sm" name="testee3" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee4">Testee 4</label>
                          <input type="text" class="form-control form-control-sm" name="testee4" placeholder="Satu nama per kolom.">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                          <label for="testee5">Testee 5</label>
                          <input type="text" class="form-control form-control-sm" name="testee5" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee6">Testee 6</label>
                          <input type="text" class="form-control form-control-sm" name="testee6" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee7">Testee 7</label>
                          <input type="text" class="form-control form-control-sm" name="testee7" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee8">Testee 8</label>
                          <input type="text" class="form-control form-control-sm" name="testee8" placeholder="Satu nama per kolom.">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                          <label for="testee9">Testee 9</label>
                          <input type="text" class="form-control form-control-sm" name="testee9" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee10">Testee 10</label>
                          <input type="text" class="form-control form-control-sm" name="testee10" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee11">Testee 11</label>
                          <input type="text" class="form-control form-control-sm" name="testee11" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee12">Testee 12</label>
                          <input type="text" class="form-control form-control-sm" name="testee12" placeholder="Satu nama per kolom.">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                          <label for="testee13">Testee 13</label>
                          <input type="text" class="form-control form-control-sm" name="testee13" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee14">Testee 14</label>
                          <input type="text" class="form-control form-control-sm" name="testee14" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee15">Testee 15</label>
                          <input type="text" class="form-control form-control-sm" name="testee15" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee16">Testee 16</label>
                          <input type="text" class="form-control form-control-sm" name="testee16" placeholder="Satu nama per kolom.">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-sm-3">
                          <label for="testee17">Testee 17</label>
                          <input type="text" class="form-control form-control-sm" name="testee17" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee18">Testee 18</label>
                          <input type="text" class="form-control form-control-sm" name="testee18" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee19">Testee 19</label>
                          <input type="text" class="form-control form-control-sm" name="testee19" placeholder="Satu nama per kolom.">
                        </div>
                        <div class="form-group col-sm-3">
                          <label for="testee20">Testee 20</label>
                          <input type="text" class="form-control form-control-sm" name="testee20" placeholder="Satu nama per kolom.">
                        </div>
                      </div>
