            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Pendaftar Belum Diverifikasi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Pendaftar Belum Diverifikasi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="80%">Nama</td>
                            <td width="16%" class="pr-1">Tgl. Pendaftaran</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE peserta_pkl.id_pkl='$id' AND peserta_pkl.val_adm='1' ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr class="expandable-body">
                            <td colspan="3"> <?php include("detailPesPklAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
