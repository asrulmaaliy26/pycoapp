                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <?php if(empty($data['file_skripsi'])) { echo '<a class="btn btn-outline-secondary btn-flat btn-xs btn-block" onclick="return confirm(\'Tidak ada file!\')" title="Tidak ada file" disabled><i class="fas fa-download"></i></a>';} else { echo '<a class="btn btn-outline-info btn-flat btn-xs btn-block" title="Lihat/download" href="'.$data['file_skripsi'].'" target="_blank"><i class="fas fa-download"></i></a>';}?> </td>
                            <td width="16%" class="text-center">
                              ...
                              <?php
                                ...
                                "</select>";}
                                else { include "opsiVerpesUjskripPerPeriodeAdm.php";}?>
                            </td>
                            <td width="10%" class="text-center"><a href="catatanPesUjskripPerPeriodeAdm.php?id=<?php echo $id;?>&id_pendaftar=<?php echo $data['id'];?>&nim=<?php echo $data['nim'];?>&page=<?php echo $page;?>" type="button" class="btn btn-outline-success btn-flat btn-xs btn-block" title="Beri catatan"><i class="far fa-comment-alt"></i> Beri Catatan</a>
                            </td>
