            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapPenguji1SemproAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>">Penguji I</a></li>
                  <li class="breadcrumb-item active small">Ekspor Penguji I <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Ekspor Penguji I <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h4>
                      <span class="badge badge-info float-right"> <?php echo $dqpenguji['nama'];?></span>
                    </div>
                  </div>
                  <div class="card-body p-0">
                   <?php
                      $sql = "SELECT * FROM jadwal_sempro WHERE penguji1='$id' AND id_sempro='$id_sempro' GROUP BY tgl_seminar ORDER BY tgl_seminar ASC";
                      ...
                      include("tableHariRuangSemproPenguji1Ekspor.php");
                      include("extConJadSemproPenguji1Ekspor.php");'
                      ';}?>
               </div>
                </div>
              </section>
