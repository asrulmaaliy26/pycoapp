...
$mean_nilai_penguji4_3=mysqli_real_escape_string($con, $_POST['nilai_penguji4_3']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji4_3='$mean_nilai_penguji4_3' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
...
header("location:ba3UjianTesisPenguji4.php?page=$page&id=$id_pendaftaran");
?>