<?php include( "contentsConAdm.php" );  
  ...
  $qry_sumber_dn = "SELECT * FROM opsi_sumber_dana_perolehan_barang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Sumber Dana Perolehan <?php echo $d_sumber_dn['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG SUMBER DANA PEROLEHAN <?php echo strtoupper($d_sumber_dn['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE sumber_dana='$id' ORDER BY DATE(tgl_perolehan) DESC";
