            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Nilai dari Utama Penguji Belum Diisi</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Nilai dari Utama Penguji Belum Diisi</h4>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_ujskrip INNER JOIN dt_mhssw ON peserta_ujskrip.nim=dt_mhssw.nim INNER JOIN nilai_ujskrip ON peserta_ujskrip.id=nilai_ujskrip.id_pendaftaran WHERE peserta_ujskrip.id_ujskrip='$id' AND nilai_ujskrip.nilai_utama IS NULL ORDER BY dt_mhssw.nama ASC";
