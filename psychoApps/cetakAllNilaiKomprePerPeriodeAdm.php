...
<html lang="en">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <?php
      ...
      ?>
    <br>
    <span style="text-transform:uppercase;"><b>Data Nilai Ujian Komprehensif <?php echo 'Tahap '.$dthp['tahap'].' ('.$djp['nm'].') '.$dsemester['nama'].' '.$dnta['ta'].'';?></b>
    <br>
    Passing Grade: <?php echo $didper['passing_grade'];?></b></span>
    <br>
    <br>
