<?php include( "contentsConAdm.php" );
  ...
  $sql = "SELECT * FROM peserta_sempro INNER JOIN dt_mhssw ON peserta_sempro.nim=dt_mhssw.nim WHERE peserta_sempro.nim='$nim' AND peserta_sempro.id_sempro='$id'";
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a class="text-info" href="verPndftrSemproPerPeriodeAdm.php?id=<?php echo $id;?>&page=<?php echo $page;?>">Opsi Verifikasi Pendaftar</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form action="updateCatatanPesSemproPerPeriodeAdm.php" method="post" enctype="multipart/form-data">
