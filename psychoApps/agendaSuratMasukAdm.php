    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Masuk</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "agendaSuratMasukAdm.php?pagination=true&keyword=$keyword";
          ...
          $reload = "agendaSuratMasukAdm.php?pagination=true";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-4 mb-2">
                <form method="post" action="agendaSuratMasukAdm.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="agendaSuratMasukAdm.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <div class="col-sm-8 mb-2">
                <a href="inputAgendaSuratMasukAdm.php?page=<?php echo $page;?>" class="btn btn-outline-danger btn-sm float-sm-right"><i class="bi bi-envelope-plus"></i> Input data</a>
              </div>
            </div>
            <div class="row">
                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td width="4%" class="text-center pl-2"><a href="editAgendaSuratMasukAdm.php?id=<?php echo $data['id'];?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-warning btn-block btn-xs" title="Edit agenda"><i class="bi bi-pencil-square"></i></a></td>
                            <td width="4%" class="text-center"> <a href="cetakDisposisiAdm.php?id=<?php echo $data['id'];?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-secondary btn-block btn-xs" target="_blank" title="Cetak disposisi"><i class="bi bi-printer"></i></a></td>
                            <td width="4%" class="text-center pr-2"><a href="deleteAgendaSuratMasukAdm.php?id=<?php echo $data['id'];?>&page=<?php echo $page;?>" role="button" class="btn btn-outline-danger btn-block btn-xs" onClick="return confirm('Yakin data ini dihapus?')" title="Hapus agenda"><i class="bi bi-trash"></i></a></td>
                          </tr>
