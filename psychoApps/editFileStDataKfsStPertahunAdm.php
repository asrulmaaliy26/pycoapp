            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a href="dataKfsStAdm.php?page=<?php echo $page_a;?>">Kirim File Surat Keputusan</a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateFileStDataKfsStPertahunAdm.php" method="post" enctype="multipart/form-data">
