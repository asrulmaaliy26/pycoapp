      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Total Proses Pembimbingan Skripsi</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php
          ...
          if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>""){
            ...
            $reload = "allProsPembAdm.php?pagination=true&keyword=$keyword";
            ...
            WHERE (pds.nim LIKE '%$keyword%' OR dm.nama LIKE '%$keyword%' OR dp1.nama LIKE '%$keyword%' OR dp2.nama LIKE '%$keyword%' OR pds.ipk LIKE '%$keyword%' OR pds.sks_ditempuh LIKE '%$keyword%' OR pds.judul_skripsi LIKE '%$keyword%' OR pds.var_1 LIKE '%$keyword%' OR pds.var_2 LIKE '%$keyword%' OR pds.var_3 LIKE '%$keyword%' OR pds.var_4 LIKE '%$keyword%' OR pds.tgl_mulai LIKE '%$keyword%' OR pds.thn_mulai LIKE '%$keyword%' OR otuu.tahap LIKE '%$keyword%' OR ons.nama LIKE '%$keyword%' OR ojs.nm LIKE '%$keyword%' OR obs.nm LIKE '%$keyword%' OR ojp.opsi LIKE '%$keyword%' OR ovpd1.nm LIKE '%$keyword%' OR ovpd2.nm LIKE '%$keyword%' OR ovpd3.nm LIKE '%$keyword%' OR ospd.nm LIKE '%$keyword%') AND (pds.status='2') ORDER BY dm.nama ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "allProsPembAdm.php?pagination=true";
          $sql = "SELECT *
            FROM pengelompokan_dospem_skripsi INNER JOIN dt_mhssw on pengelompokan_dospem_skripsi.nim = dt_mhssw.nim WHERE pengelompokan_dospem_skripsi.status='2' ORDER BY dt_mhssw.nama ASC";
          $result = mysqli_query($con, $sql);
           }
        ...
        <section class="content">
          <div class="container-fluid">
            <div class="row">
              <div class="col mb-2">
                <form method="post" action="allProsPembAdm.php?page=<?php echo $page;?>">
                  ...
                  <div class="input-group input-group-sm">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a role="button" class="btn btn-outline-secondary pl-3 pr-3" title="Refresh" href="allProsPembAdm.php?page=<?php echo $page;?>"><i class="fas fa-sync pr-2"></i>Refresh</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Total Proses Pembimbingan Skripsi</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td width="18%">Dospem I</td>
                            <td width="18%">Dospem II</td>
                            <td width="10%">Tgl. Pengajuan</td>
                            <td width="10%" class="pr-1">Tgl. Mulai</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php echo $data['tgl_mulai'];?> </td>
                          </tr>
