...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Pendaftar Ujian Komprehensif Tahap '.$dthp['tahap'].' ('.$djp['nm'].') '.$dsemester['nama'].' '.$dnta['ta'].'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="12">Data Pendaftar Ujian Komprehensif <?php echo 'Tahap '.$dthp['tahap'].' ('.$djp['nm'].') '.$dsemester['nama'].' '.$dnta['ta'].'';?>
          <br>
          Passing Grade: <?php echo $didper['passing_grade'];?> 
          </th>
        </tr>
        <tr style="border:none;">
