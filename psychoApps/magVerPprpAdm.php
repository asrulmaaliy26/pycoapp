      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "magVerPprpAdm.php?pagination=true";
                      ...
                      <table class="table table-bordered table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th rowspan="2" width="36%">Angkatan</th>
                          ...
                          <tr>
                            ...
                            <th width="8%">Total</th>
                            <th width="8%">Belum</th>
                            <th class="pr-1" width="8%">Selesai</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td class="pr-1"><a href='magVerPprpPerAngkatanAdm.php?id=<?php echo "$angkatan";?>&page=<?php echo "$page";?>' type="button" class="btn btn-outline-success btn-xs btn-block" title='Verifikasi'><i class="far fa-edit"></i></a></td>
                          </tr>
                          <?php
                            $i++; 
                            $count++;
