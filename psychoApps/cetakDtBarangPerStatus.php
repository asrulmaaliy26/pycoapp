<?php include( "contentsConAdm.php" );  
  ...
  $qry_ospb = "SELECT * FROM opsi_status_peminjaman_barang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Status <?php echo $d_ospb['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG STATUS <?php echo strtoupper($d_ospb['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE status_peminjaman='$id' ORDER BY DATE(tgl_perolehan) DESC";
