...
<div class="table-responsive" style="margin-bottom:30px;">
   <table class="table m-0 table-bordered table-sm small custom">
      ...
      <tbody class="text-muted" style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM jadwal_ujskrip WHERE sekretaris_penguji='$data[sekretaris_penguji]' AND id_ujskrip='$data[id_ujskrip]' AND tgl_ujian='$data[tgl_ujian]' ORDER BY jam_mulai ASC";
         ...
         <tr>
            ...
            <td class="text-left bg-secondary"><?php echo $dp1['nama'];?></td>
            <td class="text-left"><?php echo $dp2['nama'];?></td>
            <td class="text-left pr-1"><?php echo $dp3['nama'];?></td>
         </tr>
         <?php 
            }
            ?>
