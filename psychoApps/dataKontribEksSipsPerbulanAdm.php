            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item small"><a href="dataKontribEksSipsPertahunAdm.php?page=<?php echo $page;?>&tahun=<?php echo $tahun;?>">Tahun <?php echo $tahun;?></a></li>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover table-sm custom mb-0">
                        <thead class="thead-light">
                          ...
                          <th scope="col" width="44%" class="text-left">Tempat Penelitian</th>
                          <th scope="col" width="12%" class="text-center">Status</th>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM sips WHERE thn_pengajuan = '$tahun' AND bln_pengajuan = '$bulan' AND executor = '$username' ORDER BY id DESC";
