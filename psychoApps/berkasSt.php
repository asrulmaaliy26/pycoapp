  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active small">ST (Surat Tugas)</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
        ...
        $reload = "berkasSt.php?pagination=true&keyword=$keyword";
        ...
        $sql = "SELECT ps.id
          ...
          WHERE (ps.id_sending_surat LIKE '%$keyword%' OR ps.jenis_surat_penerima LIKE '%$keyword%' OR ps.penerima LIKE '%$keyword%' OR ps.tgl_kirim LIKE '%$keyword%' OR ps.bln_kirim LIKE '%$keyword%' OR ps.thn_kirim LIKE '%$keyword%' OR ss.deskripsi LIKE '%$keyword%' OR ss.jenis_surat LIKE '%$keyword%' OR ss.file_surat LIKE '%$keyword%' OR ss.tgl_upload LIKE '%$keyword%' OR ss.bln_upload LIKE '%$keyword%' OR ss.thn_upload LIKE '%$keyword%' OR ss.catatan LIKE '%$keyword%' OR ss.executor LIKE '%$keyword%' OR ss.editor LIKE '%$keyword%' OR ojfs.nm LIKE '%$keyword%' OR ab.nm_person LIKE '%$keyword%') AND ps.penerima=$dtDosen[id] AND ps.jenis_surat_penerima = '2' GROUP BY ps.id ORDER BY ps.id_sending_surat DESC";

        $result = mysqli_query($con, $sql);
      } else {
        $reload = "berkasSt.php?pagination=true";
        $sql = "SELECT * FROM penerima_surat WHERE penerima='$dtDosen[id]' AND jenis_surat_penerima ='2' ORDER BY id_sending_surat DESC";
        $result = mysqli_query($con, $sql);
      }
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm mb-2">
              <form method="post" action="berkasSt.php">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] <> "") {
                    ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="berkasSt.php"><i class="fas fa-sync"></i> Kembali</a>
                    <?php
                    }
                    ?>
                  </div>
            ...
            <section class="col-md-12 connectedSortable">
              <div class="card card-outline card-success">
                <div class="card-header">
                  <h4 class="card-title">ST (Surat Tugas)</h4>
                </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php if (empty($dss['file_surat'])) {
                                                            echo '<a class="btn btn-outline-secondary btn-flat btn-xs btn-block" onclick="return confirm(\'Tidak ada file!\')" title="Tidak ada file" disabled><i class="fas fa-download"></i></a>';
                                                          } else {
                                                            echo '<a class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Lihat/download" href="' . $dss['file_surat'] . '" target="_blank"><i class="fas fa-download"></i></a>';
                                                          } ?> </td>
                          </tr>
