...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=Data Belum Mendaftar Seminar Proposal Angkatan '.$angkatan.'.xls');
      ?>
    <table style="border:none;">
      <thead>
        <tr style="border:none;">
          <th style="border:none;" colspan="4">Data Belum Mendaftar Seminar Proposal Angkatan <?php echo "$angkatan";?>
          </th>
        </tr>
        <tr style="border:none;">
