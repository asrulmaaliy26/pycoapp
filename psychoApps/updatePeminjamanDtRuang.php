<?php
   ...
   $id_ruang=mysqli_real_escape_string($con, $_POST['id']);
   ...
   mysqli_query($con, "INSERT INTO dt_pinjam_ruang(id_ruang,peminjam,tgl_awal_pinjam,tgl_akhir_pinjam,status_peminjaman)".
   "values('$id','$peminjam','$tgl_awal_pinjam','$tgl_akhir_pinjam','$status_peminjaman')")  or die(mysqli_error($con));

   $qry="UPDATE dt_ruang SET status_peminjaman='2' WHERE id='$id'";
   mysqli_query($con, $qry) or die(mysqli_error($con));
   }
   header ("location:dtPinjamRuang.php?page=$page&message=notifInput");
   ?>