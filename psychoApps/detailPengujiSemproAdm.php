              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  ...
                  <div class="card-body p-0">
                   <?php
                      $sql = "SELECT * FROM jadwal_sempro WHERE penguji1='$id' OR penguji2='$id' GROUP BY tgl_seminar ORDER BY tgl_seminar ASC";
                      ...
                      include("tableHariRuangSemproDetailPenguji.php");
                      include("extConJadSemproDetailPenguji.php");'
                      ';}?>
               </div>
                </div>
              </section>
