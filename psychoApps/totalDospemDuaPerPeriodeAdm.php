      ...
      <div class="content-wrapper">
        ...
        <?php
          include 'pagination.php';
           $reload = "totalDospemDuaPerPeriodeAdm.php?pagination=true&nip=$nip";
           $sql = "SELECT * FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$nip' AND (cek2='2' OR cek2='3') AND id_periode='$id' ORDER BY nim ASC";
