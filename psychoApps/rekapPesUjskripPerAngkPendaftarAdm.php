      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Rekap Pendaftar Ujian Skripsi Angkatan <?php echo "$angkatan";?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapPndftrUjskripAdm.php?page=<?php echo $page;?>">Rekap Pendaftar Ujian Skripsi</a></li>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr class="expandable-body">
                            <td colspan="4"> <?php include("detailPesUjskripAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
