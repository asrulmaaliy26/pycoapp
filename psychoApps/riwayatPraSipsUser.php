  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link" href="formPraSipsUser.php" role="tab" aria-selected="true">Form</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatPraSipsUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <table class="table table-hover m-0 text-center table-sm custom">
                        <thead>
                          <tr>
                            ...
                            <th width="56%">Tempat observasi dan wawancara</th>
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM prasips WHERE nim=$dataku[nim] ORDER BY id DESC";
                            $result = mysqli_query($con, $sql);
                            while ($data = mysqli_fetch_array($result)) {
                            
                            $qrykota = "SELECT * FROM dt_kota WHERE id='$data[kota_observasi]'";
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakPrasips.php",
            data: dataString,
            cache: false,
