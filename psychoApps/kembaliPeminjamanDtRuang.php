    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Item Data Peminjaman Ruang</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination0.php';
          ...
          $reload0 = "kembaliPeminjamanDtRuang.php?pagination0=true&keyword=$keyword&id=$id&page=$page";
          ...
          on dr.model = omr.id
          LEFT JOIN dt_peminjam_ruang dpr
          on r.peminjam = dpr.id

          WHERE (dr.nm LIKE '%$keyword%' OR okr.nm LIKE '%$keyword%' OR omr.nm LIKE '%$keyword%') AND r.status_peminjaman='1' AND r.peminjam='$id' ORDER BY dr.nm ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload0 = "kembaliPeminjamanDtRuang.php?pagination=true&id=$id&page=$page";
          $sql = "SELECT dpr.id AS id_pinjam,dpr.id_ruang,dpr.peminjam,dpr.status_peminjaman AS status_peminjaman,dr.nm,dr.kategori,dr.model,dr.status_peminjaman FROM dt_pinjam_ruang dpr JOIN dt_ruang dr ON dpr.id_ruang=dr.id WHERE dpr.peminjam='$id' AND dpr.status_peminjaman='1'";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="kembaliPeminjamanDtRuang.php?id=<?php echo $id;?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="kembaliPeminjamanDtRuang.php?id=<?php echo $id;?>&page=<?php echo $page;?>&page0=<?php echo $page0;?>"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Item Data Peminjaman Ruang</h4>
                      <span class="float-right"><strong><?php echo $d_peminjam['nm'];?></strong></span>
                    </div>
                  </div>
                  <div class="card-body pt-2 pb-2 pl-0 pr-0">
                    <form name="update" method="post" action="updatePengembalianDtRuang.php" onSubmit="return confirm('Kembalikan data terpilih?')">
