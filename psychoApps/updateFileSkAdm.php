<?php
   ...
   mysqli_query($con, "UPDATE sending_surat SET file_surat='$file_surat' WHERE id='$id' LIMIT 1");
    ...
    header("location:rekapKirimSuratKeputusanAdm.php?page=$page&message=notifGagal");
    }
    ...
    header("location:rekapKirimSuratKeputusanAdm.php?page=$page&message=notifEdit");
    exit;
    ?>