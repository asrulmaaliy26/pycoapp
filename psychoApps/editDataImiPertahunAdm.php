            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small"><a href="dataImiPertahunAdm.php?page_a=<?php echo $page_a;?>&tahun=<?php echo $tahun;?>&page=<?php echo $page;?>">Tahun <?php echo $tahun;?></a></li>
            ...
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body">
                    <form action="updateDataImiPertahunAdm.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label>Tempat Magang
                        <br />
                        <input type="checkbox" name="bilasama" onclick="IsiSamaNamaObyek(this.form)" <?php if($dSurat['nama_obyek']==$dSurat['lembaga_tujuan_surat']) { echo "checked";}?>> Tempat Magang Sama dengan Instansi/Lembaga Tujuan Surat</label>
