...
<html lang="en">
  ...
  <form action="sformSipsUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" href="formSipsUser.php" role="tab" aria-selected="true">Form</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="card-body pb-0">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                          <label for="model_pelaksanaan">Pelaksanaan penelitian dilakukan secara <span class="text-danger">*</span></label>
