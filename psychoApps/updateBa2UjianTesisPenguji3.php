...
$mean_nilai_penguji3_2=mysqli_real_escape_string($con, $_POST['nilai_penguji3_2']);

$sql="UPDATE mag_nilai_ujtes SET nilai_penguji3_2='$mean_nilai_penguji3_2' WHERE id='$id' AND id_pendaftaran='$id_pendaftaran' LIMIT 1";
