<?php include( "contentsConAdm.php" );  
  ...
  $qry_kondisi = "SELECT * FROM opsi_kondisi_barang WHERE id='$id'";
...
<html lang="en">
  <head>
    <title>Data Barang Kondisi <?php echo $d_kondisi['nm'];?></title>
    <meta charset="utf-8">
  ...
  <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    <div class="page">
      <?php
        ...
        ?>
      <strong>
        <center>DATA BARANG KONDISI <?php echo strtoupper($d_kondisi['nm']);?></center>
      </strong>
      <br />
      <table class="table_dbr">
        ...
        <?php
          $no=0;
          $qry_dbr = "SELECT * FROM dt_inventaris_barang WHERE kondisi='$id' ORDER BY DATE(tgl_perolehan) DESC";
