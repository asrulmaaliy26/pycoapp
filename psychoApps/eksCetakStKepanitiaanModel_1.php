<?php include( "contentsConAdm.php" );
   ...
   $qnodipa="SELECT * FROM no_dipa WHERE id='$dataku[no_dipa]'";
   $resnodipa=mysqli_query($con, $qnodipa) or die (mysqli_error($con));
   $dnodipa=mysqli_fetch_assoc($resnodipa);
...
<html lang="en">
   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:15px;">
            ...
            <td>
               ...
               <ol type="a">
                  <?php 
                     ...
                     $dtjab=mysqli_fetch_assoc($resjab);
                     ?>    
                  <li><?php if ($dambilpersonil['jabatan_st']==$dtjab['id']) { echo $dtjab['nama'];} else { echo $dambilpersonil['jabatan_st'];}?></li>
                  <?php } ?>
               </ol>
               <?php } ?>
            </td>
      ...
      <br />
      <br />
      <div style="float:right; position:relative; width:280px;">
