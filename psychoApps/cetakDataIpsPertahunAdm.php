   ...
   <body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
      ...
      <table width="100%">
         ...
         <tr>
            <td>Perihal</td>
            <td align="center">:</td>
            <td><strong>IZIN PENELITIAN SKRIPSI</strong></td>
            <td>&nbsp;</td>
         </tr>
         <tr>
            <td>&nbsp;</td>
         ...
         <tr>
            ...
            <td colspan="2" style="text-align:justify;">
               Dengan hormat, <br />
               Dalam rangka pengembangan keilmuan bagi mahasiswa <?php echo "$nm_lembaga".' '."$nm_lembaga_induk";?>, maka dengan ini kami mohon kepada Bapak/Ibu memberikan kesempatan untuk melakukan penelitian skripsi kepada:
               <br />
               <br />
