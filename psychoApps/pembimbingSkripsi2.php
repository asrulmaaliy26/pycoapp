...
$qNim = "SELECT nim FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$dtDosen[id]' LIMIT 1";
...
$qJmlProses = "SELECT COUNT(*) AS jumData FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$dtDosen[id]' AND nim IN(SELECT nim FROM peserta_ujskrip)";
...
$qJmlUjskrip = "SELECT COUNT(*) AS jumData FROM pengelompokan_dospem_skripsi WHERE dospem_skripsi2='$dtDosen[id]' AND nim NOT IN(SELECT nim FROM peserta_ujskrip)";
