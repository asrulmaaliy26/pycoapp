  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="card card-success card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="riwayatSiprakksUser.php" role="tab" aria-selected="true">Riwayat</a>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover m-0 text-center table-sm custom">
                        ...
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM siprak_siswa WHERE nim=$dataku[nim] AND jenis_praktikum='2' ORDER BY id DESC";
                                      ...
                                      <div class="table-responsive">
                                        <table class="table table-hover table-bordered m-0 text-center table-sm custom">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              <td class="text-center pl-1"><?php echo $no;?></td>
                                              <td class="text-left pr-1"><?php echo $mydata['nama_testee'];?></td>
                                            </tr>
                                            <?php
                                              }
                                              ?>
    ...
    <script>
      $( '#modal-pre-cetak' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "bodyPetunjukCetakSiprakks.php",
            data: dataString,
            cache: false,
