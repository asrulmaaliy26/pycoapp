<?php include( "contentsConAdm.php" );
  ...
  $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_inventaris_barang WHERE letak='$id'";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Detail DIR</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination0.php';
          $reload0 = "dtDirPerRuang.php?id=$id&page=$page&pagination0=true";
          $sql0 = "SELECT * FROM dt_inventaris_barang WHERE letak='$id' ORDER BY nm ASC";
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover table-bordered m-0 table-sm custom">
                        <thead class="thead-light">
                          ...
                          <th width="10%" class="text-center pr-1">Gambar</th>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center pr-1"> <img src="<?php echo $data0['image'];?>" class="img-fluid rounded mx-auto d-block" width="60%" onError="this.onerror=null;this.src='images/image_none.jpg'"> </td>
                          </tr>
                          <?php
                            $i0++; 
                            $count0++;
