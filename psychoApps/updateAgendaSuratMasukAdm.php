<?php include( "contentsConAdm.php" );
  ...
  header("location:agendaSuratMasukAdm.php?message=notifEdit");
  } else {
  header("location:agendaSuratMasukAdm.php?message=notifGagal");
  */
  ...
  header("location:agendaSuratMasukAdm.php?page=$page&message=notifEdit");
  ?>