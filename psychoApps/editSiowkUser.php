...
<html lang="en">
  ...
  <form action="updateSiowkUser.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card card-success card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="editSiowkUser.php?id=<?php echo $id;?>" role="tab" aria-selected="true">Edit</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body pb-0">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-sm-3">
                          ...
                          <?php
                            $tampil = mysqli_query($con,  "SELECT * FROM anggota_siowk WHERE id_siowk='$id' AND urutan='8'" );
                            $select = mysqli_fetch_array( $tampil );
                            $data = $select[ 'nim_anggota' ];
