      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h6 class="m-0">Rekap Nilai PKL <?php echo 'Tahap '.$dthp['tahap'].' '.$dsemester['nama'].' '.$dnta['ta'].'';?></h6>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item small"><a class="text-info" href="rekapNilaiPklAdm.php?page=<?php echo $page;?>">Rekap Nilai PKL</a></li>
                  <li class="breadcrumb-item active small">List Peserta Gagal</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">List Peserta Gagal</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td rowspan="2" width="8%" class="pr-1">Nilai</td>
                          </tr>
                          <tr class="text-center bg-secondary">
                            <td width="22%" class="pl-1">DPL</td>
                            <td width="32%" class="pr-1">Lokasi</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_pkl INNER JOIN dt_mhssw ON peserta_pkl.nim=dt_mhssw.nim WHERE (peserta_pkl.id_pkl='$id') AND (peserta_pkl.nilai <= '$dt_grade[dt]' AND peserta_pkl.nilai >= '$dt_grade[db]') ORDER BY dt_mhssw.nama ASC";
                          ...
                          <tr class="expandable-body">
                            <td colspan="5"> <?php include("detailPesPklAdm.php");?> </td>
                          </tr>
                          <?php
                            }
                            ?>
