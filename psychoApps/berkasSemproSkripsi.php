                      ...
                      <tbody>
                        ...
                        ?>
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1"> <?php if (empty($dpend['file_prop'])) {
                                                            ...
                                                            echo '<a class="btn btn-outline-warning btn-flat btn-xs btn-block" title="Lihat/download" href="' . $dpend['file_prop'] . '" target="_blank"><i class="fas fa-download"></i></a>';
                                                          } ?> </td>
                          </tr>
