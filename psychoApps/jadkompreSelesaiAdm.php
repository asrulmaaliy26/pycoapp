            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Pendaftar Telah Terjadwal</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Pendaftar Telah Terjadwal</h4>
                    </div>
                  </div>
                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        <thead>
                          <tr class="text-center bg-secondary">
                            ...
                            <td rowspan="2" width="36%">Nama</td>
                            <td colspan="3" class="border-bottom-0">Jadwal Ujian</td>
                            <td rowspan="2" width="10%">Tgl. Pendaftaran</td>
                            <td rowspan="2" width="10%" class="pr-1">Tgl. Verifikasi</td>
                          </tr>
                          <tr class="text-center bg-secondary">
                            <td width="10%" class="pl-1">Tanggal</td>
                            <td width="10%">Pukul</td>
                            <td width="16%" class="pr-1">Ruang</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                            $no=0;
                            $sql = "SELECT * FROM peserta_kompre INNER JOIN dt_mhssw ON peserta_kompre.nim=dt_mhssw.nim WHERE peserta_kompre.id_kompre='$id' AND peserta_kompre.statusform='2' ORDER BY dt_mhssw.nama ASC";
