            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active small">Detail Penguji</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Detail Penguji</h4>
                      <span class="badge badge-info float-right"> <?php echo $dqpenguji['nama'];?></span>
                    </div>
                  </div>
                  <div class="card-body p-0">
                   <?php
                      $sql = "SELECT * FROM jadwal_ujskrip WHERE sekretaris_penguji='$id' OR ketua_penguji='$id' OR penguji_utama='$id' GROUP BY tgl_ujian ORDER BY tgl_ujian ASC";
                      ...
                      include("tableHariRuangUjskripDetailPenguji.php");
                      include("extConJadUjskripDetailPenguji.php");'
                      ';}?>
               </div>
                </div>
              </section>
