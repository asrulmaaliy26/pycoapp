...
<html lang="en">
  ...
  <body>
    <?php
      ...
      header('Content-Disposition: attachment; filename=>Data Surat Izin Praktikum Individu Testee Mahasiswa Tahun '.$thn_pengajuan.'.xls');
      ?>
    <p><strong>Data Surat Izin Praktikum Individu Testee Mahasiswa Tahun <?php echo $thn_pengajuan;?></strong></p>
    <table width="100%">
      <thead>
        <tr>
          <th width="4%">No</th>
          ...
          <th width="52%">Tujuan Surat/Dosen Pengampu Matakuliah</th>
      ...
      <tbody>
        <?php
          $no=0;
          $sql =  "SELECT * FROM siprak_mahasiswa WHERE jenis_praktikum = '1' AND thn_pengajuan='$thn_pengajuan' ORDER BY id ASC";
        ...
        <tr>
          ...
          <td><?php echo $data['dosen_testee'];?></td>
