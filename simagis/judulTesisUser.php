  ...
  <body>
    <?php include "navBankUser.php";
      include 'paginationUser.php';         
            ...
            $reload = "judulTesisUser.php?pagination=true&keyword=$keyword";
      ...
      WHERE mrt.nim LIKE '%$keyword%' OR mdmp.nama LIKE '%$keyword%' OR mrt.judul_tesis LIKE '%$keyword%' OR mrt.tgl_upload LIKE '%$keyword%'";
       ...
       $reload = "judulTesisUser.php?pagination=true";
    ...
    <div class="container">
      <div class="row">
        <h3 class="text-center text-info">Judul Tesis</h3>
        <div class="col-lg-12">
          <div class="row">
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <form method="post" action="judulTesisUser.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="judulTesisUser.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                ...
                <div class="table-responsive">
                  <table class="table table-condensed table-bordered custom small" style="margin-bottom:0px;">
                    <thead>
                      <tr>
                        <th class="text-center" width="3%">No.</th>
                        <th class="text-center" width="27%">Nama | NIM</th>
    ...
    <script>
      ...
      $.ajax({
      type: "GET",
      url: "detailRevisiTesPerIndUser.php",
      data: dataString,
      cache: false,
