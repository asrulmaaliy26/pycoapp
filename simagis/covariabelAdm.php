  ...
  <body>
    <?php include "navMasterDataAdm.php";
      include 'pagination.php';         
            ...
            $reload = "covariabelAdm.php?pagination=true&keyword=$keyword";
            
            $sql = "SELECT * FROM mag_covariable WHERE nm LIKE '%$keyword%' ORDER BY nm ASC";
      
            $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
            }else{
            $reload = "covariabelAdm.php?pagination=true";
        ...
        <div class="col-lg-12">
          <div class="row">
            <ul class="nav nav-tabs" style="margin-bottom:10px;">
              ...
              <li role="presentation" class="active"><a href="covariabelAdm.php">Co-Variable</a></li>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <form method="post" action="covariabelAdm.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="covariabelAdm.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;  font-size:13px;">
                    <thead>
                      <tr class="success">
                        ...
                        <th rowspan="2" width="36%" class="text-center" style="vertical-align:middle;">Nama Co-Variabel</th>
                        <th colspan="3" class="text-center">Telah Digunakan pada (Kali)</th>
                        <th rowspan="2" width="14%" rowspan="2" class="text-center">Validasi</th>
                        <th rowspan="2" width="10%" class="text-center" style="vertical-align:middle;">Opsi</th>
                      </tr>
                      <tr class="success">
                        <th width="12%" class="text-center">Co-variabel 1</th>
                        <th width="12%" class="text-center">Co-variabel 2</th>
                        <th width="12%" class="text-center">Co-variabel 3</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?php echo $jumV2;?></td>
                        <td class="text-center"><?php echo $jumV3;?></td>
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                        <?php if($data['cek']==1 OR $data['cek']==2 AND $sumV==0) { echo 
                          "<label for='' class='sr-only'>Validasi</label>
                          <form class='' style='margin-bottom:0px;' action='updateVerifikasiCovariable.php' method='post'>
                        ...
                        <td class="text-center">
                          <?php if($data['cek']==1 AND $sumV==0) { echo
                            ...
                            <a class='btn btn-default' href='deleteCovariabelAdm.php?id=".$id."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}
                            else { echo 
