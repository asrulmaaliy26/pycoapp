  ...
  <body>
      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah data Pendaftar Seminar Proposal Tesis <?php echo 'Tahap'.' '.$dthp['tahap'].' Semester'.' '.$dsemester['nama'].' TA. '.$dnta['ta'];?>.</li>
                  ...
                  <table class="table table-condensed table-bordered table-striped custom" width="100%" style="margin-bottom:0px; font-size:13px;">
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" class="text-center" width="18%">Nama | NIM | Hp | Tgl. Daftar</th>
                        <th rowspan="2" class="text-center" width="20%">Judul Proposal Tesis</th>
                        <th colspan="8" class="text-center">File</th>
                        <th rowspan="2" class="text-center" width="13%">Opsi</th>
                      </tr>
                      <tr>
                        <th width="4%" class="text-center" style="font-size:10px;">Proposal</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Turnitin</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Toefl</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Transkrip</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Audien</th>
                        <th width="4%" class="text-center" style="font-size:10px;">D.minasi</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Publikasi</th>
                        <th width="4%" class="text-center" style="font-size:10px;">Kwitansi</th>
                      </tr>
                    </thead>
                    <tbody class="text-muted">
                      <?php
                        $no=0;
                        $sql =  "SELECT * FROM mag_peserta_sempro WHERE id_sempro = '$id_sempro' ORDER BY nim ASC";
                        ...
                        $qrynilai= "select * from mag_nilai_sempro WHERE id_pendaftaran='$data[id]'";
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?php if(empty($data['file_toefl'])) { echo '<a class="btn btn-danger" title="Tidak ada file" disabled><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';} else { echo '<a class="btn btn-danger" title="Download" href="'.$data['file_toefl'].'" target="_blank"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';}?></td>
                        ...
                        <td class="text-center"><?php if(empty($data['file_audien'])) { echo '<a class="btn btn-danger" title="Tidak ada file" disabled><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';} else { echo '<a class="btn btn-danger" title="Download" href="'.$data['file_audien'].'" target="_blank"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';}?></td>
                        <td class="text-center"><?php if(empty($data['file_diseminasi'])) { echo '<a class="btn btn-danger" title="Tidak ada file" disabled><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';} else { echo '<a class="btn btn-danger" title="Download" href="'.$data['file_diseminasi'].'" target="_blank"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';}?></td>
                        <td class="text-center"><?php if(empty($data['file_publikasi'])) { echo '<a class="btn btn-danger" title="Tidak ada file" disabled><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';} else { echo '<a class="btn btn-danger" title="Download" href="'.$data['file_publikasi'].'" target="_blank"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>';}?></td>
                        ...
                        <td class="text-center">
                          <?php
                            ...
                            if($data['cek']==1) {echo '
                                              <button class="btn btn-primary" title="Buat jadwal seminar" data-toggle="modal" data-target="#modalCrtJad" data-whatever="'.$data['id'].'"><span class="glyphicon glyphicon-calendar"></span></button>';} else {
                                              echo '
                                              <button class="btn btn-success" title="Edit jadwal seminar" data-toggle="modal" data-target="#modalCrtJad" data-whatever="'.$data['id'].'"><span class="glyphicon glyphicon-calendar"></span></button>';}
                            }
                                              ?>
                          ...
                          <a role="button" href="cetakPendSemproAdm.php?id=<?php echo $data['id'];?>" class="btn btn-default" title="Cetak" target="_blank"><span class="glyphicon glyphicon-print"></span></a>
                          ...
                          else { echo "<a class='btn btn-default' href='deletePendSemproAdm.php?id=".$data['id']."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}?>          
                        </td>
                      </tr>
                      <?php
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalCrtJad"><?php $sql =  "SELECT * FROM mag_peserta_sempro WHERE id_sempro = '$id_sempro' ORDER BY nim ASC";
                $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
                $data = mysqli_fetch_array($result); 
                if($data['cek']==1) {echo "Input Jadwal";} else {echo "Edit Jadwal";}?></h4>
            </div>
            <div class="modal-body">
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalEdit">Edit Pendaftar Seminar Proposal Tesis</h4>
            </div>
            <div class="modal-body">
    ...
    <script>
      ...
      $( '#modalCrtJad' ).on( 'show.bs.modal', function ( event ) {
          ...
          $.ajax( {
            type: "GET",
            url: "includeInputJadSemproPerPeriode.php",
            data: dataString,
            cache: false,
