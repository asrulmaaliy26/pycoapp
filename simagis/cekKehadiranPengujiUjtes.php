<?php
  ...
  $qry_moment = "SELECT * FROM mag_periode_pendaftaran_ujtes WHERE id='$djdwl[id_ujtes]'";
            ...
            <div class="row">
              <div class="col-md-12" style="margin-bottom:10px;">
                <ul class="nav nav-tabs">
                  ...
                  <li role="presentation"><a href="jadUjtesPerPeriode.php?id=<?php echo "$id_ujtes";?>">Jadwal Ujian</a></li>
                ...
                <div class="table-responsive">
                  <table width="100%" style="font-size:13px;" class="table table-condensed table-bordered custom">
                    <tr>
                      ...
                      <td width="2%" align="center">:</td>
                      <td width="38%"><?php if(empty($djdwl['tgl_ujian']))  { echo "";} else { echo $dayList[$day].', '.bulanIndo($djdwl['tgl_ujian']);}?></td>
                    </tr>
                    <tr>
                      <td>NIM</td>
                      <td align="center">:</td>
                    ...
                    <tbody class="text-muted" style="font-size:13px;">
                      <tr>
                        ...
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          ...
                          <form class="" style="margin-bottom:0px;" action="updateCekKehadiranPengujiUtamaUjtes.php" method="post">
                      ...
                      <tr>
                        ...
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          <label for="" class="sr-only">Cek Hadir</label>
                          <form class="" style="margin-bottom:0px;" action="updateCekKehadiranKetuaPengujiUjtes.php" method="post">
                            <input type="text" class="sr-only" name="id" value="<?php echo $id;?>">
                      ...
                      <tr>
                        ...
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          <label for="" class="sr-only">Cek Hadir</label>
                          <form class="" style="margin-bottom:0px;" action="updateCekKehadiranPembimbing1Ujtes.php" method="post">
                            <input type="text" class="sr-only" name="id" value="<?php echo $id;?>">
                      ...
                      <tr>
                        ...
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          <label for="" class="sr-only">Cek Hadir</label>
                          <form class="" style="margin-bottom:0px;" action="updateCekKehadiranPembimbing2Ujtes.php" method="post">
                            <input type="text" class="sr-only" name="id" value="<?php echo $id;?>">
