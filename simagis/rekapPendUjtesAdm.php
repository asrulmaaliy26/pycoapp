...
<html lang="en">
  ...
  <body>
    <?php include "navPendAdm.php";
      $qry = "SELECT COUNT(*) AS jumData FROM mag_periode_pendaftaran_ujtes";
         ...
         $jumlahData = $dataku['jumData'];
          ...
          $reload = "rekapPendUjtesAdm.php?pagination=true";
          $sql =  "SELECT * FROM mag_periode_pendaftaran_ujtes ORDER BY start_datetime DESC";
      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah data Pendaftaran Ujian Tesis per periode.</li>
              <li>Periode Pendaftaran Ujian Tesis yang <code>sedang aktif</code> bertanda <span class='label label-primary'>Sedang Aktif</span>. Silahkan tekan <code>tombol ON/OFF</code> untuk mengaktifkan atau menonaktifkan.</li>
              <li><code>Perhatikan</code> rekap Periode Pendaftaran Ujian Tesis yang ada. Jika input baru, pastikan Periode Pendaftaran Ujian Tesis <code>tidak sama</code>.</li>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-condensed table-bordered table-striped custom" style="margin-bottom:0px; font-size:12px;">
                    <thead>
                      <tr class="">
                        ...
                        <th rowspan="2" class="text-center" width="3%">Pndftr</th>
                        <th colspan="2" class="text-center">Jadwal Ujian</th>
                        <th colspan="5" class="text-center">Hasil Ujian</th>
                        <th rowspan="2" class="text-center" width="4%">Penguji</th>
                        <th rowspan="2" class="text-center" width="16%">Opsi</th>
                      </tr>
                      <tr>
                        <th class="text-center" width="12%">Awal</th>
                        <th class="text-center" width="12%">Akhir</th>
                        <th class="text-center" width="5%">Belum</th>
                        <th class="text-center" width="5%">Sudah</th>
                        <th class="text-center" width="2%">A</th>
                        <th class="text-center" width="2%">B+</th>
                        <th class="text-center" width="2%">B</th>
                        <th class="text-center" width="2%">C+</th>
                        <th class="text-center" width="2%">C</th>
                      </tr>
                    </thead>
                    <tbody class="text-muted">
                      <?php
                        ...
                        $qpeserta = "SELECT * FROM mag_peserta_ujtes WHERE id_ujtes='$id'";
                        $row1 = mysqli_query($GLOBALS["___mysqli_ston"], $qpeserta);
                        $dpeserta = mysqli_num_rows($row1);
                        
                        $qjadwal = "SELECT * FROM mag_jadwal_ujtes WHERE id_ujtes='$id'";
                        $row2 = mysqli_query($GLOBALS["___mysqli_ston"], $qjadwal);
                        $djadwal = mysqli_num_rows($row2);
                        
                        $qjumpeserta = "SELECT COUNT(id_ujtes) AS jum FROM mag_peserta_ujtes WHERE id_ujtes='$id'";
                        $rjp = mysqli_query($GLOBALS["___mysqli_ston"], $qjumpeserta);
                        $dJumPeserta = mysqli_fetch_assoc($rjp);
                        
                        $qry1 = "SELECT COUNT(*) AS jumData FROM mag_peserta_ujtes WHERE id_ujtes='$id' AND cek='1'";
                        ...
                        $qry2 = "SELECT COUNT(*) AS jumData FROM mag_peserta_ujtes WHERE id_ujtes='$id' AND cek='2'";
                        ...
                        $qrerata1 = "SELECT COUNT(id) AS rerata FROM mag_nilai_ujtes WHERE (mean_nilai_penguji1+mean_nilai_penguji2+mean_nilai_penguji3+mean_nilai_penguji4)/4 BETWEEN 90 AND 101 AND id_ujtes='$id' AND validasi='2'";
                        ...
                        $qrerata2 = "SELECT COUNT(id) AS rerata FROM mag_nilai_ujtes WHERE (mean_nilai_penguji1+mean_nilai_penguji2+mean_nilai_penguji3+mean_nilai_penguji4)/4 BETWEEN 79 AND 90 AND id_ujtes='$id' AND validasi='2'";
                        ...
                        $qrerata3 = "SELECT COUNT(id) AS rerata FROM mag_nilai_ujtes WHERE (mean_nilai_penguji1+mean_nilai_penguji2+mean_nilai_penguji3+mean_nilai_penguji4)/4 BETWEEN 69 AND 79 AND id_ujtes='$id' AND validasi='2'";
                        ...
                        $qrerata4 = "SELECT COUNT(id) AS rerata FROM mag_nilai_ujtes WHERE (mean_nilai_penguji1+mean_nilai_penguji2+mean_nilai_penguji3+mean_nilai_penguji4)/4 BETWEEN 59 AND 69 AND id_ujtes='$id' AND validasi='2'";
                        $rrerata4 =  mysqli_query($GLOBALS["___mysqli_ston"], $qrerata4) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        $drerata4 = mysqli_fetch_assoc($rrerata4) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        $rerata4 = $drerata4['rerata'];
                        
                        $qrerata5 = "SELECT COUNT(id) AS rerata FROM mag_nilai_ujtes WHERE (mean_nilai_penguji1+mean_nilai_penguji2+mean_nilai_penguji3+mean_nilai_penguji4)/4 BETWEEN 0 AND 59 AND id_ujtes='$id' AND validasi='2'";
                        $rrerata5 =  mysqli_query($GLOBALS["___mysqli_ston"], $qrerata5) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        $drerata5 = mysqli_fetch_assoc($rrerata5) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        $rerata5 = $drerata5['rerata'];
                        ?>
                      <tr>
                        ...
                        <td class="text-center"><?php if($data['status']==1) { echo "<a class='btn btn-success btn-sm btn-block'><span class='glyphicon glyphicon-check'></span> ON</a>";} else { echo "<a class='btn btn-default btn-sm btn-block' title='Aktifkan!' href='updateStatusPeriodeUjtes.php?id=".$id."' onclick='return confirm(\"Yakin periode ini diaktifkan?\")'><span class='glyphicon glyphicon-ban-circle'></span> OFF</a>";}?></td>
                        <td class="text-center"><a href='pendaftarUjtesPerPeriode.php?id=<?php echo "$id";?>&page=<?php echo "$page";?>' class='btn btn-sm btn-block btn-info' title='Lihat dan edit'><?php echo $dJumPeserta['jum'];?></a></td>
                        ...
                        <td class="text-center"><a href='jadUjtesPerPeriode.php?id=<?php echo "$id";?>&page=<?php echo "$page";?>' class='btn btn-sm btn-block btn-primary' title='Lihat jadwal'><?php echo $jumlahData2;?></a></td>
                        <td class="text-center"><?php echo "$rerata1";?></td>
                        <td class="text-center"><?php echo "$rerata2";?></td>
                        <td class="text-center"><?php echo "$rerata3";?></td>
                        <td class="text-center"><?php echo "$rerata4";?></td>
                        <td class="text-center"><?php echo "$rerata5";?></td>
                        ...
                        <td class="text-center">
                          <a href='formPenilaianUjtesPerPeriode.php?id=<?php echo "$id";?>&page=<?php echo "$page";?>' class='btn btn-sm btn-success' title='Validasi nilai'>Validasi Nilai</a>
                          ...
                          <?php if(($dpeserta > 0) || ($djadwal > 0)) { echo "<a class='btn btn-default' title='Tidak bisa dihapus! Sudah ada pendaftar' disabled><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";} else { echo "<a class='btn btn-default' href='deletePeriodePendUjtes.php?id=".$id."&page=".$page."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}?>
                        </td>
                      </tr>
                      <?php
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="panel panel-default">
                <div class="panel-body">
                  <form action="sformInputPeriodePendUjtesAdm.php" method="post">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" max="100" name="at" class="form-control" value="100" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="ab">Grade Bawah A</label>
                        <input type="number" name="ab" class="form-control" value="90.5001" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="bplust">Grade Atas B+</label>
                        <input type="number" name="bplust" class="form-control" value="90.5000" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="bplusb">Grade Bawah B+</label>
                        <input type="number" name="bplusb" class="form-control" value="79.5001" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="bt">Grade Atas B</label>
                        <input type="number" name="bt" class="form-control" value="79.5000" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="bb">Grade Bawah B</label>
                        <input type="number" name="bb" class="form-control" value="69.5001" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="cplust">Grade Atas C+</label>
                        <input type="number" name="cplust" class="form-control" value="69.5000" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="cplusb">Grade Bawah C+</label>
                        <input type="number" name="cplusb" class="form-control" value="59.5001" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="ct">Grade Atas C</label>
                        <input type="number" name="ct" class="form-control" value="59.5000" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="cb">Grade Bawah C</label>
                        <input type="number" name="cb" class="form-control" value="0.0000" required>
                      </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalEdit">Edit Periode Pendaftaran Ujian Tesis</h4>
            </div>
            <div class="modal-body">
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalRekapPenguji">Rekap Dosen Penguji Ujian Tesis</h4>
            </div>
            <div class="modal-body">
    ...
    <script>
      ...
      $.ajax({
      type: "GET",
      url: "editPeriodePendUjtesAdm.php",
      data: dataString,
      cache: false,
      ...
      $.ajax({
      type: "GET",
      url: "pendaftarUjtesBelumTerjadwalAdm.php",
      data: dataString,
      cache: false,
      success: function (data) {
       console.log(data);
