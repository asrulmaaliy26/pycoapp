   ...
   <table class="jadwal">
      <thead>
         <tr>
            ...
            <th class="text-center" width="14%">Penguji Utama</th>
            <th class="text-center" width="14%">Ketua Penguji</th>
			<th class="text-center" width="14%">Pembimbing I</th>
            <th class="text-center" width="14%">Pembimbing II</th>
         </tr>
      </thead>
      <tbody style="font-size:13px;">
         <?php				           	  
            $no=0;
            $q =  "SELECT * FROM mag_jadwal_ujtes WHERE id_ujtes='$djdwl[id_ujtes]' AND tgl_ujian='$djdwl[tgl_ujian]' ORDER BY jam_mulai ASC";
