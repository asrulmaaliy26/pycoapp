      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah data Revisi Tesis <?php echo 'Tahap'.' '.$dthp['tahap'].' Semester'.' '.$dsemester['nama'].' TA. '.$dnta['ta'];?>.</li>
                  ...
                  <table class="table table-bordered table-striped custom" width="100%" style="margin-bottom:0px; font-size:13px;">
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" class="text-center" width="44%">Judul Tesis</th>
                    ...
                    <tbody class="text-muted">
                      <?php
                        $no=0;
                        $sql =  "SELECT * FROM mag_revisi_tesis WHERE id_ujtes = '$id_ujtes' ORDER BY id ASC";
                      ...
                      <tr>
                        ...
                        <a class='btn btn-default' title='Sudah diterima, tidak bisa dihapus!' disabled><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                          ...
                          echo "
                          <a class='btn btn-default' href='deleteRevisiTesPerPeriodeAdm.php?id=".$data['id']."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";
                        }
                        ?>                   
                        </td>
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          ...
                          <form class="" style="margin-bottom:0px;" action="updateValidasiRevisiTes.php" method="post">
