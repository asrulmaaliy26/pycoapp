...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updateVariabelmediatorUser.php" method="post">
      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
      <div class="form-group">
        <label for="nm">Nama variabel mediator baru:</label>
        <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama variabel mediator baru" value="<?php echo $dataku['nm'];?>" required>
      </div>
      <div class="checkbox">
        <label>
