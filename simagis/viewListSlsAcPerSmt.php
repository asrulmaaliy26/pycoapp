  ...
  <table class="table table-condensed table-bordered table-striped custom" style="margin-bottom:0px; font-size:13px;">
    <thead>
      <tr>
        ...
        <th width="36%" class="text-center">Nama | NIM</th>
        <th width="34%" class="text-center">Academic Coach</th>
        <th width="13%" class="text-center">Tgl. Verifikasi</th>
        <th width="13%" class="text-center">Tgl. Selesai</th>
      </tr>
    </thead>
    <tbody>
      <?php
        $no=0;
        $qdw = "SELECT * FROM mag_pengelompokan_dosen_wali WHERE id_periode='$id' AND cek='2' AND status='2' ORDER BY tgl_cek";
