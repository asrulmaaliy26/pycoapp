...
<div class="table-responsive">
  <table class="table custom">
    <tbody>
      <?php
        $qdm = "SELECT * FROM mag_dt_mhssw_pasca WHERE angkatan='$angkatan' AND smt_daftar='2' AND status='3' ORDER BY nama ASC";
          ...
          <div class="table-responsive">
            <table class="table table-condensed custom" style="font-size:13px;">
              <tbody>
                ...
                <tr>
                  <td class="text-left">Tahun Cuti</td>
                  <td class="text-center">:</td>
                  <td class="text-left"><?php echo $ddm['thn_cuti'];?></td>
                </tr>
              </tbody>
            </table>
          </div>
