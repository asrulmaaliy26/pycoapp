  ...
  <body>
    <?php include "navMasterDataAdm.php";
      include 'pagination.php';         
            ...
            $reload = "variabelmoderatorAdm.php?pagination=true&keyword=$keyword";
            
            $sql = "SELECT * FROM mag_moderatorvariable WHERE nm LIKE '%$keyword%' ORDER BY nm ASC";
      
            $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
            }else{
            $reload = "variabelmoderatorAdm.php?pagination=true";
        ...
        <div class="col-lg-12">
          <div class="row">
            <ul class="nav nav-tabs" style="margin-bottom:10px;">
              ...
              <li role="presentation" class="active"><a href="variabelmoderatorAdm.php">Variabel Moderator</a></li>
            </ul>
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <form method="post" action="variabelmoderatorAdm.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="variabelmoderatorAdm.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;  font-size:13px;">
                    <thead>
                      <tr class="success">
                        ...
                        <th width="52%" class="text-center" style="vertical-align:middle;">Nama Variabel Moderator</th>
                    ...
                    <tbody>
                      <?php
                        ...
                        $qv1 = "SELECT COUNT(*) AS jum FROM mag_revisi_tesis WHERE moderator='$id'";
                      ...
                      <tr>
                        ...
                        <?php if($data['cek']==1 OR $data['cek']==2 AND $jumV1==0) { echo 
                          ...
                          <form class='' style='margin-bottom:0px;' action='updateVerifikasiModVariable.php' method='post'>
                        ...
                        <td class="text-center">
                          <?php if($data['cek']==1 AND $jumV1==0) { echo
                            ...
                            <a class='btn btn-default' href='deleteModVariabelAdm.php?id=".$id."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}
                            else { echo 
