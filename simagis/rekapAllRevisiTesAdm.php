  ...
  <body>
    <?php include "navPendAdm.php";
      include 'pagination.php';     
       ...
       $reload = "rekapAllRevisiTesAdm.php?pagination=true&keyword=$keyword";
      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah semua data Revisi Tesis.</li>
            ...
            <div class="row">
              <div class="col-md-12" style="margin-bottom:10px;">
                <ul class="nav nav-tabs">
                  <li role="presentation"><a href="rekapRevisiTesAdm.php">Periode Pendaftaran</a></li>
                  <li role="presentation" class="active"><a>Semua Data</a></li>
                </ul>
              </div>
              <div class="col-md-12">
                <form method="post" action="rekapAllRevisiTesAdm.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="rekapAllRevisiTesAdm.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class=" table table-condensed table-bordered table-striped custom" width="100%" style="margin-bottom:0px; font-size:13px;">
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" class="text-center" width="28%">Judul Tesis</th>
                      ...
                      <tr>
                        ...
                        <th width="5%" class="text-center" style="font-size:10px;">Tesis</th>
                      </tr>
                    </thead>
                    <tbody class="text-muted">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <?php
                            ...
                            <a class='btn btn-default' title='Sudah diterima, tidak bisa dihapus!' disabled><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                              ...
                              echo "
                              <a class='btn btn-default' href='deleteRevisiTesAllAdm.php?id=".$data['id']."&page=".$page."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                                </a>";
                            }
                            ?>                   
                        </td>
                        <td class="text-center" style="padding-bottom:2px; padding-top:2px;">
                          ...
                          <form class="" style="margin-bottom:0px;" action="updateValidasiRevisiTesAll.php" method="post">
