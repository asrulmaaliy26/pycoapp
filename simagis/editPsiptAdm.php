...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updatePsiptAdm.php" method="post">
      ...
      <div class="form-group">
        ...
        <input type="checkbox" name="bilasama" onclick="IsiSama(this.form)" <?php if($dataku['nama_obyek']==$dataku['lembaga_tujuan_surat']) { echo "checked";}?>> Tempat penelitian sama dengan instansi/lembaga tujuan surat
        </label>
      ...
      <div class="form-group">
                ...
                <textarea name="judul_tesis" class="form-control" id="judul_tesis" required><?php echo $dataku['judul_tesis'];?></textarea>
      </div>
      <div class="form-group">
