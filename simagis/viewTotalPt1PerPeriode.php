...
<div class="panel panel-default">
  <div class="panel-heading">Total Pembimbingan Dosen Pembimbing Tesis I</div>
  <div class="table-responsive">
    <table class="table table-condensed table-bordered custom" style="margin-bottom:0px; font-size:13px;">
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2' AND (status='1' OR status='2') ORDER BY tgl_mulai";
        ...
        <tr>
          ...
          <td class="text-center"><?php if($ddw['cek1']==2 && $ddw['status']==1) { echo "Proses";} if($ddw['cek1']==2 && $ddw['status']==2) { echo "Selesai";}?></td>
