  ...
  <body>
    <?php include "navBankUser.php";
      include 'paginationUser.php';         
            ...
            $reload = "variabelmoderatorUser.php?pagination=true&keyword=$keyword";
            
            $sql = "SELECT * FROM mag_moderatorvariable WHERE nm LIKE '%$keyword%' ORDER BY nm ASC";
      
            $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
            }else{
            $reload = "variabelmoderatorUser.php?pagination=true";
            $sql =  "SELECT * FROM mag_moderatorvariable ORDER BY nm ASC";
            $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
            }
    ...
    <div class="container">
      <div class="row">
        <?php
          ...
          if (!empty($_GET['message']) && $_GET['message'] == 'notifDelete') {
                  ...
                  ?>
        <h3 class="text-center text-info">Variabel Moderator Tesis</h3>
        <div class="col-lg-12">
          <div class="row">
            <ul class="nav nav-tabs" style="margin-bottom:10px;">
              ...
              <li role="presentation" class="active"><a href="variabelmoderatorUser.php">Variabel Moderator</a></li>
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <ul class="list">
                  <li>Berikut adalah list variabel moderator tesis yang telah digunakan.</li>
              ...
              <div class="panel-body">
                <form method="post" action="variabelmoderatorUser.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="variabelmoderatorUser.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;">
                    <thead>
                      <tr class="success">
                        ...
                        <th width="54%" class="text-center" style="vertical-align:middle;">Nama variabel moderator</th>
                    ...
                    <tbody>
                      <?php
                        ...
                        $qv = "SELECT COUNT(*) AS jum FROM mag_revisi_tesis WHERE moderator='$id'";
                        $rv = mysqli_query($GLOBALS["___mysqli_ston"], $qv)or die( mysqli_error($GLOBALS["___mysqli_ston"]));
                        $dv = mysqli_fetch_assoc($rv);
                        $jumV=$dv['jum'];
                        ?>
                      <tr>
                        <td class="text-center"><?php echo ++$no;?></td>
                        <td><?php echo $data['nm'];?></td>
                        <td class="text-center"><?php echo $jumV;?></td>
                        <td class="text-center">
                          <?php if($jumV==0) { echo
                            ...
                            <a class='btn btn-default' href='deleteModeratorvariabelUser.php?id=".$id."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}
                            else { echo 
      ...
      <form action="sformModvariabel.php" method="post">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Input variabel moderator baru</h4>
              </div>
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama variabel moderator baru" required>
                </div>
                <div class="checkbox">
                  <label>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalEdit">Edit variabel moderator baru</h4>
            </div>
            <div class="modal-body">
    ...
    <script>
      ...
      $.ajax( {
      type: "GET",
      url: "editVariabelmoderatorUser.php",
      data: dataString,
      cache: false,
