  ...
  <body>
    <?php include "navMasterDataAdm.php";
      include 'pagination.php';     
       ...
       $reload = "rekapJudulPropAdm.php?pagination=true&keyword=$keyword";
      ...
      WHERE mrs.nim LIKE '%$keyword%' OR mdmp.nama LIKE '%$keyword%' OR mrs.judul_prop LIKE '%$keyword%' OR mrs.tgl_upload LIKE '%$keyword%'";
       ...
       $reload = "rekapJudulPropAdm.php?pagination=true";
    ...
    <div class="container-fluid">
      <div class="row">
        <h3 class="text-center text-warning">Judul Proposal Tesis</h3>
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah semua data Judul Proposal Tesis.</li>
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <form method="post" action="rekapJudulPropAdm.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="rekapJudulPropAdm.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class=" table table-condensed table-bordered table-striped custom" width="100%" style="margin-bottom:0px; font-size:13px;">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center" width="48%">Judul Proposal Tesis</th>
                    ...
                    <tbody class="text-muted">
                      <?php
                        ...
                        $qidSempro = "SELECT * FROM mag_peserta_sempro WHERE id_sempro='$data[id_sempro]'";
                        $ridSempro = mysqli_query($GLOBALS["___mysqli_ston"], $qidSempro)or die( mysqli_error($GLOBALS["___mysqli_ston"]));
                        $didSempro = mysqli_fetch_assoc($ridSempro);

                        $qryperiod = "SELECT * FROM mag_periode_pendaftaran_sempro WHERE id='$didSempro[id_sempro]'";
