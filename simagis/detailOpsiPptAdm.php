        ...
        <div class="panel panel-danger">
          ...
          <ul class="list-group">
            <?php           		
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar pengajuan" data-toggle="modal" data-target="#modalListPengajuanOpsiPt" data-whatever="<?php echo $id;?>" style="padding-bottom:9px;">
            <span class="badge"><?php echo "$jumPengajuan";?> mhs</span>
            Pengajuan
            </button>
            <?php
              $qry3 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2' AND status='1'";
			  ...
			  $qry4 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND cek2='2' AND status='1'";
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar proses" data-toggle="modal" data-target="#modalListProsesOpsiPt" data-whatever="<?php echo $id;?>" style="padding-bottom:9px;">
