...
<div class="table-responsive">
  <table class="table custom">
    <tbody>
      <?php
        $qdm = "SELECT * FROM mag_dt_mhssw_pasca AS mdmp JOIN mag_peserta_sempro AS mps ON mdmp.nim=mps.nim WHERE mdmp.angkatan='$angkatan' AND mdmp.smt_daftar='2' ORDER BY mdmp.nama ASC";
