            ...
            <div class="row">
              <div class="col-md-12" style="margin-bottom:10px;">
                <ul class="nav nav-tabs">
                  ...
                  <li role="presentation" class="active"><a>Jadwal Seminar</a></li>
                </ul>
              </div>
              <div class="col-md-12">
                <?php
                  $sql =  "SELECT * FROM mag_jadwal_sempro WHERE id_sempro='$id_sempro' GROUP BY tgl_seminar ORDER BY tgl_seminar ASC";
