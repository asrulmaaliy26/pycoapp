...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updatePendUjtesAdm.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <textarea name="catatan" class="form-control textcatatan" id="catatan" required><?php echo $dataku['catatan'];?></textarea>
      </div>
      <input type="text" name="id" class="sr-only" value="<?php echo $dataku['id'];?>" required readonly>
      <input type="text" name="id_ujtes" class="sr-only" value="<?php echo $dataku['id_ujtes'];?>" required readonly>
