  ...
  <body>
    <?php include "navBankUser.php";
      include 'paginationUser.php';         
            ...
            $reload = "variabelmediatorUser.php?pagination=true&keyword=$keyword";
            
            $sql = "SELECT * FROM mag_mediatorvariable WHERE nm LIKE '%$keyword%' ORDER BY nm ASC";
      
            $result = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
            }else{
            $reload = "variabelmediatorUser.php?pagination=true";
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          <div class="row">
            <ul class="nav nav-tabs" style="margin-bottom:10px;">
              ...
              <li role="presentation" class="active"><a href="variabelmediatorUser.php">Variabel Mediator</a></li>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <form method="post" action="variabelmediatorUser.php">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      if($_REQUEST['keyword']<>""){
                      ?>
                    <a class="btn btn-success" title="Refresh" href="variabelmediatorUser.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    <?php
                      }
                      ?>
                    </span>
                  ...
                  <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;">
                    <thead>
                      <tr class="success">
                        ...
                        <th width="54%" class="text-center" style="vertical-align:middle;">Nama variabel mediator</th>
                    ...
                    <tbody>
                      <?php
                        ...
                        $qv = "SELECT COUNT(*) AS jum FROM mag_revisi_tesis WHERE mediator='$id'";
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php if($jumV==0) { echo
                            ...
                            <a class='btn btn-default' href='deleteVariabelmediatorUser.php?id=".$id."' onclick='return confirm(\"Yakin data ini dihapus?\")' title='Hapus'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>
                            </a>";}
                            else { echo 
      ...
      <form action="sformMedvariabel.php" method="post">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Input variabel mediator baru</h4>
              </div>
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="nm">Nama variabel mediator baru:</label>
                  <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama variabel mediator baru" required>
                </div>
                <div class="checkbox">
                  <label>
    ...
    <script>
      ...
      $.ajax( {
      type: "GET",
      url: "editVariabelmediatorUser.php",
      data: dataString,
      cache: false,
