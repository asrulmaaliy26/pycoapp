<?php
   ...
   ?>
<p style="text-align:center; font-size:18px; text-transform:uppercase;"><strong>JADWAL SEMINAR PROPOSAL TESIS <br /> 
   ...
   <strong>
      <table width="100%" class="tgl">
         <tr>
            ...
            <td width="73%"><?php echo $dayList[$day].', '.bulanIndo($djdwl['tgl_seminar']);?></td>
         </tr>
         <tr>
            <td>Ruang</td>
