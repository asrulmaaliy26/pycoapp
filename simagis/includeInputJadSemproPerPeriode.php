<?php
  ...
  $qryperiod = "select * from mag_periode_pendaftaran_sempro WHERE id='$dt[id_sempro]'";
...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updateJadSemproPerPeriode.php" method="post">
      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
      <input type="text" name="id_sempro" class="sr-only" value="<?php echo $dperiod['id'];?>" required readonly>
      ...
      <div class="form-group row">
        <div class="col-md-4">
          ...
          <div class="input-group input-append date" id="datetimepicker4">
            <input type="text" class="form-control" name="tgl_seminar" value="<?php echo "$djdwl[tgl_seminar]";?>" required>
      ...
      <div class="form-group">
        ...
        <?php
          ...
          echo "<option value=''>-Pilih-</option>";
          $tampil = mysqli_query($GLOBALS["___mysqli_ston"],  "SELECT * FROM dt_pegawai WHERE menguji_sempro_tesis = '2' ORDER BY nama_tg ASC" );
          while ( $w = mysqli_fetch_array( $tampil ) ) {
