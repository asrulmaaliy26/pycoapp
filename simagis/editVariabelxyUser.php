<?php
  ...
  $myquery = "SELECT * FROM mag_variablexy WHERE id='$id'";
...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updateVariabelxyUser.php" method="post">
      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
      <div class="form-group">
        <label for="nm">Nama variabel:</label>
        <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama variabel" value="<?php echo $dataku['nm'];?>" required>
      </div>
      <div class="checkbox">
        <label>
