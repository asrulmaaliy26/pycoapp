    ...
    <table class="table table-condensed table-bordered table-striped custom" style="margin-bottom:0px; font-size:13px;">
      <thead>
        <tr>
          ...
          <th width="58%" class="text-center">Nama | NIM</th>
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dosen_wali WHERE dosen_wali='$id' AND cek='2' AND status='2' ORDER BY tgl_selesai ASC";
