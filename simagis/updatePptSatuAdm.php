<?php
  ...
  $qry = "SELECT COUNT(dospem_tesis1) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$_POST[dospem_tesis1]' AND id_periode='$_POST[id_periode]' AND (cek1='1' OR cek1='2')";
  ...
  header("location:verifikasiEditPpt.php?id=$id&id_periode=$id_periode&message=notifGagalDospem");
   ...
   mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE mag_pengelompokan_dospem_tesis SET dospem_tesis1='$dospem_tesis1',nip_dospem_tesis1='$nip1' WHERE id='$id' LIMIT 1") or die(mysqli_error($GLOBALS["___mysqli_ston"]));  
