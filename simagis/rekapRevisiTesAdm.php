...
<html lang="en">
  ...
  <body>
    ...
    $qry = "SELECT COUNT(*) AS jumData FROM mag_revisi_tesis";
    ...
    $sql =  "SELECT * FROM mag_revisi_tesis GROUP BY id_ujtes ORDER BY id_ujtes DESC";
    ...
    <div class="container-fluid">
      <div class="row">
        <h3 class="text-center text-warning">Revisi Tesis</h3>
        <div class="panel panel-success">
          <div class="panel-heading">
            <ul class="list">
              <li>Berikut adalah data Revisi Tesis berdasarkan periode pendaftaran.</li>
            ...
            <div class="row">
              <div class="col-md-12" style="margin-bottom:10px;">
                <ul class="nav nav-tabs">
                  ...
                  <li role="presentation"><a href="rekapAllRevisiTesAdm.php">Semua Data</a></li>
                </ul>
              </div>
              <div class="col-md-12">
                  ...
                  <table class=" table table-condensed table-bordered table-striped custom" width="100%" style="margin-bottom:0px; font-size:13px;">
                    ...
                    <tbody class="text-muted">
                      <?php
                        ...
                        $qjum = "SELECT COUNT(*) AS jumData FROM mag_revisi_tesis WHERE id_ujtes='$id_ujtes'";
                        ...
                        $qjb = "SELECT COUNT(*) AS jumData FROM mag_revisi_tesis WHERE id_ujtes='$id_ujtes' AND cek='1'";
                        ...
                        $qjter = "SELECT COUNT(*) AS jumData FROM mag_revisi_tesis WHERE id_ujtes='$id_ujtes' AND cek='2'";
                        ...
                        $qjtol = "SELECT COUNT(*) AS jumData FROM mag_revisi_tesis WHERE id_ujtes='$id_ujtes' AND cek='3'";
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href='detailRekapRevisiTesPerPeriode.php?id_ujtes=<?php echo "$id_ujtes";?>&page=<?php echo "$page";?>' class='btn btn-warning btn-sm btn-block' title='Lihat dan validasi'>Lihat dan Validasi</a>
                        </td>
                      </tr>
                      <?php
                        $i++; 
