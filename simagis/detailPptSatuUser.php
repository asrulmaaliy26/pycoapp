        ...
        <div class="panel panel-danger">
          ...
          <ul class="list-group">
            <?php           		
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar pengajuan" data-toggle="modal" data-target="#modalListPengajuanSatu" data-whatever="<?php echo $ddw['id'];?>" style="padding-bottom:9px;">
            ...
            <?php
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar proses" data-toggle="modal" data-target="#modalListProsesSatu" data-whatever="<?php echo $ddw['id'];?>" style="padding-bottom:9px;">
