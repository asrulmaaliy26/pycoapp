<?php
  ...
  $nf_kwitansi = "file_kwitansi_sempro/";
   ...
   $myqry="UPDATE mag_peserta_sempro SET judul_prop='$judul_prop',tgl_pendaftaran='$tgl_pendaftaran',thn_pendaftaran='$thn_pendaftaran' WHERE id='$id' LIMIT 1";
  	mysqli_query($GLOBALS["___mysqli_ston"], $myqry) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
  	header("location:formPendSempro.php?message=notifEdit");
  ?>