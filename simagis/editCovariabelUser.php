...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updateCovariabelUser.php" method="post">
      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
      <div class="form-group">
        <label for="nm">Nama co-variabel baru:</label>
        <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama co-variabel baru" value="<?php echo $dataku['nm'];?>" required>
      </div>
      <div class="checkbox">
        <label>
