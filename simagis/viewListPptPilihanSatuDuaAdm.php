  ...
  <div class="table-responsive">
    <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;">
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND id_periode='$data[id]' AND cek1='1' ORDER BY tgl_pengajuan";
  ...
  <div class="table-responsive">
    <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;">
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND id_periode='$data[id]' AND cek2='1' ORDER BY tgl_pengajuan";
          $rdw = mysqli_query($GLOBALS["___mysqli_ston"], $qdw)or die( mysqli_error($GLOBALS["___mysqli_ston"]));
          while($ddw = mysqli_fetch_assoc($rdw)) {
          $no++;
          $qm = "SELECT * FROM mag_dt_mhssw_pasca WHERE nim='$ddw[nim]'";
