...
<div class="table-responsive">
  <table class="table table-condensed table-bordered table-striped custom" style="margin-bottom:0px; font-size:13px;">
    ...
    <tbody>
      <?php
        $no=0;
        $qdw = "SELECT * FROM dt_pegawai WHERE menguji_sempro_tesis = '2' ORDER BY nama ASC";
        $rdw = mysqli_query($GLOBALS["___mysqli_ston"], $qdw)or die( mysqli_error($GLOBALS["___mysqli_ston"]));
        while($ddw = mysqli_fetch_assoc($rdw)) {
        $no++;
        
        $qry1 = "SELECT COUNT(*) AS jumData FROM mag_jadwal_sempro WHERE penguji3='$ddw[id]' AND id_sempro='$id'";
        ...
        $qry2 = "SELECT COUNT(*) AS jumData FROM mag_jadwal_sempro WHERE penguji4='$ddw[id]' AND id_sempro='$id'";
        ...
        $qry3 = "SELECT COUNT(*) AS jumData FROM mag_jadwal_sempro WHERE penguji1='$ddw[id]' AND id_sempro='$id'";
        ...
        $qry4 = "SELECT COUNT(*) AS jumData FROM mag_jadwal_sempro WHERE penguji2='$ddw[id]' AND id_sempro='$id'";
