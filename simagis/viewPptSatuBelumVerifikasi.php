  ...
  <div class="table-responsive">
    <table class="table table-condensed table-bordered table-striped custom" style="margin-bottom:0px; font-size:13px;">
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE id_periode='$id' AND cek1='1' ORDER BY tgl_pengajuan ASC";
		  ...
		  $qpt = "SELECT * FROM mag_dospem_tesis WHERE id='$ddw[dospem_tesis1]'";
