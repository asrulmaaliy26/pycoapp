...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="updateModVariabelAdm.php" method="post">
      <input type="text" name="id" class="sr-only" value="<?php echo $id;?>" required readonly>
      <div class="form-group">
        <label for="nm">Nama Variabel Moderator:</label>
        <input type="text" name="nm" class="form-control" id="nm" placeholder="Nama moderator variabel" value="<?php echo $dataku['nm'];?>" required>
      </div>
      <div class="checkbox">
        <label>
