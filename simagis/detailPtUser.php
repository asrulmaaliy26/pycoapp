<?php
  ...
  $qdw = "SELECT * FROM mag_dospem_tesis WHERE id='$id'";
    ...
    <div class="box_1 center-block hidden-lg hidden-md">
      ...
      <div class="col-md-4 col-sm-12 col-xs-12">
        <div class="panel panel-danger">
          ...
          <ul class="list-group">
            <?php           		
              $qry1 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='1'";
			  ...
			  $qry2 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND cek2='1'";
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar pengajuan" data-toggle="modal" data-target="#modalListPengajuan" data-whatever="<?php echo $id;?>" style="padding-bottom:9px;">
            <span class="badge"><?php echo "$jumPengajuan";?> mhs</span>
            Pengajuan
            </button>
            <?php
              $qry3 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2'  AND cekjudul='2' AND status='1'";
			  ...
			  $qry4 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND cek2='2'  AND cekjudul='2' AND status='1'";
              ...
              ?>
            <button type="button" class="list-group-item" title="Daftar proses" data-toggle="modal" data-target="#modalListProses" data-whatever="<?php echo $id;?>" style="padding-bottom:9px;">
            <span class="badge"><?php echo "$jumProses";?> mhs</span>
            Proses
            </button>
            <?php
              $qry5 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2' AND cekjudul='2' AND status='2'";
			  ...
			  $qry6 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND cek2='2' AND cekjudul='2' AND status='2'";
            ...
            <?php
              $qry7 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2'";
			  ...
			  $qry8 = "SELECT COUNT(*) AS jumData FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis2='$id' AND cek2='2'";
