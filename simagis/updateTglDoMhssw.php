<?php
  ...
  $thn_do=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['thn_do']);
  $page=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['page']);
  
  mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE mag_dt_mhssw_pasca SET thn_do='$thn_do' WHERE nim='$nim' LIMIT 1")  or die(mysqli_error($GLOBALS["___mysqli_ston"]));
