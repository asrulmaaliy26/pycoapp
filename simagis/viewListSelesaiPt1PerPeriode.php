...
<div class="panel panel-default">
  <div class="panel-heading">Selesai Pembimbingan untuk Dosen Pembimbing I</div>
  <div class="table-responsive">
    <table class="table table-condensed table-bordered custom" style="margin-bottom:0px;">
      ...
      <tbody>
        <?php
          $no=0;
          $qdw = "SELECT * FROM mag_pengelompokan_dospem_tesis WHERE dospem_tesis1='$id' AND cek1='2' AND cekjudul='2' AND status='2' ORDER BY tgl_mulai";
