      ...
      <div class="row">
        <?php
          ...
          <a href="#" class="close" data-dismiss="alert" aria-label="close"></a><span class="glyphicon glyphicon-thumbs-up"></span> Data berhasil diupdate</div>';} 
            ?>
        <h3 class="text-center text-warning">SOP Pendaftaran Ujian Tesis</h3>
        <form action="updateSopPut.php" method="post" enctype="multipart/form-data">
          <div class="panel panel-success">
            <div class="panel-heading">
              <ul class="list">
                <li>Berikut deskripsi SOP (Standar Operasional Procedure) Pendaftaran Ujian Tesis.</li>
